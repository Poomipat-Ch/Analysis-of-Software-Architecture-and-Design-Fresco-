...
public class DraweeMocks {
   ...
   */
  public static com.facebook.drawee.interfaces.DraweeController mockController()
  {
   ...
   */
  public static void stubGetAndSetHierarchy(com.facebook.drawee.interfaces.DraweeController controller)
  {
   ...
   * @param controller controller to stub methods of
   */
  public static void stubGetAndSetContentDescription(com.facebook.drawee.interfaces.DraweeController controller)
  {
   ...
   */
  public static com.facebook.drawee.controller.ControllerListener stubControllerListener(final com.facebook.drawee.interfaces.DraweeController controller)
  {
   ...
   */
  public static com.facebook.drawee.generic.GenericDraweeHierarchy mockDraweeHierarchyOf(Drawable topLevelDrawable)
  {
   ...
   * @return mock GenericDraweeHierarchy
   */
  public static com.facebook.drawee.generic.GenericDraweeHierarchy mockDraweeHierarchy()
  {
   ...
   */
  public static com.facebook.drawee.generic.GenericDraweeHierarchyBuilder mockGenericDraweeHierarchyBuilder()
  {
   ...
   * @return mock GenericDraweeHierarchyBuilder
   */
  public static com.facebook.drawee.generic.GenericDraweeHierarchyBuilder mockBuilderOf(GenericDraweeHierarchy...drawableHierarchies )
  {
    GenericDraweeHierarchyBuilder builder =
        mock(GenericDraweeHierarchyBuilder.class, CALLS_REAL_METHODS);
   ...
   */
  public static <T> com.facebook.common.internal.Supplier<T> supplierOf(final T...values )
  {
