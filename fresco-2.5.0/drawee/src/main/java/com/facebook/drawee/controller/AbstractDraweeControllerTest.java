...
public class AbstractDraweeControllerTest {
  ...
  public static class FakeDraweeController extends AbstractDraweeController<, > {
    private com.facebook.common.internal.Supplier<DataSource<FakeImage>> mDataSourceSupplier;

    public boolean mIsAttached =  false;

    public FakeDraweeController(com.facebook.drawee.components.DeferredReleaser deferredReleaser, Executor uiThreadExecutor, com.facebook.common.internal.Supplier<DataSource<FakeImage>> dataSourceSupplier, String id, Object callerContext) {
    ...
    @Override
    protected com.facebook.datasource.DataSource<FakeImage> getDataSource() {
    ...
    @Override
    protected void releaseImage(@Nullable AbstractDraweeControllerTest.FakeImage image) {
      if (image != null) {
        image.close();
      }
    }
    ...
    @Nullable
    @Override
    public Map<String, Object> obtainExtrasFromImage(AbstractDraweeControllerTest.FakeImageInfo fakeImageInfo) {
      return Collections.emptyMap();
    }

    @Override
    public boolean isSameImageRequest(com.facebook.drawee.interfaces.DraweeController other) {
      return false;
    }
  ...
  private com.facebook.drawee.interfaces.SettableDraweeHierarchy mDraweeHierarchy;
  ...
  private void initializeAndAttachController(String id, com.facebook.datasource.DataSource<FakeImage> dataSource) {
    try {
  ...
  private static void finish(com.facebook.datasource.SimpleDataSource<FakeImage> dataSource, AbstractDraweeControllerTest.FakeImage image, int outcome)
  {
    switch (outcome) {
      case FAILURE:
  ...
  private static AbstractDraweeControllerTest.FakeImage createFaultyImage()
  {
