 ...
 */
@NotThreadSafe
public abstract class AbstractDraweeController<T, INFO> implements com.facebook.drawee.interfaces.DraweeController, com.facebook.drawee.components.DeferredReleaser.Releasable, com.facebook.drawee.gestures.GestureDetector.ClickListener {
  ...
  private static class InternalForwardingListener<INFO> extends ForwardingControllerListener<> {
   ...
   *  Components
   */
  private final com.facebook.drawee.components.DraweeEventTracker mEventTracker =  DraweeEventTracker.newInstance();

  private final com.facebook.drawee.components.DeferredReleaser mDeferredReleaser;
   ...
   */
  @Nullable
  private com.facebook.drawee.components.RetryManager mRetryManager;

  @Nullable
  private com.facebook.drawee.gestures.GestureDetector mGestureDetector;
  ...
  protected com.facebook.fresco.ui.common.ForwardingControllerListener2<INFO> mControllerListener2 = 
      new ForwardingControllerListener2<>();

  @Nullable
  protected com.facebook.fresco.ui.common.LoggingListener mLoggingListener;

  /**
   *  Hierarchy
   */
  @Nullable
  private com.facebook.drawee.interfaces.SettableDraweeHierarchy mSettableDraweeHierarchy;
  ...
  @Nullable
  private com.facebook.datasource.DataSource<T> mDataSource;
  ...
  public AbstractDraweeController(com.facebook.drawee.components.DeferredReleaser deferredReleaser, Executor uiThreadImmediateExecutor, String id, Object callerContext) {
   ...
   */
  @ReturnsOwnership
  protected com.facebook.drawee.components.RetryManager getRetryManager() {
    if (mRetryManager == null) {
   ...
   */
  @Nullable
  protected com.facebook.drawee.gestures.GestureDetector getGestureDetector() {
   ...
   */
  protected void setGestureDetector(@Nullable com.facebook.drawee.gestures.GestureDetector gestureDetector) {
  ...
  public void addControllerListener2(com.facebook.fresco.ui.common.ControllerListener2<INFO> controllerListener2) {
    mControllerListener2.addListener(controllerListener2);
  }

  public void removeControllerListener2(com.facebook.fresco.ui.common.ControllerListener2<INFO> controllerListener2) {
    mControllerListener2.removeListener(controllerListener2);
  }

  public void setLoggingListener(final com.facebook.fresco.ui.common.LoggingListener loggingListener) {
  ...
  protected com.facebook.fresco.ui.common.ControllerListener2<INFO> getControllerListener2() {
  ...
  private void onNewResultInternal(String id, com.facebook.datasource.DataSource<T> dataSource, @Nullable T image, float progress, boolean isFinished, boolean wasImmediate, boolean deliverTempResult) {
    try {
      if (FrescoSystrace.isTracing()) {
  ...
  private void onFailureInternal(String id, com.facebook.datasource.DataSource<T> dataSource, Throwable throwable, boolean isFinished) {
    if (FrescoSystrace.isTracing()) {
  ...
  private void onProgressUpdateInternal(String id, com.facebook.datasource.DataSource<T> dataSource, float progress, boolean isFinished) {
    // ignore late callbacks (data source that failed is not the one we expected)
    if (!isExpectedDataSource(id, dataSource)) {
  ...
  private boolean isExpectedDataSource(String id, com.facebook.datasource.DataSource<T> dataSource) {
  ...
  protected abstract com.facebook.datasource.DataSource<T> getDataSource() ;
  ...
  protected void reportSubmit(com.facebook.datasource.DataSource<T> dataSource, @Nullable INFO info) {
  ...
  private void reportSuccess(String id, @Nullable T image, @Nullable com.facebook.datasource.DataSource<T> dataSource) {
    INFO info = getImageInfo(image);
  ...
  private void reportFailure(Throwable throwable, @Nullable com.facebook.datasource.DataSource<T> dataSource) {
  ...
  private com.facebook.fresco.ui.common.ControllerListener2.Extras obtainExtras(@Nullable Map<String, Object> datasourceExtras, @Nullable Map<String, Object> imageExtras, @Nullable Uri mainUri) {
  ...
  private com.facebook.fresco.ui.common.ControllerListener2.Extras obtainExtras(@Nullable com.facebook.datasource.DataSource<T> datasource, @Nullable INFO info, @Nullable Uri mainUri) {
    return obtainExtras(
