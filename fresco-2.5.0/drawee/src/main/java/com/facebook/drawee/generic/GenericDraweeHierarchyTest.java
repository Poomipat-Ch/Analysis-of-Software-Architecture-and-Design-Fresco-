...
public class GenericDraweeHierarchyTest {
  ...
  private com.facebook.drawee.drawable.ForwardingDrawable mWrappedImage;
  ...
  private void assertLayersOn(com.facebook.drawee.drawable.FadeDrawable fadeDrawable, int firstLayerIndex, int numberOfLayers) {
  ...
  private void testSetDrawable(GenericDraweeHierarchy dh, int index, GenericDraweeHierarchyTest.SetDrawableCallback callback) {
    FadeDrawable fadeDrawable = (FadeDrawable) dh.getTopLevelDrawable().getCurrent();
    // null
  ...
  private GenericDraweeHierarchy testRoundingParams_createHierarchy(RoundingParams prevRoundingParams, RoundingParams roundingParams) {
    GenericDraweeHierarchy dh =
        mBuilder
            .setPlaceholderImage(mWrappedImage, ScaleType.CENTER)
            .setFailureImage(mFailureImage, ScaleType.CENTER)
  ...
  private void testRoundingParams_NoRoundedLeafs(RootDrawable rootDrawable, com.facebook.drawee.drawable.FadeDrawable fadeDrawable) {
    assertNotNull(fadeDrawable);
    assertScaleTypeAndDrawable(mWrappedImage, ScaleType.CENTER, fadeDrawable.getDrawable(1));
    assertScaleTypeAndDrawable(mFailureImage, ScaleType.CENTER, fadeDrawable.getDrawable(5));
    assertSame(mRetryImage, fadeDrawable.getDrawable(4));
  ...
  private void testRoundingParams_RoundedLeafs(RootDrawable rootDrawable, com.facebook.drawee.drawable.FadeDrawable fadeDrawable, RoundingParams roundingParams) {
    assertNotNull(fadeDrawable);
    assertScaleTypeAndDrawable(mWrappedImage, ScaleType.CENTER, fadeDrawable.getDrawable(1));
    Rounded roundedPlaceholder = (Rounded) mWrappedImage.getCurrent().getCurrent();
    assertRoundingParams(roundingParams, roundedPlaceholder);
  ...
  private void assertRoundingParams(RoundingParams roundingParams, com.facebook.drawee.drawable.Rounded roundedDrawable) {
