 ...
 */
@ThreadSafe
public class ForwardingControllerListener<INFO> implements ControllerListener<>, com.facebook.fresco.ui.common.OnDrawControllerListener<> {
  /**
  ...
  @Override
  public void onImageDrawn(String id, INFO imageInfo, com.facebook.fresco.ui.common.DimensionsInfo dimensionsInfo) {
    final int numberOfListeners = mListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
      try {
        ControllerListener<? super INFO> listener = mListeners.get(i);
