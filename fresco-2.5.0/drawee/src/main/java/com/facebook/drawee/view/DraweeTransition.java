...
public class DraweeTransition extends Transition {
  ...
  private final com.facebook.drawee.drawable.ScalingUtils.ScaleType mFromScale;

  private final com.facebook.drawee.drawable.ScalingUtils.ScaleType mToScale;
  ...
  public static TransitionSet createTransitionSet(com.facebook.drawee.drawable.ScalingUtils.ScaleType fromScale, com.facebook.drawee.drawable.ScalingUtils.ScaleType toScale)
  {
    return createTransitionSet(fromScale, toScale, null, null);
  }

  public static TransitionSet createTransitionSet(com.facebook.drawee.drawable.ScalingUtils.ScaleType fromScale, com.facebook.drawee.drawable.ScalingUtils.ScaleType toScale, @Nullable PointF fromFocusPoint, @Nullable PointF toFocusPoint)
  {
  ...
  public DraweeTransition(com.facebook.drawee.drawable.ScalingUtils.ScaleType fromScale, com.facebook.drawee.drawable.ScalingUtils.ScaleType toScale, @Nullable PointF fromFocusPoint, @Nullable PointF toFocusPoint) {
  ...
  public DraweeTransition(com.facebook.drawee.drawable.ScalingUtils.ScaleType fromScale, com.facebook.drawee.drawable.ScalingUtils.ScaleType toScale) {
