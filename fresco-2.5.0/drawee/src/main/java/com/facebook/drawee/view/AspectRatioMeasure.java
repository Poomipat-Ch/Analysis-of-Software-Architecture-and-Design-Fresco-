...
public class AspectRatioMeasure {
   ...
   */
  public static void updateMeasureSpec(AspectRatioMeasure.Spec spec, float aspectRatio, @Nullable ViewGroup.LayoutParams layoutParams, int widthPadding, int heightPadding)
  {
