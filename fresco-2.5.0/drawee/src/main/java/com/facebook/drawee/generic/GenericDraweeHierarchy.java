 ...
 * </ul>
 */
public class GenericDraweeHierarchy implements com.facebook.drawee.interfaces.SettableDraweeHierarchy {
  ...
  private final com.facebook.drawee.drawable.FadeDrawable mFadeDrawable;

  private final com.facebook.drawee.drawable.ForwardingDrawable mActualImageWrapper;
  ...
  @Nullable
  private Drawable buildActualImageBranch(Drawable drawable, @Nullable com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType, @Nullable PointF focusPoint, @Nullable ColorFilter colorFilter) {
   ...
   */
  @Nullable
  private Drawable buildBranch(@Nullable Drawable drawable, @Nullable com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType) {
   ...
   */
  private com.facebook.drawee.drawable.DrawableParent getParentDrawableAtIndex(int index) {
   ...
   */
  private com.facebook.drawee.drawable.ScaleTypeDrawable getScaleTypeDrawableAtIndex(int index) {
   ...
   */
  public void setPlaceholderImage(int resourceId, com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType) {
   ...
   * @param ScalingUtils.ScaleType a new scale type.
   */
  public void setFailureImage(int resourceId, com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType) {
   ...
   * @param ScalingUtils.ScaleType a new scale type.
   */
  public void setRetryImage(int resourceId, com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType) {
   ...
   * @param ScalingUtils.ScaleType a new scale type.
   */
  public void setProgressBarImage(int resourceId, com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType) {
  ...
  public void setOnFadeListener(com.facebook.drawee.drawable.FadeDrawable.OnFadeListener onFadeFinished) {
