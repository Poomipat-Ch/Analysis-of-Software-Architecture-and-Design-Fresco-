...
public class SimpleDraweeView extends GenericDraweeView {
  private static com.facebook.common.internal.Supplier<? extends AbstractDraweeControllerBuilder> sDraweecontrollerbuildersupplier;

  /**
   *  Initializes {@link SimpleDraweeView} with supplier of Drawee controller builders. 
   */
  public static void initialize(com.facebook.common.internal.Supplier<? extends AbstractDraweeControllerBuilder> draweeControllerBuilderSupplier)
  {
  ...
  public SimpleDraweeView(Context context, com.facebook.drawee.generic.GenericDraweeHierarchy hierarchy) {
  ...
  protected com.facebook.drawee.controller.AbstractDraweeControllerBuilder getControllerBuilder() {
   ...
   */
  public void setImageRequest(com.facebook.imagepipeline.request.ImageRequest request) {
