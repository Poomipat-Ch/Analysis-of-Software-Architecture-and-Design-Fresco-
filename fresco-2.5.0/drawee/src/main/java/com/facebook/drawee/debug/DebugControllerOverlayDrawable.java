 ...
 */
public class DebugControllerOverlayDrawable extends Drawable implements com.facebook.drawee.debug.listener.ImageLoadingTimeListener {
   ...
   */
  @VisibleForTesting
  static final int TEXT_COLOR_IMAGE_OK =  Color.GREEN;

  /**
   *  Yellow if the image dimensions are a bit off
   */
  @VisibleForTesting
  static final int TEXT_COLOR_IMAGE_ALMOST_OK =  Color.YELLOW;

  /**
   *  Red if the image dimensions are too far off
   */
  @VisibleForTesting
  static final int TEXT_COLOR_IMAGE_NOT_OK =  Color.RED;
  ...
  @Nullable
  private com.facebook.drawee.drawable.ScalingUtils.ScaleType mScaleType;
  ...
  public void setScaleType(com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType) {
  ...
  @VisibleForTesting
  int determineSizeHintColor(int imageWidth, int imageHeight, @Nullable com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType) {
