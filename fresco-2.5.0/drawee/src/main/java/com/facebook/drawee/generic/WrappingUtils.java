...
public class WrappingUtils {
   ...
   */
  @Nullable
  static Drawable maybeWrapWithScaleType(@Nullable Drawable drawable, @Nullable com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType)
  {
   ...
   */
  @Nullable
  static Drawable maybeWrapWithScaleType(@Nullable Drawable drawable, @Nullable com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType, @Nullable PointF focusPoint)
  {
   ...
   * 
   * <p>If the provided drawable or matrix is null, the given drawable is returned without being
   * wrapped.
   * 
   * @return the wrapping matrix drawable, or the original drawable if the wrapping didn't take
   *     place
   */
  @Nullable
   ...
   */
  static com.facebook.drawee.drawable.ScaleTypeDrawable wrapChildWithScaleType(com.facebook.drawee.drawable.DrawableParent parent, com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType)
  {
   ...
   * </ul>
   */
  static void updateOverlayColorRounding(com.facebook.drawee.drawable.DrawableParent parent, @Nullable RoundingParams roundingParams)
  {
   ...
   * </ul>
   */
  static void updateLeafRounding(com.facebook.drawee.drawable.DrawableParent parent, @Nullable RoundingParams roundingParams, Resources resources)
  {
   ...
   */
  static void applyRoundingParams(com.facebook.drawee.drawable.Rounded rounded, RoundingParams roundingParams)
  {
   ...
   */
  static void resetRoundingParams(com.facebook.drawee.drawable.Rounded rounded)
  {
   ...
   */
  static com.facebook.drawee.drawable.DrawableParent findDrawableParentForLeaf(com.facebook.drawee.drawable.DrawableParent parent)
  {
    while (true) {
      Drawable child = parent.getDrawable();
