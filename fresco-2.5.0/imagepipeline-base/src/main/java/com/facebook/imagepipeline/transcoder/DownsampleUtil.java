...
public class DownsampleUtil {
   ...
   * @return
   */
  public static int determineSampleSize(final com.facebook.imagepipeline.common.RotationOptions rotationOptions, @Nullable final com.facebook.imagepipeline.common.ResizeOptions resizeOptions, final com.facebook.imagepipeline.image.EncodedImage encodedImage, final int maxBitmapSize)
  {
  ...
  public static int determineSampleSizeJPEG(final com.facebook.imagepipeline.image.EncodedImage encodedImage, final int pixelSize, final int maxBitmapSizeInBytes)
  {
  ...
  @VisibleForTesting
  public static float determineDownsampleRatio(final com.facebook.imagepipeline.common.RotationOptions rotationOptions, @Nullable final com.facebook.imagepipeline.common.ResizeOptions resizeOptions, final com.facebook.imagepipeline.image.EncodedImage encodedImage)
  {
  ...
  private static int getRotationAngle(final com.facebook.imagepipeline.common.RotationOptions rotationOptions, final com.facebook.imagepipeline.image.EncodedImage encodedImage)
  {
