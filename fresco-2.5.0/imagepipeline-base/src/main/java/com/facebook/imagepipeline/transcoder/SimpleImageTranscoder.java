...
public class SimpleImageTranscoder implements ImageTranscoder {
  ...
  @Override
  public ImageTranscodeResult transcode(com.facebook.imagepipeline.image.EncodedImage encodedImage, OutputStream outputStream, @Nullable com.facebook.imagepipeline.common.RotationOptions rotationOptions, @Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions, @Nullable com.facebook.imageformat.ImageFormat outputFormat, @Nullable Integer quality) {
    if (quality == null) {
  ...
  @Override
  public boolean canResize(com.facebook.imagepipeline.image.EncodedImage encodedImage, @Nullable com.facebook.imagepipeline.common.RotationOptions rotationOptions, @Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions) {
    if (rotationOptions == null) {
      rotationOptions = RotationOptions.autoRotate();
    }
  ...
  @Override
  public boolean canTranscode(com.facebook.imageformat.ImageFormat imageFormat) {
  ...
  private int getSampleSize(final com.facebook.imagepipeline.image.EncodedImage encodedImage, final com.facebook.imagepipeline.common.RotationOptions rotationOptions, @Nullable final com.facebook.imagepipeline.common.ResizeOptions resizeOptions) {
    int sampleSize;
    if (!mResizingEnabled) {
      sampleSize = DownsampleUtil.DEFAULT_SAMPLE_SIZE;
    } else {
   ...
   */
  private static Bitmap.CompressFormat getOutputFormat(@Nullable final com.facebook.imageformat.ImageFormat format)
  {
    if (format == null) {
