...
public class ImagePipelineFactory {
  ...
  private com.facebook.imagepipeline.cache.CountingMemoryCache<CacheKey, CloseableImage> mBitmapCountingMemoryCache;

  @Nullable
  private com.facebook.imagepipeline.cache.InstrumentedMemoryCache<CacheKey, CloseableImage> mBitmapMemoryCache;

  private com.facebook.imagepipeline.cache.CountingMemoryCache<CacheKey, PooledByteBuffer> mEncodedCountingMemoryCache;

  @Nullable
  private com.facebook.imagepipeline.cache.InstrumentedMemoryCache<CacheKey, PooledByteBuffer> mEncodedMemoryCache;

  @Nullable
  private com.facebook.imagepipeline.cache.BufferedDiskCache mMainBufferedDiskCache;

  @Nullable
  private com.facebook.cache.disk.FileCache mMainFileCache;
  ...
  @Nullable
  private com.facebook.imagepipeline.cache.BufferedDiskCache mSmallImageBufferedDiskCache;

  @Nullable
  private com.facebook.cache.disk.FileCache mSmallImageFileCache;

  @Nullable
  private com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory mPlatformBitmapFactory;

  @Nullable
  private com.facebook.imagepipeline.platform.PlatformDecoder mPlatformDecoder;

  @Nullable
  private com.facebook.imagepipeline.animated.factory.AnimatedFactory mAnimatedFactory;
  ...
  @Nullable
  private com.facebook.imagepipeline.animated.factory.AnimatedFactory getAnimatedFactory() {
  ...
  @Nullable
  public com.facebook.imagepipeline.drawable.DrawableFactory getAnimatedDrawableFactory(@Nullable Context context) {
  ...
  public com.facebook.imagepipeline.cache.CountingMemoryCache<CacheKey, CloseableImage> getBitmapCountingMemoryCache() {
  ...
  public com.facebook.imagepipeline.cache.InstrumentedMemoryCache<CacheKey, CloseableImage> getBitmapMemoryCache() {
  ...
  public com.facebook.imagepipeline.cache.CountingMemoryCache<CacheKey, PooledByteBuffer> getEncodedCountingMemoryCache() {
  ...
  public com.facebook.imagepipeline.cache.InstrumentedMemoryCache<CacheKey, PooledByteBuffer> getEncodedMemoryCache() {
  ...
  private com.facebook.imagepipeline.decoder.ImageDecoder getImageDecoder() {
  ...
  public com.facebook.imagepipeline.cache.BufferedDiskCache getMainBufferedDiskCache() {
  ...
  public com.facebook.imagepipeline.platform.PlatformDecoder getPlatformDecoder() {
  ...
  private com.facebook.imagepipeline.cache.BufferedDiskCache getSmallImageBufferedDiskCache() {
   ...
   */
  private com.facebook.imagepipeline.transcoder.ImageTranscoderFactory getImageTranscoderFactory() {
