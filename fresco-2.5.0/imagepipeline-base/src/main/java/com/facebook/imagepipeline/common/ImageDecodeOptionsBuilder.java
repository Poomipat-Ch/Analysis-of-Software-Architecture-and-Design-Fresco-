...
public class ImageDecodeOptionsBuilder<T extends ImageDecodeOptionsBuilder> {
  ...
  @Nullable
  private com.facebook.imagepipeline.decoder.ImageDecoder mCustomImageDecoder;
   ...
   * @return this builder
   */
  public T setCustomImageDecoder(@Nullable com.facebook.imagepipeline.decoder.ImageDecoder customImageDecoder) {
   ...
   * @return the builder
   */
  public T setBitmapTransformation(@Nullable com.facebook.imagepipeline.transformation.BitmapTransformation bitmapTransformation) {
