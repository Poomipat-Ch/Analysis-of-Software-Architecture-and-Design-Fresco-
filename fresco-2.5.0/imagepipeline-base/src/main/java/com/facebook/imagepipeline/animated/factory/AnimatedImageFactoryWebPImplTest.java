...
public class AnimatedImageFactoryWebPImplTest {
  ...
  private static com.facebook.common.references.ResourceReleaser<PooledByteBuffer> FAKE_RESOURCE_RELEASER = 
  ...
  private static com.facebook.common.references.ResourceReleaser<Bitmap> FAKE_BITMAP_RESOURCE_RELEASER = 
  ...
  private com.facebook.imagepipeline.animated.impl.AnimatedDrawableBackendProvider mMockAnimatedDrawableBackendProvider;

  private com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory mMockBitmapFactory;

  private AnimatedImageFactory mAnimatedImageFactory;

  private com.facebook.animated.webp.WebPImage mWebPImageMock;
  ...
  private void testCreateDefaults(com.facebook.animated.webp.WebPImage mockWebPImage, com.facebook.common.memory.PooledByteBuffer byteBuffer) {
  ...
  private void testCreateWithPreviewBitmap(com.facebook.animated.webp.WebPImage mockWebPImage, com.facebook.common.memory.PooledByteBuffer byteBuffer, Bitmap mockBitmap) throws Exception {
  ...
  private void testCreateWithDecodeAlFrames(com.facebook.animated.webp.WebPImage mockWebPImage, com.facebook.common.memory.PooledByteBuffer byteBuffer, Bitmap mockBitmap1, Bitmap mockBitmap2) throws Exception {
    // For decoding preview frame, expect some calls.
    final AnimatedDrawableBackend mockAnimatedDrawableBackend =
  ...
  private static com.facebook.imagepipeline.testing.TrivialPooledByteBuffer createByteBuffer()
  {
    byte[] buf = new byte[16];
    return new TrivialPooledByteBuffer(buf);
  }

  private static com.facebook.imagepipeline.testing.TrivialBufferPooledByteBuffer createDirectByteBuffer()
  {
    byte[] buf = new byte[16];
   ...
   */
  private static com.facebook.imagepipeline.animated.base.AnimatedDrawableBackend createAnimatedDrawableBackendMock(final int frameCount)
  {
    // For decoding preview frame, expect some calls.
