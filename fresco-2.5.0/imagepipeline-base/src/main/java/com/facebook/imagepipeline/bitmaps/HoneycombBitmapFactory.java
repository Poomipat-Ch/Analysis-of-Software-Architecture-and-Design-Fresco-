...
public class HoneycombBitmapFactory extends PlatformBitmapFactory {
  ...
  public HoneycombBitmapFactory(EmptyJpegGenerator jpegGenerator, com.facebook.imagepipeline.platform.PlatformDecoder purgeableDecoder, com.facebook.imagepipeline.core.CloseableReferenceFactory closeableReferenceFactory) {
  ...
  @Override
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmapInternal(int width, int height, Bitmap.Config bitmapConfig) {
  ...
  private com.facebook.common.references.CloseableReference<Bitmap> createFallbackBitmap(int width, int height, Bitmap.Config bitmapConfig) {
