...
public interface DrawableFactory {
   ...
   */
  boolean supportsImageType(@Nonnull com.facebook.imagepipeline.image.CloseableImage image) ;
   ...
   */
  @Nullable
  Drawable createDrawable(@Nonnull com.facebook.imagepipeline.image.CloseableImage image) ;
