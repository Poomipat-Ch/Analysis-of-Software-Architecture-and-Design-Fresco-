...
public class CountingLruMap<K, V> {
   ...
   */
  public synchronized ArrayList<LinkedHashMap.Entry<K, V>> getMatchingEntries(@Nullable com.facebook.common.internal.Predicate<K> predicate) {
   ...
   */
  public synchronized ArrayList<V> removeAll(@Nullable com.facebook.common.internal.Predicate<K> predicate) {
