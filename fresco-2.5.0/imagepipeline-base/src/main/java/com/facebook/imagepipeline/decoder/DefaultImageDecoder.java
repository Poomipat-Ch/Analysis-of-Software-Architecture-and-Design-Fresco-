...
public class DefaultImageDecoder implements ImageDecoder {
  ...
  @Nullable
  private final Map<com.facebook.imageformat.ImageFormat, ImageDecoder> mCustomDecoders;

  public DefaultImageDecoder(@Nullable final ImageDecoder animatedGifDecoder, @Nullable final ImageDecoder animatedWebPDecoder, final com.facebook.imagepipeline.platform.PlatformDecoder platformDecoder) {
    this(animatedGifDecoder, animatedWebPDecoder, platformDecoder, null);
  }

  public DefaultImageDecoder(@Nullable final ImageDecoder animatedGifDecoder, @Nullable final ImageDecoder animatedWebPDecoder, final com.facebook.imagepipeline.platform.PlatformDecoder platformDecoder, @Nullable Map<ImageFormat, ImageDecoder> customDecoders) {
   ...
   */
  @Override
  public com.facebook.imagepipeline.image.CloseableImage decode(final com.facebook.imagepipeline.image.EncodedImage encodedImage, final int length, final com.facebook.imagepipeline.image.QualityInfo qualityInfo, final com.facebook.imagepipeline.common.ImageDecodeOptions options) {
   ...
   */
  public com.facebook.imagepipeline.image.CloseableImage decodeGif(final com.facebook.imagepipeline.image.EncodedImage encodedImage, final int length, final com.facebook.imagepipeline.image.QualityInfo qualityInfo, final com.facebook.imagepipeline.common.ImageDecodeOptions options) {
   ...
   */
  public com.facebook.imagepipeline.image.CloseableStaticBitmap decodeStaticImage(final com.facebook.imagepipeline.image.EncodedImage encodedImage, com.facebook.imagepipeline.common.ImageDecodeOptions options) {
   ...
   * @return a CloseableStaticBitmap
   */
  public com.facebook.imagepipeline.image.CloseableStaticBitmap decodeJpeg(final com.facebook.imagepipeline.image.EncodedImage encodedImage, int length, com.facebook.imagepipeline.image.QualityInfo qualityInfo, com.facebook.imagepipeline.common.ImageDecodeOptions options) {
    CloseableReference<Bitmap> bitmapReference =
   ...
   */
  public com.facebook.imagepipeline.image.CloseableImage decodeAnimatedWebp(final com.facebook.imagepipeline.image.EncodedImage encodedImage, final int length, final com.facebook.imagepipeline.image.QualityInfo qualityInfo, final com.facebook.imagepipeline.common.ImageDecodeOptions options) {
