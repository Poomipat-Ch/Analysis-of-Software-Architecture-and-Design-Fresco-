...
@DoNotStrip
public class NativeJpegTranscoder implements com.facebook.imagepipeline.transcoder.ImageTranscoder {
  ...
  @Override
  public com.facebook.imagepipeline.transcoder.ImageTranscodeResult transcode(final com.facebook.imagepipeline.image.EncodedImage encodedImage, final OutputStream outputStream, @Nullable com.facebook.imagepipeline.common.RotationOptions rotationOptions, @Nullable final com.facebook.imagepipeline.common.ResizeOptions resizeOptions, @Nullable com.facebook.imageformat.ImageFormat outputFormat, @Nullable Integer quality) throws IOException {
    if (quality == null) {
