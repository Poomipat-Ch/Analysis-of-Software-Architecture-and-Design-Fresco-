...
public interface ImageTranscoder {
   ...
   */
  ImageTranscodeResult transcode(com.facebook.imagepipeline.image.EncodedImage encodedImage, OutputStream outputStream, @Nullable com.facebook.imagepipeline.common.RotationOptions rotationOptions, @Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions, @Nullable com.facebook.imageformat.ImageFormat outputFormat, @Nullable Integer quality) throws IOException ;
   ...
   */
  boolean canResize(com.facebook.imagepipeline.image.EncodedImage encodedImage, @Nullable com.facebook.imagepipeline.common.RotationOptions rotationOptions, @Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions) ;
   ...
   */
  boolean canTranscode(com.facebook.imageformat.ImageFormat imageFormat) ;
