...
public class MultiImageTranscoderFactory implements ImageTranscoderFactory {
  ...
  public MultiImageTranscoderFactory(final int maxBitmapSize, final boolean useDownSamplingRatio, @Nullable final ImageTranscoderFactory primaryImageTranscoderFactory, @ImageTranscoderType final Integer imageTranscoderType, final boolean ensureTranscoderLibraryLoaded) {
  ...
  @Override
  public ImageTranscoder createImageTranscoder(com.facebook.imageformat.ImageFormat imageFormat, boolean isResizingEnabled) {
  ...
  @Nullable
  private ImageTranscoder getCustomImageTranscoder(com.facebook.imageformat.ImageFormat imageFormat, boolean isResizingEnabled) {
  ...
  @Nullable
  private ImageTranscoder getNativeImageTranscoder(com.facebook.imageformat.ImageFormat imageFormat, boolean isResizingEnabled) {
  ...
  private ImageTranscoder getSimpleImageTranscoder(com.facebook.imageformat.ImageFormat imageFormat, boolean isResizingEnabled) {
    return new SimpleImageTranscoderFactory(mMaxBitmapSize)
        .createImageTranscoder(imageFormat, isResizingEnabled);
  }

  @Nullable
  private ImageTranscoder getImageTranscoderWithType(com.facebook.imageformat.ImageFormat imageFormat, boolean isResizingEnabled) {
