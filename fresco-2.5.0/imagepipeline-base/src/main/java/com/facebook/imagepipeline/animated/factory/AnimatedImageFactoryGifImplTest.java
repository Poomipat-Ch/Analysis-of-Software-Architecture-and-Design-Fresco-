...
public class AnimatedImageFactoryGifImplTest {
  ...
  private com.facebook.animated.gif.GifImage mGifImageMock;
  ...
  private void testCreateDefaults(com.facebook.animated.gif.GifImage mockGifImage, com.facebook.common.memory.PooledByteBuffer byteBuffer) {
  ...
  private void testCreateWithPreviewBitmap(com.facebook.animated.gif.GifImage mockGifImage, Bitmap mockBitmap, com.facebook.common.memory.PooledByteBuffer byteBuffer) throws Exception {
  ...
  private void testCreateWithDecodeAlFrames(com.facebook.animated.gif.GifImage mockGifImage, Bitmap mockBitmap1, Bitmap mockBitmap2, com.facebook.common.memory.PooledByteBuffer byteBuffer) throws Exception {
    // For decoding preview frame, expect some calls.
    final AnimatedDrawableBackend mockAnimatedDrawableBackend =
  ...
  private com.facebook.imagepipeline.testing.TrivialPooledByteBuffer createByteBuffer() {
   ...
   */
  private com.facebook.imagepipeline.animated.base.AnimatedDrawableBackend createAnimatedDrawableBackendMock(final int frameCount) {
    // For decoding preview frame, expect some calls.
