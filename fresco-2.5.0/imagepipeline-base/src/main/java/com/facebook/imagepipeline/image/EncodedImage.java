 ...
 */
@Immutable
public class EncodedImage extends Closeable {
   ...
   */
  @Nullable
  private final com.facebook.common.references.CloseableReference<PooledByteBuffer> mPooledByteBufferRef;

  @Nullable
  private final com.facebook.common.internal.Supplier<FileInputStream> mInputStreamSupplier;

  private com.facebook.imageformat.ImageFormat mImageFormat =  ImageFormat.UNKNOWN;
  ...
  @Nullable
  private com.facebook.imagepipeline.common.BytesRange mBytesRange;
  ...
  public EncodedImage(com.facebook.common.references.CloseableReference<PooledByteBuffer> pooledByteBufferRef) {
  ...
  public EncodedImage(com.facebook.common.internal.Supplier<FileInputStream> inputStreamSupplier) {
    Preconditions.checkNotNull(inputStreamSupplier);
    this.mPooledByteBufferRef = null;
    this.mInputStreamSupplier = inputStreamSupplier;
  }

  public EncodedImage(com.facebook.common.internal.Supplier<FileInputStream> inputStreamSupplier, int streamSize) {
   ...
   */
  public com.facebook.common.references.CloseableReference<PooledByteBuffer> getByteBufferRef() {
   ...
   */
  public void setImageFormat(com.facebook.imageformat.ImageFormat imageFormat) {
  ...
  public void setBytesRange(@Nullable com.facebook.imagepipeline.common.BytesRange bytesRange) {
  ...
  @VisibleForTesting
  @Nullable
  public synchronized com.facebook.common.references.SharedReference<PooledByteBuffer> getUnderlyingReferenceTestOnly() {
