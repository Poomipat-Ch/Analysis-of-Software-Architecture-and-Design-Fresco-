...
public class LruCountingMemoryCache<K, V> implements CountingMemoryCache<, >, MemoryCache<, >, com.facebook.cache.common.HasDebugData {
  @Nullable
  ...
  public LruCountingMemoryCache(ValueDescriptor<V> valueDescriptor, MemoryCache.CacheTrimStrategy cacheTrimStrategy, com.facebook.common.internal.Supplier<MemoryCacheParams> memoryCacheParamsSupplier, @Nullable CountingMemoryCache.EntryStateObserver<K> entryStateObserver) {
