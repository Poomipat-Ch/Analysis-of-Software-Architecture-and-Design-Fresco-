...
public class AnimatedImageFactoryImpl implements AnimatedImageFactory {
  ...
  }  public AnimatedImageFactoryImpl(com.facebook.imagepipeline.animated.impl.AnimatedDrawableBackendProvider animatedDrawableBackendProvider, com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory bitmapFactory) {
   ...
   */
  public com.facebook.imagepipeline.image.CloseableImage decodeGif(final com.facebook.imagepipeline.image.EncodedImage encodedImage, final com.facebook.imagepipeline.common.ImageDecodeOptions options, final Bitmap.Config bitmapConfig) {
   ...
   */
  public com.facebook.imagepipeline.image.CloseableImage decodeWebP(final com.facebook.imagepipeline.image.EncodedImage encodedImage, final com.facebook.imagepipeline.common.ImageDecodeOptions options, final Bitmap.Config bitmapConfig) {
  ...
  private com.facebook.imagepipeline.image.CloseableImage getCloseableImage(com.facebook.imagepipeline.common.ImageDecodeOptions options, com.facebook.imagepipeline.animated.base.AnimatedImage image, Bitmap.Config bitmapConfig) {
  ...
  private com.facebook.common.references.CloseableReference<Bitmap> createPreviewBitmap(com.facebook.imagepipeline.animated.base.AnimatedImage image, Bitmap.Config bitmapConfig, int frameForPreview) {
  ...
  private List<com.facebook.common.references.CloseableReference<Bitmap>> decodeAllFrames(com.facebook.imagepipeline.animated.base.AnimatedImage image, Bitmap.Config bitmapConfig) {
    AnimatedImageResult tempResult = AnimatedImageResult.forAnimatedImage(image);
    AnimatedDrawableBackend drawableBackend =
        mAnimatedDrawableBackendProvider.get(tempResult, null);
  ...
  @SuppressLint("NewApi")
  private com.facebook.common.references.CloseableReference<Bitmap> createBitmap(int width, int height, Bitmap.Config bitmapConfig) {
    CloseableReference<Bitmap> bitmap =
