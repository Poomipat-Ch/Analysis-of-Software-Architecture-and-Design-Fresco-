...
public abstract class PlatformBitmapFactory {
   ...
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(int width, int height, Bitmap.Config bitmapConfig) {
    return createBitmap(width, height, bitmapConfig, null);
  }

  /**
   * Creates a bitmap of the specified width and height. The bitmap will be created with the default
   * ARGB_8888 configuration
   * 
   * @param width the width of the bitmap
   * @param height the height of the bitmap
   * @return a reference to the bitmap
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(int width, int height) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(int width, int height, Bitmap.Config bitmapConfig, @Nullable Object callerContext) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(int width, int height, @Nullable Object callerContext) {
    return createBitmap(width, height, Bitmap.Config.ARGB_8888, callerContext);
  }

  /**
   * Creates a bitmap from the specified source bitmap. It is initialized with the same density as
   * the original bitmap.
   * 
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(Bitmap source) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(Bitmap source, @Nullable Object callerContext) {
    return createBitmap(source, 0, 0, source.getWidth(), source.getHeight(), callerContext);
  }

  /**
   * Creates a bitmap from the specified subset of the source bitmap. It is initialized with the
   * same density as the original bitmap.
   * 
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(Bitmap source, int x, int y, int width, int height) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(Bitmap source, int x, int y, int width, int height, @Nullable Object callerContext) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(Bitmap source, int x, int y, int width, int height, @Nullable Matrix matrix, boolean filter) {
    return createBitmap(source, x, y, width, height, matrix, filter, null);
  }

  /**
   * Creates a bitmap from the specified source scaled to have the height and width as specified. It
   * is initialized with the same density as the original bitmap.
   * 
   * @param source The bitmap we are subsetting
   ...
   * @return a reference to the bitmap
   * @throws IllegalArgumentException if the destinationWidth is <= 0, or destinationHeight is <= 0
   * @throws TooManyBitmapsException if the pool is full
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createScaledBitmap(Bitmap source, int destinationWidth, int destinationHeight, boolean filter) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createScaledBitmap(Bitmap source, int destinationWidth, int destinationHeight, boolean filter, @Nullable Object callerContext) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(Bitmap source, int x, int y, int width, int height, @Nullable Matrix matrix, boolean filter, @Nullable Object callerContext) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(DisplayMetrics display, int width, int height, Bitmap.Config config) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(DisplayMetrics display, int width, int height, Bitmap.Config config, @Nullable Object callerContext) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  private com.facebook.common.references.CloseableReference<Bitmap> createBitmap(int width, int height, Bitmap.Config config, boolean hasAlpha) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  private com.facebook.common.references.CloseableReference<Bitmap> createBitmap(int width, int height, Bitmap.Config config, boolean hasAlpha, @Nullable Object callerContext) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  private com.facebook.common.references.CloseableReference<Bitmap> createBitmap(DisplayMetrics display, int width, int height, Bitmap.Config config, boolean hasAlpha) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  private com.facebook.common.references.CloseableReference<Bitmap> createBitmap(@Nullable DisplayMetrics display, int width, int height, Bitmap.Config config, boolean hasAlpha, @Nullable Object callerContext) {
    checkWidthHeight(width, height);
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(int[] colors, int width, int height, Bitmap.Config config) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(int[] colors, int width, int height, Bitmap.Config config, @Nullable Object callerContext) {
    CloseableReference<Bitmap> bitmapRef = createBitmapInternal(width, height, config);
    Bitmap bitmap = bitmapRef.get();
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(DisplayMetrics display, int[] colors, int width, int height, Bitmap.Config config) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(DisplayMetrics display, int[] colors, int width, int height, Bitmap.Config config, @Nullable Object callerContext) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(DisplayMetrics display, int[] colors, int offset, int stride, int width, int height, Bitmap.Config config) {
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public com.facebook.common.references.CloseableReference<Bitmap> createBitmap(DisplayMetrics display, int[] colors, int offset, int stride, int width, int height, Bitmap.Config config, @Nullable Object callerContext) {
    CloseableReference<Bitmap> bitmapRef =
  ...
  private static void checkFinalImageBounds(Bitmap source, int x, int y, int width, int height)
  {
    ...
    Preconditions.checkArgument(
        y + height <= source.getHeight(), "y + height must be <= bitmap.height()");
  }
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  public abstract com.facebook.common.references.CloseableReference<Bitmap> createBitmapInternal(int width, int height, Bitmap.Config bitmapConfig) ;
