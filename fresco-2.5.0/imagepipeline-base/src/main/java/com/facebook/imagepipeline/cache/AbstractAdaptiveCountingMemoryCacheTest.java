...
public class AbstractAdaptiveCountingMemoryCacheTest {
  ...
  @Mock
  public com.facebook.common.references.ResourceReleaser<Integer> mReleaser;

  @Mock
  public AbstractAdaptiveCountingMemoryCache.CacheTrimStrategy mCacheTrimStrategy;

  @Mock
  public com.facebook.common.internal.Supplier<MemoryCacheParams> mParamsSupplier;

  @Mock
  public AbstractAdaptiveCountingMemoryCache.EntryStateObserver<String> mEntryStateObserver;
  ...
  private com.facebook.common.references.CloseableReference<Integer> newReference(int size) {
  ...
  private void assertOrphanWithCount(AbstractAdaptiveCountingMemoryCache.Entry<String, Integer> entry, int count) {
  ...
  private AbstractAdaptiveCountingMemoryCache<String, Integer> createDummyAdaptiveCountingMemoryCache(com.facebook.common.internal.Supplier<MemoryCacheParams> memoryCacheParamsSupplier, AbstractAdaptiveCountingMemoryCache.CacheTrimStrategy cacheTrimStrategy, ValueDescriptor<Integer> valueDescriptor, int adaptiveRatePromil, int frequentlyUsedThreshold, int ghostListMaxSize, int lfuFractionPromil) {
