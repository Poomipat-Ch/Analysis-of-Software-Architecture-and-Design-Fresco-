...
public class BufferedDiskCacheTest {
  @Mock
  public com.facebook.cache.disk.FileCache mFileCache;

  @Mock
  public com.facebook.common.memory.PooledByteBufferFactory mByteBufferFactory;

  @Mock
  public com.facebook.common.memory.PooledByteStreams mPooledByteStreams;
  ...
  @Mock
  public com.facebook.binaryresource.BinaryResource mBinaryResource;
  ...
  private com.facebook.imagepipeline.testing.TestExecutorService mReadPriorityExecutor;

  private com.facebook.imagepipeline.testing.TestExecutorService mWritePriorityExecutor;
