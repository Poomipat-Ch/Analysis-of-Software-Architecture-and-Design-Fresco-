 ...
 */
@ThreadSafe
public class CloseableStaticBitmap extends CloseableBitmap implements com.facebook.common.references.HasBitmap {
  @GuardedBy("this")
  private com.facebook.common.references.CloseableReference<Bitmap> mBitmapReference;
   ...
   */
  public CloseableStaticBitmap(Bitmap bitmap, com.facebook.common.references.ResourceReleaser<Bitmap> resourceReleaser, QualityInfo qualityInfo, int rotationAngle) {
   ...
   * @param resourceReleaser ResourceReleaser to release the bitmap to
   */
  public CloseableStaticBitmap(Bitmap bitmap, com.facebook.common.references.ResourceReleaser<Bitmap> resourceReleaser, QualityInfo qualityInfo, int rotationAngle, int exifOrientation) {
   ...
   */
  public CloseableStaticBitmap(com.facebook.common.references.CloseableReference<Bitmap> bitmapReference, QualityInfo qualityInfo, int rotationAngle) {
   ...
   * @param bitmapReference the bitmap reference.
   */
  public CloseableStaticBitmap(com.facebook.common.references.CloseableReference<Bitmap> bitmapReference, QualityInfo qualityInfo, int rotationAngle, int exifOrientation) {
  ...
  private synchronized com.facebook.common.references.CloseableReference<Bitmap> detachBitmapReference() {
   ...
   */
  public synchronized com.facebook.common.references.CloseableReference<Bitmap> convertToBitmapReference() {
   ...
   */
  @Nullable
  public synchronized com.facebook.common.references.CloseableReference<Bitmap> cloneUnderlyingBitmapReference() {
