...
public abstract class AbstractAdaptiveCountingMemoryCache<K, V> implements CountingMemoryCache<, > {
   ...
   */
  private final com.facebook.common.internal.Supplier<MemoryCacheParams> mMemoryCacheParamsSupplier;
  ...
  @GuardedBy("this")
  @VisibleForTesting
  final AbstractAdaptiveCountingMemoryCache.IntMapArrayList<K> mLeastFrequentlyUsedKeysGhostList;
  ...
  public AbstractAdaptiveCountingMemoryCache(com.facebook.common.internal.Supplier<MemoryCacheParams> memoryCacheParamsSupplier, MemoryCache.CacheTrimStrategy cacheTrimStrategy, ValueDescriptor<V> valueDescriptor, int adaptiveRatePromil, int frequentlyUsedThreshold, int ghostListMaxSize, int lfuFractionPromil) {
   ...
   */
  @Nullable
  public com.facebook.common.references.CloseableReference<V> cache(final K key, final com.facebook.common.references.CloseableReference<V> valueRef) {
   ...
   */
  @Nullable
  public com.facebook.common.references.CloseableReference<V> cache(final K key, final com.facebook.common.references.CloseableReference<V> valueRef, @Nullable final CountingMemoryCache.EntryStateObserver<K> observer) {
   ...
   */
  @Nullable
  public com.facebook.common.references.CloseableReference<V> get(final K key) {
    Preconditions.checkNotNull(key);
    final Entry<K, V> oldLFUExclusive;
    final Entry<K, V> oldMFUExclusive;
    CloseableReference<V> clientRef = null;
   ...
   */
  private synchronized com.facebook.common.references.CloseableReference<V> newClientReference(final CountingMemoryCache.Entry<K, V> entry) {
   ...
   */
  private synchronized void addElementToGhostList(K key, int accessCount, AbstractAdaptiveCountingMemoryCache.ArrayListType evictionType) {
   ...
   */
  @Nullable
  public com.facebook.common.references.CloseableReference<V> reuse(K key) {
    Preconditions.checkNotNull(key);
    CloseableReference<V> clientRef = null;
   ...
   */
  @Override
  public synchronized boolean contains(com.facebook.common.internal.Predicate<K> predicate) {
   ...
   */
  @Nullable
  private synchronized ArrayList<CountingMemoryCache.Entry<K, V>> trimExclusivelyOwnedEntries(int count, int size, CountingLruMap<K, Entry<K, V>> ExclusixeEntries, AbstractAdaptiveCountingMemoryCache.ArrayListType evictionType) {
   ...
   * called while holding the <code>this</code> lock.
   */
  private void maybeClose(@Nullable ArrayList<Entry<K, V>> oldEntries1, @Nullable ArrayList<Entry<K, V>> oldEntries2) {
  ...
  private void maybeNotifyExclusiveEntriesRemoval(@Nullable ArrayList<Entry<K, V>> entries1, @Nullable ArrayList<Entry<K, V>> entries2) {
   ...
   */
  private synchronized void makeOrphans(@Nullable ArrayList<Entry<K, V>> oldEntries1, @Nullable ArrayList<Entry<K, V>> oldEntries2) {
   ...
   */
  @Nullable
  private synchronized com.facebook.common.references.CloseableReference<V> referenceToClose(CountingMemoryCache.Entry<K, V> entry) {
    Preconditions.checkNotNull(entry);
