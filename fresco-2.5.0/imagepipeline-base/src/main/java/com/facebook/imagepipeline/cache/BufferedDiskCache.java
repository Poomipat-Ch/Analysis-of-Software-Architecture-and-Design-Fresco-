...
public class BufferedDiskCache {
  ...
  private final com.facebook.cache.disk.FileCache mFileCache;

  private final com.facebook.common.memory.PooledByteBufferFactory mPooledByteBufferFactory;

  private final com.facebook.common.memory.PooledByteStreams mPooledByteStreams;
  ...
  public BufferedDiskCache(com.facebook.cache.disk.FileCache fileCache, com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory, com.facebook.common.memory.PooledByteStreams pooledByteStreams, Executor readExecutor, Executor writeExecutor, ImageCacheStatsTracker imageCacheStatsTracker) {
   ...
   */
  public boolean containsSync(com.facebook.cache.common.CacheKey key) {
   ...
   */
  public Task<Boolean> contains(final com.facebook.cache.common.CacheKey key) {
    if (containsSync(key)) {
  ...
  private Task<Boolean> containsAsync(final com.facebook.cache.common.CacheKey key) {
    try {
   ...
   */
  public boolean diskCheckSync(final com.facebook.cache.common.CacheKey key) {
    if (containsSync(key)) {
      return true;
    }
    return checkInStagingAreaAndFileCache(key);
   ...
   */
  public Task<com.facebook.imagepipeline.image.EncodedImage> get(com.facebook.cache.common.CacheKey key, AtomicBoolean isCancelled) {
    try {
   ...
   * @param key
   */
  public Task<Void> probe(final com.facebook.cache.common.CacheKey key) {
  ...
  public void addKeyForAsyncProbing(final com.facebook.cache.common.CacheKey key) {
    Preconditions.checkNotNull(key);
    mFileCache.probe(key);
  }
   ...
   */
  private boolean checkInStagingAreaAndFileCache(final com.facebook.cache.common.CacheKey key) {
  ...
  private Task<com.facebook.imagepipeline.image.EncodedImage> getAsync(final com.facebook.cache.common.CacheKey key, final AtomicBoolean isCancelled) {
    try {
   ...
   */
  public void put(final com.facebook.cache.common.CacheKey key, com.facebook.imagepipeline.image.EncodedImage encodedImage) {
    try {
      if (FrescoSystrace.isTracing()) {
   ...
   */
  public Task<Void> remove(final com.facebook.cache.common.CacheKey key) {
    Preconditions.checkNotNull(key);
  ...
  private Task<com.facebook.imagepipeline.image.EncodedImage> foundPinnedImage(com.facebook.cache.common.CacheKey key, com.facebook.imagepipeline.image.EncodedImage pinnedImage) {
    FLog.v(TAG, "Found image for %s in staging area", key.getUriString());
    mImageCacheStatsTracker.onStagingAreaHit(key);
   ...
   */
  @Nullable
  private com.facebook.common.memory.PooledByteBuffer readFromDiskCache(final com.facebook.cache.common.CacheKey key) throws IOException {
    try {
   ...
   * @throws IOException
   */
  private void writeToDiskCache(final com.facebook.cache.common.CacheKey key, final com.facebook.imagepipeline.image.EncodedImage encodedImage) {
