...
public class ImagePipelineTest {
  ...
  @Mock
  public ImagePipelineConfigInterface mConfig;

  private com.facebook.common.internal.Supplier<Boolean> mPrefetchEnabledSupplier;

  private com.facebook.common.internal.Supplier<Boolean> mSuppressBitmapPrefetchingSupplier;

  private com.facebook.common.internal.Supplier<Boolean> mLazyDataSourceSupplier;
  ...
  private com.facebook.imagepipeline.cache.BufferedDiskCache mMainDiskStorageCache;

  private com.facebook.imagepipeline.cache.BufferedDiskCache mSmallImageDiskStorageCache;

  private com.facebook.imagepipeline.listener.RequestListener mRequestListener1;

  private com.facebook.imagepipeline.listener.RequestListener mRequestListener2;

  private com.facebook.imagepipeline.producers.ThreadHandoffProducerQueue mThreadHandoffProducerQueue;
  ...
  private void verifyPrefetchToDiskCache(com.facebook.datasource.DataSource<Void> dataSource, com.facebook.imagepipeline.producers.Producer<Void> prefetchProducerSequence, com.facebook.imagepipeline.common.Priority priority) {
