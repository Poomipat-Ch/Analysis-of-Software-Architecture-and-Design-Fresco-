...
public class JpegTranscoderUtils {
   ...
   */
  public static final com.facebook.common.internal.ImmutableList<Integer> INVERTED_EXIF_ORIENTATIONS = 
      ImmutableList.of(
  ...
  public static int getSoftwareNumerator(com.facebook.imagepipeline.common.RotationOptions rotationOptions, @Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions, com.facebook.imagepipeline.image.EncodedImage encodedImage, boolean resizingEnabled)
  {
    if (!resizingEnabled) {
  ...
  public static int getRotationAngle(com.facebook.imagepipeline.common.RotationOptions rotationOptions, com.facebook.imagepipeline.image.EncodedImage encodedImage)
  {
   ...
   *     orientation
   */
  public static int getForceRotatedInvertedExifOrientation(com.facebook.imagepipeline.common.RotationOptions rotationOptions, com.facebook.imagepipeline.image.EncodedImage encodedImage)
  {
  ...
  @VisibleForTesting
  public static float determineResizeRatio(com.facebook.imagepipeline.common.ResizeOptions resizeOptions, int width, int height)
  {
    if (resizeOptions == null) {
      return 1.0f;
    }
   ...
   */
  @Nullable
  public static Matrix getTransformationMatrix(final com.facebook.imagepipeline.image.EncodedImage encodedImage, final com.facebook.imagepipeline.common.RotationOptions rotationOptions)
  {
  ...
  private static int extractOrientationFromMetadata(com.facebook.imagepipeline.image.EncodedImage encodedImage)
  {
