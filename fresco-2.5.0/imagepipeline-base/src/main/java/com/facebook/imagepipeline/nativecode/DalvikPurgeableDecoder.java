...
public abstract class DalvikPurgeableDecoder implements com.facebook.imagepipeline.platform.PlatformDecoder {
  static {
    ImagePipelineNativeLoader.load();
  }  protected static final byte[] EOI = 
      new byte[] {(byte) JfifUtil.MARKER_FIRST_BYTE, (byte) JfifUtil.MARKER_EOI};

  private final com.facebook.imagepipeline.memory.BitmapCounter mUnpooledBitmapsCounter;
  ...
  @Override
  public com.facebook.common.references.CloseableReference<Bitmap> decodeFromEncodedImage(com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig, @Nullable Rect regionToDecode) {
    return decodeFromEncodedImageWithColorSpace(encodedImage, bitmapConfig, regionToDecode, null);
  }

  @Override
  public com.facebook.common.references.CloseableReference<Bitmap> decodeJPEGFromEncodedImage(com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig, @Nullable Rect regionToDecode, int length) {
   ...
   */
  @Override
  public com.facebook.common.references.CloseableReference<Bitmap> decodeFromEncodedImageWithColorSpace(final com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig, @Nullable Rect regionToDecode, @Nullable final ColorSpace colorSpace) {
   ...
   */
  @Override
  public com.facebook.common.references.CloseableReference<Bitmap> decodeJPEGFromEncodedImageWithColorSpace(final com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig, @Nullable Rect regionToDecode, int length, @Nullable final ColorSpace colorSpace) {
    BitmapFactory.Options options =
        getBitmapFactoryOptions(encodedImage.getSampleSize(), bitmapConfig);
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      OreoUtils.setColorSpace(options, colorSpace);
   ...
   * @return
   */
  protected abstract Bitmap decodeByteArrayAsPurgeable(com.facebook.common.references.CloseableReference<PooledByteBuffer> bytesRef, BitmapFactory.Options options) ;
   ...
   * @return
   */
  protected abstract Bitmap decodeJPEGByteArrayAsPurgeable(com.facebook.common.references.CloseableReference<PooledByteBuffer> bytesRef, int length, BitmapFactory.Options options) ;
  ...
  @VisibleForTesting
  public static boolean endsWithEOI(com.facebook.common.references.CloseableReference<PooledByteBuffer> bytesRef, int length)
  {
   ...
   */
  public com.facebook.common.references.CloseableReference<Bitmap> pinBitmap(Bitmap bitmap) {
