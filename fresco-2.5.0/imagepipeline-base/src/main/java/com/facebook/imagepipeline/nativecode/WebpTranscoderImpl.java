...
public class WebpTranscoderImpl implements WebpTranscoder {
   ...
   */
  @Override
  public boolean isWebpNativelySupported(com.facebook.imageformat.ImageFormat webpFormat) {
  ...
  public void transcodeWebpToJpeg(InputStream inputStream, OutputStream outputStream, int quality) throws IOException {
    ...
    nativeTranscodeWebpToJpeg(
        Preconditions.checkNotNull(inputStream), Preconditions.checkNotNull(outputStream), quality);
  }
  ...
  public void transcodeWebpToPng(InputStream inputStream, OutputStream outputStream) throws IOException {
    ...
    nativeTranscodeWebpToPng(
        Preconditions.checkNotNull(inputStream), Preconditions.checkNotNull(outputStream));
  }
