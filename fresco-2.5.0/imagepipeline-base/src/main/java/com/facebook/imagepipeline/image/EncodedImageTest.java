...
public class EncodedImageTest {
  ...
  private com.facebook.common.internal.Supplier<FileInputStream> mInputStreamSupplier;
  ...
  private void checkWebpImage(final String imagePath, final com.facebook.imageformat.ImageFormat imageFormat, final int expectedWidth, final int expectedHeight) throws IOException {
    PooledByteBuffer buf =
        new TrivialPooledByteBuffer(
