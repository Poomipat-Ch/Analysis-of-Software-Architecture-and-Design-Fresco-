...
public class CountingMemoryCacheInspector<K, V> {
  public static class DumpInfoEntry<K, V> {
     ...
     */
    @Nullable
    public final com.facebook.common.references.CloseableReference<V> value;

    public DumpInfoEntry(final K key, final com.facebook.common.references.CloseableReference<V> valueRef) {
   ...
   * contents
   */
  public CountingMemoryCacheInspector.DumpInfo dumpCacheContent() {
