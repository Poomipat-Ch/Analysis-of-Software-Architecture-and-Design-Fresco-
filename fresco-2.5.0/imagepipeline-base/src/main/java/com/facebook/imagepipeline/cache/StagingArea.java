...
public class StagingArea {
  ...
  @GuardedBy("this")
  private Map<com.facebook.cache.common.CacheKey, EncodedImage> mMap;
   ...
   */
  public synchronized void put(final com.facebook.cache.common.CacheKey key, final com.facebook.imagepipeline.image.EncodedImage encodedImage) {
   ...
   */
  public boolean remove(final com.facebook.cache.common.CacheKey key) {
    Preconditions.checkNotNull(key);
   ...
   * @return true if item was removed
   */
  public synchronized boolean remove(final com.facebook.cache.common.CacheKey key, final com.facebook.imagepipeline.image.EncodedImage encodedImage) {
    Preconditions.checkNotNull(key);
   ...
   */
  @Nullable
  public synchronized com.facebook.imagepipeline.image.EncodedImage get(final com.facebook.cache.common.CacheKey key) {
    Preconditions.checkNotNull(key);
   ...
   */
  public synchronized boolean containsKey(com.facebook.cache.common.CacheKey key) {
    Preconditions.checkNotNull(key);
