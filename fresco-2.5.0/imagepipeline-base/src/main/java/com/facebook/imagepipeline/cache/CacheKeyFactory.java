...
public interface CacheKeyFactory {
   ...
   */
  com.facebook.cache.common.CacheKey getBitmapCacheKey(com.facebook.imagepipeline.request.ImageRequest request, @Nullable Object callerContext) ;

  /**
   *  @return {@link CacheKey} for doing post-processed bitmap cache lookups in the pipeline. 
   */
  com.facebook.cache.common.CacheKey getPostprocessedBitmapCacheKey(com.facebook.imagepipeline.request.ImageRequest request, @Nullable Object callerContext) ;
   ...
   */
  com.facebook.cache.common.CacheKey getEncodedCacheKey(com.facebook.imagepipeline.request.ImageRequest request, @Nullable Object callerContext) ;
   ...
   * @return {@link CacheKey} for doing encoded image lookups in the pipeline.
   */
  com.facebook.cache.common.CacheKey getEncodedCacheKey(com.facebook.imagepipeline.request.ImageRequest request, Uri sourceUri, @Nullable Object callerContext) ;
