...
public interface MemoryCache<K, V> extends com.facebook.common.memory.MemoryTrimmable, com.facebook.cache.common.HasDebugData {
  public interface CacheTrimStrategy {
    double getTrimRatio(com.facebook.common.memory.MemoryTrimType trimType) ;
   ...
   */
  @Nullable
  com.facebook.common.references.CloseableReference<V> cache(K key, com.facebook.common.references.CloseableReference<V> value) ;
   ...
   */
  @Nullable
  com.facebook.common.references.CloseableReference<V> get(K key) ;
   ...
   */
  int removeAll(com.facebook.common.internal.Predicate<K> predicate) ;
   ...
   */
  boolean contains(com.facebook.common.internal.Predicate<K> predicate) ;
