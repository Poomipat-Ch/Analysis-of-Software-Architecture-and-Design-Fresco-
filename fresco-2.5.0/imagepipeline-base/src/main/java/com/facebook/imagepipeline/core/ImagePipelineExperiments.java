...
public class ImagePipelineExperiments {
  public static class Builder {
    ...
    private com.facebook.common.webp.WebpBitmapFactory.WebpErrorLogger mWebpErrorLogger;

    private boolean mDecodeCancellationEnabled =  false;

    private com.facebook.common.webp.WebpBitmapFactory mWebpBitmapFactory;
    ...
    public com.facebook.common.internal.Supplier<Boolean> mLazyDataSource;
    ...
    public com.facebook.common.internal.Supplier<Boolean> mSuppressBitmapPrefetchingSupplier =  Suppliers.of(false);
    ...
    public ImagePipelineConfig.Builder setWebpErrorLogger(com.facebook.common.webp.WebpBitmapFactory.WebpErrorLogger webpErrorLogger) {
      mWebpErrorLogger = webpErrorLogger;
      return mConfigBuilder;
    }

    public ImagePipelineConfig.Builder setWebpBitmapFactory(com.facebook.common.webp.WebpBitmapFactory webpBitmapFactory) {
     ...
     */
    public ImagePipelineConfig.Builder setLazyDataSource(com.facebook.common.internal.Supplier<Boolean> lazyDataSource) {
    ...
    public ImagePipelineConfig.Builder setSuppressBitmapPrefetchingSupplier(com.facebook.common.internal.Supplier<Boolean> suppressBitmapPrefetchingSupplier) {
  ...
  private final com.facebook.common.webp.WebpBitmapFactory.WebpErrorLogger mWebpErrorLogger;

  private final boolean mDecodeCancellationEnabled;

  private final com.facebook.common.webp.WebpBitmapFactory mWebpBitmapFactory;
  ...
  private ImagePipelineExperiments(ImagePipelineExperiments.Builder builder) {
  ...
  public com.facebook.common.internal.Supplier<Boolean> getSuppressBitmapPrefetchingSupplier() {
  ...
  public static class DefaultProducerFactoryMethod implements ImagePipelineExperiments.ProducerFactoryMethod {
    @Override
    public ProducerFactory createProducerFactory(Context context, com.facebook.common.memory.ByteArrayPool byteArrayPool, com.facebook.imagepipeline.decoder.ImageDecoder imageDecoder, com.facebook.imagepipeline.decoder.ProgressiveJpegConfig progressiveJpegConfig, boolean downsampleEnabled, boolean resizeAndRotateEnabledForNetwork, boolean decodeCancellationEnabled, ExecutorSupplier executorSupplier, com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory, com.facebook.common.memory.PooledByteStreams pooledByteStreams, com.facebook.imagepipeline.cache.MemoryCache<CacheKey, CloseableImage> bitmapMemoryCache, com.facebook.imagepipeline.cache.MemoryCache<CacheKey, PooledByteBuffer> encodedMemoryCache, com.facebook.imagepipeline.cache.BufferedDiskCache defaultBufferedDiskCache, com.facebook.imagepipeline.cache.BufferedDiskCache smallImageBufferedDiskCache, com.facebook.imagepipeline.cache.CacheKeyFactory cacheKeyFactory, com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory platformBitmapFactory, int bitmapPrepareToDrawMinSizeBytes, int bitmapPrepareToDrawMaxSizeBytes, boolean bitmapPrepareToDrawForPrefetch, int maxBitmapSize, CloseableReferenceFactory closeableReferenceFactory, boolean keepCancelledFetchAsLowPriority, int trackedKeysSize) {
