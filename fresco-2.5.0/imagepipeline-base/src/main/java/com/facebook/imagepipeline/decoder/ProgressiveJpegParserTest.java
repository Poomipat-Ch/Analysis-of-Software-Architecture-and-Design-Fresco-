...
public class ProgressiveJpegParserTest {
  @Mock
  public com.facebook.common.references.ResourceReleaser mResourceReleaser;
   ...
   */
  private void testFirstNBytes(byte[] byteArray, int n, boolean foundNewScan, int expectedBestScan, int bestScanEndOffset) {
    assertEquals(
        foundNewScan,
  ...
  private static com.facebook.imagepipeline.image.EncodedImage buildEncodedImage(com.facebook.imagepipeline.testing.TrivialPooledByteBuffer byteBuffer)
  {
