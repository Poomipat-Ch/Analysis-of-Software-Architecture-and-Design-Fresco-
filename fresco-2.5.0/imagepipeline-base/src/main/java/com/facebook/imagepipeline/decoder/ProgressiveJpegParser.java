...
public class ProgressiveJpegParser {
  ...
  public ProgressiveJpegParser(com.facebook.common.memory.ByteArrayPool byteArrayPool) {
   ...
   */
  public boolean parseMoreData(final com.facebook.imagepipeline.image.EncodedImage encodedImage) {
