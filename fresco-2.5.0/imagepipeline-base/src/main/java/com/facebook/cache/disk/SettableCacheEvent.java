...
public class SettableCacheEvent implements com.facebook.cache.common.CacheEvent {
  ...
  public SettableCacheEvent setCacheKey(com.facebook.cache.common.CacheKey cacheKey) {
    mCacheKey = cacheKey;
    return this;
  }
  ...
  public SettableCacheEvent setEvictionReason(com.facebook.cache.common.CacheEventListener.EvictionReason evictionReason) {
