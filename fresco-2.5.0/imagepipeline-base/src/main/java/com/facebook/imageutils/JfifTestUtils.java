...
public class JfifTestUtils {
   ...
   *  content length 4
   */
  public static final String DQT =  DQT_MARKER + "0004 0000";

  /**
   *  content length 6
   */
  public static final String DHT =  DHT_MARKER + "0006 0000 0000";

  /**
   *  content length 4, optional
   */
  public static final String DRI =  DRI_MARKER + "0004 0000";

  /**
   *  content length 6
   */
  public static final String SOF =  SOF_MARKER + "0006 0000 0000";

  /**
   *  content length 4
   */
  public static final String SOS =  SOS_MARKER + "0004 0000";

  /**
   *  content length 4, optional
   */
  public static final String APP0 =  APP0_MARKER + "0004 0000";

  /**
   *  content length 4, optional
   */
  public static final String APP2 =  APP2_MARKER + "0004 0000";
  ...
  public static String makeIfdEntry(int tag, int type, int count, int value, int valueNumBytes, boolean littleEndian)
  {
