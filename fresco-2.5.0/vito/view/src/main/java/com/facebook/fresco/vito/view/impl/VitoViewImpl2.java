...
public class VitoViewImpl2 implements com.facebook.fresco.vito.view.VitoView.Implementation {
  ...
  private final com.facebook.fresco.vito.core.FrescoController2 mController;

  private final com.facebook.fresco.vito.core.VitoImagePipeline mVitoImagePipeline;

  public VitoViewImpl2(com.facebook.fresco.vito.core.FrescoController2 controller, com.facebook.fresco.vito.core.VitoImagePipeline vitoImagePipeline) {
    mController = controller;
    mVitoImagePipeline = vitoImagePipeline;
  }

  @Override
  public void show(final com.facebook.fresco.vito.source.ImageSource imageSource, final com.facebook.fresco.vito.options.ImageOptions imageOptions, @Nullable final Object callerContext, @Nullable final com.facebook.fresco.vito.listener.ImageListener imageListener, final View target) {
  ...
  private void fetchImage(final com.facebook.fresco.vito.core.FrescoDrawable2 drawable, final com.facebook.fresco.vito.core.VitoImageRequest request) {
    mController.fetch(
        drawable,
        request,
   ...
   */
  private com.facebook.fresco.vito.core.FrescoDrawable2 ensureDrawableSet(final View target) {
  ...
  @Nullable
  private static com.facebook.fresco.vito.core.FrescoDrawable2 getDrawable(final View view)
  {
    Drawable d =
  ...
  private com.facebook.fresco.vito.core.FrescoDrawable2 createDrawable() {
