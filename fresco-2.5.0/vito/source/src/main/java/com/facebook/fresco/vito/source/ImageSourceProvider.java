...
public class ImageSourceProvider {
   ...
   * @return the ImageSource to be passed to the UI component
   */
  public static ImageSource increasingQuality(ImageSource lowResImageSource, ImageSource highResImageSource)
  {
  ...
  @Nullable
  private static ImageSourceProvider.Implementation sImplementation;

  private ImageSourceProvider() {
  }

  public static void setImplementation(ImageSourceProvider.Implementation implementation)
  {
  ...
  private static ImageSourceProvider.Implementation get()
  {
