...
public class FrescoDrawable2ImplTest {
  ...
  private com.facebook.imagepipeline.image.CloseableImage mCloseableImage;

  private com.facebook.common.references.CloseableReference<CloseableImage> mCloseableReference;
  ...
  @Test
  public void testFrescoDrawable_whenDrawableClosed_thenReleaseActualImageReference() throws InterruptedException {
  ...
  @Test
  public void testFrescoDrawable_whenNewImageDrawableSet_thenReleaseOldImageReference() throws InterruptedException {
    mFrescoDrawable.setImage(NopDrawable.INSTANCE, mCloseableReference);
    mCloseableReference.close();
  ...
  @Test
  public void testFrescoDrawable_whenNewNullImageDrawableSet_thenReleaseOldImageReference() throws InterruptedException {
    mFrescoDrawable.setImage(NopDrawable.INSTANCE, mCloseableReference);
    mCloseableReference.close();
  ...
  @Test
  public void testFrescoDrawable_whenImageDrawableSet_thenReleaseImageReference() throws InterruptedException {
    mFrescoDrawable.setImage(NopDrawable.INSTANCE, mCloseableReference);
    mCloseableReference.close();
  ...
  @Test
  public void testFrescoDrawable_whenImageDrawableReset_thenReleaseImageReference() throws InterruptedException {
    mFrescoDrawable.setImage(NopDrawable.INSTANCE, mCloseableReference);
    mCloseableReference.close();
  ...
  static class DummyCloseableImage extends com.facebook.imagepipeline.image.CloseableImage {
