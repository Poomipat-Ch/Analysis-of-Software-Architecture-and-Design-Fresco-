...
public class FrescoVitoImageDecodeOptionsBuilder extends com.facebook.imagepipeline.common.ImageDecodeOptionsBuilder<> {
  @Nullable
   ...
   */
  public FrescoVitoImageDecodeOptionsBuilder setScaleType(com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType) {
