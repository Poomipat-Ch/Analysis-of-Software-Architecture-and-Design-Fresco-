...
public class ImagePipelineUtilsImplTest {
  ...
  private final com.facebook.imagepipeline.common.ImageDecodeOptions mRoundingDecodeOptions =  mock(ImageDecodeOptions.class);

  private final com.facebook.imagepipeline.common.ImageDecodeOptions mRoundingDecodeOptionsAntiAliased = 
      mock(ImageDecodeOptions.class);

  private com.facebook.fresco.vito.core.ImagePipelineUtils mImagePipelineUtils;

  private com.facebook.fresco.vito.core.ImagePipelineUtils mImagePipelineUtilsNoNativeRounding;
