...
public class CircularBorderBitmapDrawable extends BitmapDrawable {
  ...
  @Nullable
  private com.facebook.fresco.vito.options.BorderOptions mBorderOptions;
  ...
  public void setBorder(@Nullable com.facebook.fresco.vito.options.BorderOptions borderOptions) {
  ...
  @Nullable
  public com.facebook.fresco.vito.options.BorderOptions getBorder() {
