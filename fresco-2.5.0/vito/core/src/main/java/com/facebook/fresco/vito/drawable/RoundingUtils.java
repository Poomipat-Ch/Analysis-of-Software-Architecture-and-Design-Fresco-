...
public class RoundingUtils {
   ...
   */
  public Drawable roundedDrawable(Resources resources, Bitmap bitmap, @Nullable com.facebook.fresco.vito.options.BorderOptions borderOptions, @Nullable com.facebook.fresco.vito.options.RoundingOptions roundingOptions) {
   ...
   * @return a drawable with the applied effect
   */
  public Drawable roundedDrawable(Resources resources, Drawable drawable, @Nullable com.facebook.fresco.vito.options.BorderOptions borderOptions, @Nullable com.facebook.fresco.vito.options.RoundingOptions roundingOptions) {
    if (borderOptions != null && borderOptions.width > 0) {
  ...
  private Drawable roundedDrawableWithoutBorder(Resources resources, Bitmap bitmap, @Nullable com.facebook.fresco.vito.options.RoundingOptions roundingOptions) {
  ...
  private Drawable roundedDrawableWithBorder(Resources resources, Bitmap bitmap, com.facebook.fresco.vito.options.BorderOptions borderOptions, @Nullable com.facebook.fresco.vito.options.RoundingOptions roundingOptions) {
    if (roundingOptions == null) {
  ...
  private Drawable roundedDrawableWithoutBorder(Resources resources, Drawable drawable, @Nullable com.facebook.fresco.vito.options.RoundingOptions roundingOptions) {
    if (roundingOptions != null) {
  ...
  private Drawable roundedDrawableWithBorder(Resources resources, Drawable drawable, com.facebook.fresco.vito.options.BorderOptions borderOptions, @Nullable com.facebook.fresco.vito.options.RoundingOptions roundingOptions) {
    if (roundingOptions == null) {
  ...
  private static <T extends Drawable & Rounded> T getRoundedDrawable(Resources resources, @Nullable Bitmap bitmap)
  {
  ...
  private <T extends Drawable & Rounded> Drawable applyRounding(T drawable, @Nullable com.facebook.fresco.vito.options.BorderOptions borderOptions, com.facebook.fresco.vito.options.RoundingOptions roundingOptions) {
  ...
  private <T extends Drawable & Rounded> Drawable squareDrawableWithBorder(T drawable, com.facebook.fresco.vito.options.BorderOptions borderOptions) {
  ...
  private static <T extends Drawable & Rounded> Drawable circularDrawable(T drawable, @Nullable com.facebook.fresco.vito.options.BorderOptions borderOptions)
  {
  ...
  private static <T extends Drawable & Rounded> Drawable roundedCornerDrawable(T drawable, @Nullable com.facebook.fresco.vito.options.BorderOptions borderOptions, @Nullable com.facebook.fresco.vito.options.RoundingOptions roundingOptions)
  {
    if (borderOptions != null) {
      applyBorders(drawable, borderOptions);
    }
   ...
   */
  private static <T extends Drawable & Rounded> void applyBorders(T drawable, com.facebook.fresco.vito.options.BorderOptions borderOptions)
  {
