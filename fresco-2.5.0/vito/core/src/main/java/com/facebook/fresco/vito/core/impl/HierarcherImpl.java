...
public class HierarcherImpl implements Hierarcher {
  ...
  private final com.facebook.fresco.vito.options.ImageOptionsDrawableFactory mDrawableFactory;

  private final com.facebook.fresco.vito.drawable.RoundingUtils mRoundingUtils;

  public HierarcherImpl(com.facebook.fresco.vito.options.ImageOptionsDrawableFactory drawableFactory) {
  ...
  @Nullable
  @Override
  public Drawable buildActualImageDrawable(Resources resources, com.facebook.fresco.vito.options.ImageOptions imageOptions, com.facebook.common.references.CloseableReference<CloseableImage> closeableImage) {
  ...
  @Override
  public Drawable buildPlaceholderDrawable(Resources resources, com.facebook.fresco.vito.options.ImageOptions imageOptions) {
  ...
  protected Drawable applyRoundingOptions(Resources resources, Drawable placeholderDrawable, com.facebook.fresco.vito.options.ImageOptions imageOptions) {
  ...
  @Override
  @Nullable
  public Drawable buildProgressDrawable(Resources resources, com.facebook.fresco.vito.options.ImageOptions imageOptions) {
    if (FrescoSystrace.isTracing()) {
  ...
  @Override
  @Nullable
  public Drawable buildErrorDrawable(Resources resources, com.facebook.fresco.vito.options.ImageOptions imageOptions) {
    if (FrescoSystrace.isTracing()) {
  ...
  @Override
  public com.facebook.drawee.drawable.ForwardingDrawable buildActualImageWrapper(com.facebook.fresco.vito.options.ImageOptions imageOptions, @Nullable Object callerContext) {
  ...
  @Override
  public void setupActualImageWrapper(com.facebook.drawee.drawable.ScaleTypeDrawable actualImageWrapper, com.facebook.fresco.vito.options.ImageOptions imageOptions, @Nullable Object callerContext) {
  ...
  @Override
  @Nullable
  public Drawable buildOverlayDrawable(Resources resources, com.facebook.fresco.vito.options.ImageOptions imageOptions) {
