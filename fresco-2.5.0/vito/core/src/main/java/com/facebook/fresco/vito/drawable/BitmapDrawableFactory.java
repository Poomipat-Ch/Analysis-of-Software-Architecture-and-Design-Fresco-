...
public class BitmapDrawableFactory implements com.facebook.fresco.vito.options.ImageOptionsDrawableFactory {
   ...
   */
  protected Drawable handleCloseableStaticBitmap(com.facebook.imagepipeline.image.CloseableStaticBitmap closeableStaticBitmap, com.facebook.fresco.vito.options.ImageOptions imageOptions) {
  ...
  protected Drawable rotatedDrawable(com.facebook.imagepipeline.image.CloseableStaticBitmap closeableStaticBitmap, Drawable drawable) {
   ...
   */
  private static boolean hasTransformableRotationAngle(com.facebook.imagepipeline.image.CloseableStaticBitmap closeableStaticBitmap)
  {
   ...
   */
  private static boolean hasTransformableExifOrientation(com.facebook.imagepipeline.image.CloseableStaticBitmap closeableStaticBitmap)
  {
