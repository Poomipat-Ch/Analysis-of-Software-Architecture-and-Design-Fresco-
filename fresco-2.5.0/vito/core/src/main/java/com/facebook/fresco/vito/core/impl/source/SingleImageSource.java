...
public class SingleImageSource implements VitoImageSource {
  private final com.facebook.imagepipeline.request.ImageRequest mMainImageRequest;

  private final com.facebook.imagepipeline.request.ImageRequest.RequestLevel mRequestLevelForFetch;

  public SingleImageSource(com.facebook.imagepipeline.request.ImageRequest mainImageRequest) {
    this(mainImageRequest, ImageRequest.RequestLevel.FULL_FETCH);
  }

  public SingleImageSource(com.facebook.imagepipeline.request.ImageRequest mainImageRequest, com.facebook.imagepipeline.request.ImageRequest.RequestLevel requestLevelForFetch) {
