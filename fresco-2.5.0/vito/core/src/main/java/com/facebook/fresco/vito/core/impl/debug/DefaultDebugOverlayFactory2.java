...
public class DefaultDebugOverlayFactory2 extends BaseDebugOverlayFactory2 {
  public DefaultDebugOverlayFactory2(com.facebook.common.internal.Supplier<Boolean> debugOverlayEnabled) {
    super(debugOverlayEnabled);
  }

  @Override
  protected void setData(DebugOverlayDrawable overlay, com.facebook.fresco.vito.core.FrescoDrawable2 drawable, @Nullable com.facebook.fresco.ui.common.ControllerListener2.Extras extras) {
    setBasicData(overlay, drawable);
    setImageRequestData(overlay, drawable.getImageRequest());
    setImageOriginData(overlay, extras);
  }

  private static void setBasicData(DebugOverlayDrawable overlay, com.facebook.fresco.vito.core.FrescoDrawable2 drawable)
  {
  ...
  private static void setImageOriginData(DebugOverlayDrawable overlay, @Nullable com.facebook.fresco.ui.common.ControllerListener2.Extras extras)
  {
  ...
  private static void setImageRequestData(DebugOverlayDrawable overlay, @Nullable com.facebook.fresco.vito.core.VitoImageRequest imageRequest)
  {
