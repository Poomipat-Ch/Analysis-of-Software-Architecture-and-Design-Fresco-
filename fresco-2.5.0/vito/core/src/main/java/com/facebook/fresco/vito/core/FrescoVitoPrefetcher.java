...
public interface FrescoVitoPrefetcher {
   ...
   */
  com.facebook.datasource.DataSource<Void> prefetch(PrefetchTarget prefetchTarget, Uri uri, @Nullable com.facebook.fresco.vito.options.ImageOptions imageOptions, @Nullable Object callerContext, String callsite) ;
   ...
   * @return a DataSource that can safely be ignored.
   */
  com.facebook.datasource.DataSource<Void> prefetchToBitmapCache(Uri uri, @Nullable com.facebook.fresco.vito.options.DecodedImageOptions imageOptions, @Nullable Object callerContext, String callsite) ;
   ...
   * @return a DataSource that can safely be ignored.
   */
  com.facebook.datasource.DataSource<Void> prefetchToEncodedCache(Uri uri, @Nullable com.facebook.fresco.vito.options.EncodedImageOptions imageOptions, @Nullable Object callerContext, String callsite) ;
   ...
   * @return a DataSource that can safely be ignored.
   */
  com.facebook.datasource.DataSource<Void> prefetchToDiskCache(Uri uri, @Nullable com.facebook.fresco.vito.options.ImageOptions imageOptions, @Nullable Object callerContext, String callsite) ;
   ...
   * @return a DataSource that can safely be ignored.
   */
  com.facebook.datasource.DataSource<Void> prefetch(PrefetchTarget prefetchTarget, VitoImageRequest imageRequest, @Nullable Object callerContext, @Nullable com.facebook.imagepipeline.listener.RequestListener requestListener, String callsite) ;
