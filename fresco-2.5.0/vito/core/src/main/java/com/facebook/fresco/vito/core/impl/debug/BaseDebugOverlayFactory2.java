...
public abstract class BaseDebugOverlayFactory2 implements DebugOverlayFactory2 {
  private final com.facebook.common.internal.Supplier<Boolean> mDebugOverlayEnabled;

  public BaseDebugOverlayFactory2(com.facebook.common.internal.Supplier<Boolean> debugOverlayEnabled) {
    mDebugOverlayEnabled = debugOverlayEnabled;
  }

  @Override
  public void update(com.facebook.fresco.vito.core.FrescoDrawable2 drawable, @Nullable com.facebook.fresco.ui.common.ControllerListener2.Extras extras) {
  ...
  protected abstract void setData(DebugOverlayDrawable overlay, com.facebook.fresco.vito.core.FrescoDrawable2 drawable, @Nullable com.facebook.fresco.ui.common.ControllerListener2.Extras extras) ;

  private static DebugOverlayDrawable extractOrCreate(com.facebook.fresco.vito.core.FrescoDrawable2 drawable)
  {
  ...
  private static class DebugOverlayDrawableWrapper extends LayerDrawable {
    ...
    public DebugOverlayDrawableWrapper(Drawable existingOverlayDrawable, DebugOverlayDrawable debugOverlayDrawable) {
