...
public interface ImageListener extends com.facebook.fresco.ui.common.OnDrawControllerListener<> {
  /**
   ...
   */
  void onFinalImageSet(long id, @ImageOrigin int imageOrigin, @Nullable com.facebook.imagepipeline.image.ImageInfo imageInfo, @Nullable Drawable drawable) ;
   ...
   * @param imageInfo image info
   */
  void onIntermediateImageSet(long id, @Nullable com.facebook.imagepipeline.image.ImageInfo imageInfo) ;
