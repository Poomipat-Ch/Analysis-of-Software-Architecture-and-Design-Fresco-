...
public class FrescoVitoTapToRetryImageSpec {
  @PropDefault
  protected static final int maxTapCount =  Integer.MAX_VALUE;
  ...
  static void onCreateInitialState(ComponentContext c, StateValue<Boolean> isTapToRetry, StateValue<Integer> tapCount, @Prop(optional = true) boolean isInitialTapToLoad)
  {
  ...
  @OnCreateLayout
  static Component onCreateLayout(final ComponentContext c, @Prop final com.facebook.fresco.vito.source.ImageSource imageSource, @Nullable final Object callerContext, @Prop(optional = true, resType = ResType.FLOAT) final float imageAspectRatio, @Nullable final EventHandler<ClickEvent> imageClickHandler, @Nullable final EventHandler<LongClickEvent> imageLongClickHandler, @Nullable final EventHandler<TouchEvent> imageTouchHandler, @Nullable final com.facebook.fresco.vito.listener.ImageListener imageListener, @Nullable final com.facebook.fresco.vito.options.ImageOptions imageOptions, @Prop(optional = true) final int maxTapCount, @Prop(optional = true) final com.facebook.drawee.drawable.FadeDrawable.OnFadeListener onFadeListener, @Nullable final FrescoVitoImage2Spec.Prefetch prefetch, @Nullable final com.facebook.imagepipeline.listener.RequestListener prefetchRequestListener, @Nullable final Drawable retryImage, @Nullable final com.facebook.drawee.drawable.ScalingUtils.ScaleType retryImageScaleType, @State final boolean isTapToRetry, @State final int tapCount)
  {
    if (isTapToRetry) {
