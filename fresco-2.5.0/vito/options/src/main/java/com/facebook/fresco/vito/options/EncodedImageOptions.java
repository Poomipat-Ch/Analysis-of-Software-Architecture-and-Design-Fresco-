...
public class EncodedImageOptions {
  public static class Builder<T extends EncodedImageOptions.Builder> {
    @Nullable
    private com.facebook.imagepipeline.common.Priority mPriority;

    @Nullable
    private com.facebook.imagepipeline.request.ImageRequest.CacheChoice mCacheChoice;
    ...
    public T priority(@Nullable com.facebook.imagepipeline.common.Priority priority) {
      mPriority = priority;
      return getThis();
    }

    public T cacheChoice(@Nullable com.facebook.imagepipeline.request.ImageRequest.CacheChoice cacheChoice) {
  ...
  public static EncodedImageOptions.Builder create()
  {
    return new Builder(ImageOptions.defaults());
  }

  @Nullable
  private final com.facebook.imagepipeline.common.Priority mPriority;

  @Nullable
  private final com.facebook.imagepipeline.request.ImageRequest.CacheChoice mCacheChoice;

  public EncodedImageOptions(EncodedImageOptions.Builder builder) {
  ...
  protected com.facebook.common.internal.Objects.ToStringHelper toStringHelper() {
