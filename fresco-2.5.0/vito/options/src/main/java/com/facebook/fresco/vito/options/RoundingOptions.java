...
public class RoundingOptions {
  ...
  public static RoundingOptions forCornerRadii(float topLeft, float topRight, float bottomRight, float bottomLeft)
  {
  ...
  private RoundingOptions(boolean isCircular, float cornerRadiusPx, @Nullable float[] cornerRadii, boolean antiAliasing, boolean forceRoundAtDecode) {
