...
public class BorderOptions {
   ...
   * @return BorderOptions
   */
  public static BorderOptions create(@ColorInt int color, float width, float padding, boolean scaleDownInsideBorders)
  {
  ...
  public BorderOptions(@ColorInt int color, float width, float padding, boolean scaleDownInsideBorders) {
    this.color = color;
    this.width = width;
