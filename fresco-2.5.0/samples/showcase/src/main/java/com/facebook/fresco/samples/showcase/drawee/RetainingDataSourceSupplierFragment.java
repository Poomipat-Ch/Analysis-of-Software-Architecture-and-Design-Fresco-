...
public class RetainingDataSourceSupplierFragment extends com.facebook.fresco.samples.showcase.BaseShowcaseFragment {
  private List<Uri> mSampleUris;

  private int mUriIndex =  0;

  private com.facebook.drawee.controller.ControllerListener controllerListener = 
  ...
  private void replaceImage(com.facebook.datasource.RetainingDataSourceSupplier<CloseableReference<CloseableImage>> retainingSupplier) {
