 ...
 */
public class DraweeHierarchyFragment extends com.facebook.fresco.samples.showcase.BaseShowcaseFragment {
  ...
  private void setUri(com.facebook.drawee.view.SimpleDraweeView draweeView, Uri uri, boolean retryEnabled) {
