...
public class SimpleScaleTypeAdapter extends BaseAdapter {
  public static class Entry {
    public final com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType;
    ...
    private Entry(com.facebook.drawee.drawable.ScalingUtils.ScaleType scaleType, String description, @Nullable PointF focusPoint) {
  ...
  private static final SimpleScaleTypeAdapter.Entry[] BUILT_IN_SPINNER_ENTRIES = 
      new Entry[] {
  ...
  private static final SimpleScaleTypeAdapter.Entry[] CUSTOM_TYPES = 
      new Entry[] {
  ...
  private final List<SimpleScaleTypeAdapter.Entry> mEntries;

  private SimpleScaleTypeAdapter(SimpleScaleTypeAdapter.Entry[] entries) {
