...
public class ResizableFrameLayout extends FrameLayout {
  ...
  @Nullable
  private ResizableFrameLayout.SizeChangedListener mSizeChangedListener;
  ...
  public void setUpdateMaximumDimensionOnNextSizeChange(boolean updateMaximumDimensionOnNextSizeChange) {
    mUpdateMaximumDimensionOnNextSizeChange = updateMaximumDimensionOnNextSizeChange;
  }

  public void setSizeChangedListener(@Nullable ResizableFrameLayout.SizeChangedListener sizeChangedListener) {
