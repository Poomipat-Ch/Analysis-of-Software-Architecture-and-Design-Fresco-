 ...
 */
public class FrescoVitoRegionDecoder implements com.facebook.imagepipeline.decoder.ImageDecoder {
  private final com.facebook.imagepipeline.platform.PlatformDecoder mPlatformDecoder;

  public FrescoVitoRegionDecoder(com.facebook.imagepipeline.platform.PlatformDecoder platformDecoder) {
  ...
  @Nullable
  private Rect computeRegionToDecode(com.facebook.imagepipeline.image.EncodedImage encodedImage, com.facebook.imagepipeline.common.ImageDecodeOptions options) {
