 ...
 * notifications.
 */
public class ImagePipelineResizingFragment extends com.facebook.fresco.samples.showcase.BaseShowcaseFragment {
  private class SizeEntry {
    @Nullable
    final com.facebook.imagepipeline.common.ResizeOptions resizeOptions;

    SizeEntry(@Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions) {
  ...
  private final ImagePipelineResizingFragment.SizeEntry[] SPINNER_ENTRIES_SIZE = 
      new SizeEntry[] {
        new SizeEntry(null),
  ...
  private ImagePipelineResizingFragment.ImageFormatEntry[] mImageFormatEntries;

  private Button mButton;

  private com.facebook.drawee.view.SimpleDraweeView mDraweeMain;
  ...
  private void reloadImage(Uri imageUri, @Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions) {
  ...
  private class SimpleImageFormatAdapter extends BaseAdapter {
    private final ImagePipelineResizingFragment.ImageFormatEntry[] mImageFormatEntries;

    public SimpleImageFormatAdapter(ImagePipelineResizingFragment.ImageFormatEntry[] imageFormatEntries) {
