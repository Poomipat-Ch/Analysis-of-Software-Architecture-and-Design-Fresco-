...
public class SimpleGallerySectionSpec {
  ...
  static RenderInfo onRender(final SectionContext c, @Prop(optional = true) boolean enableTapToRetry, @Prop(optional = true) boolean isInitialTapToLoad, @FromEvent Uri model)
  {
  ...
  static boolean onTouchEvent(SectionContext c, @FromEvent View view, @FromEvent MotionEvent motionEvent)
  {
