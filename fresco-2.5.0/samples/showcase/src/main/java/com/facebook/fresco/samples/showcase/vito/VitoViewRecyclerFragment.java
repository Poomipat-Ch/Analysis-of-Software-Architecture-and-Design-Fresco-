 ...
 */
public class VitoViewRecyclerFragment extends com.facebook.fresco.samples.showcase.BaseShowcaseFragment {
  /**
  ...
  @Nullable
  private com.facebook.imagepipeline.common.ResizeOptions mResizeOptions;

  private com.facebook.fresco.vito.options.ImageOptions.Builder mOptionsBuilder =  ImageOptions.create().fadeDurationMs(500);
  ...
  public class SimpleAdapter extends RecyclerView.Adapter<SimpleViewHolder> {
    ...
    @Override
    public VitoViewRecyclerFragment.SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View itemView =
    ...
    @Override
    public void onBindViewHolder(VitoViewRecyclerFragment.SimpleViewHolder holder, int position) {
