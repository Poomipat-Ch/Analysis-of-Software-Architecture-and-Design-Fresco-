 ...
 */
public class ImageFormatOverrideExample extends com.facebook.fresco.samples.showcase.BaseShowcaseFragment {
  private static final com.facebook.imagepipeline.decoder.ImageDecoder CUSTOM_COLOR_DECODER =  ColorImageExample.createDecoder();
