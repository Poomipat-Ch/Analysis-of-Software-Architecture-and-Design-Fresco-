 ...
 * finally displayed.
 */
public class ImagePipelinePrefetchFragment extends com.facebook.fresco.samples.showcase.BaseShowcaseFragment {
  private Uri[] mUris;
  ...
  private final com.facebook.drawee.backends.pipeline.info.ImageOriginListener mImageOriginListener = 
  ...
  private class PrefetchSubscriber extends com.facebook.datasource.BaseDataSubscriber<> {
    private int mSuccessful =  0;

    private int mFailed =  0;

    @Override
    protected void onNewResultImpl(com.facebook.datasource.DataSource<Void> dataSource) {
      mSuccessful++;
      updateDisplay();
    }

    @Override
    protected void onFailureImpl(com.facebook.datasource.DataSource<Void> dataSource) {
      mFailed++;
      updateDisplay();
    }
