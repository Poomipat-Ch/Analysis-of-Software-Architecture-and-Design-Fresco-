...
public class SimpleListSectionSpec {
  ...
  static RenderInfo onRender(final SectionContext c, @FromEvent SimpleListSectionSpec.Data model)
  {
  ...
  private static List<SimpleListSectionSpec.Data> generateData(final SectionContext c, int count)
  {
