 ...
 */
public class DraweeRecyclerViewFragment extends com.facebook.fresco.samples.showcase.BaseShowcaseFragment {
  /**
  ...
  public class SimpleAdapter extends RecyclerView.Adapter<SimpleViewHolder> {
    ...
    @Override
    public DraweeRecyclerViewFragment.SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View itemView =
    ...
    @Override
    public void onBindViewHolder(DraweeRecyclerViewFragment.SimpleViewHolder holder, int position) {
  ...
  static class SimpleViewHolder extends RecyclerView.ViewHolder {
    ...
    private final com.facebook.drawee.view.SimpleDraweeView mSimpleDraweeView;
