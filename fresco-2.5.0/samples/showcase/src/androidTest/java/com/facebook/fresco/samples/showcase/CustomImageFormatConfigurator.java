...
public class CustomImageFormatConfigurator {
  ...
  public static com.facebook.imagepipeline.decoder.ImageDecoderConfig createImageDecoderConfig(Context context)
  {
  ...
  public static void addCustomDrawableFactories(Context context, com.facebook.drawee.backends.pipeline.DraweeConfig.Builder draweeConfigBuilder)
  {
