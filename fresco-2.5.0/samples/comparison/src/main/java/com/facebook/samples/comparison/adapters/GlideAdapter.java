...
public class GlideAdapter extends ImageListAdapter {
  public GlideAdapter(Context context, com.facebook.samples.comparison.instrumentation.PerfListener perfListener) {
    super(context, perfListener);
  }

  @Override
  public com.facebook.samples.comparison.holders.GlideHolder onCreateViewHolder(ViewGroup parent, int viewType) {
