 ...
 */
public class UilHolder extends BaseViewHolder<> {
  private final ImageLoader mImageLoader;

  public UilHolder(Context context, ImageLoader imageLoader, View layoutView, com.facebook.samples.comparison.instrumentation.InstrumentedImageView view, com.facebook.samples.comparison.instrumentation.PerfListener perfListener) {
