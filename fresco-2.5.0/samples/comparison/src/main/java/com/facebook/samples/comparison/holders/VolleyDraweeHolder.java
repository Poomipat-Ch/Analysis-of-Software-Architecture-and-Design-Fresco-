 ...
 */
public class VolleyDraweeHolder extends BaseViewHolder<> {
  public VolleyDraweeHolder(Context context, View parentView, com.facebook.samples.comparison.instrumentation.InstrumentedDraweeView view, com.facebook.samples.comparison.instrumentation.PerfListener perfListener) {
