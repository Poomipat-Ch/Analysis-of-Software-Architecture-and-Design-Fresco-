 ...
 */
public class PicassoHolder extends BaseViewHolder<> {
  private final Picasso mPicasso;

  public PicassoHolder(Context context, Picasso picasso, View parent, com.facebook.samples.comparison.instrumentation.InstrumentedImageView view, com.facebook.samples.comparison.instrumentation.PerfListener perfListener) {
