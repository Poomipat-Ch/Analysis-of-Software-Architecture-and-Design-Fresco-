...
public class PicassoAdapter extends ImageListAdapter {
  ...
  public PicassoAdapter(Context context, com.facebook.samples.comparison.instrumentation.PerfListener perfListener) {
    super(context, perfListener);
    mPicasso = SamplePicassoFactory.getPicasso(context);
  }

  @Override
  public com.facebook.samples.comparison.holders.PicassoHolder onCreateViewHolder(ViewGroup parent, int viewType) {
