...
public class FrescoAdapter extends ImageListAdapter {
  public FrescoAdapter(Context context, com.facebook.samples.comparison.instrumentation.PerfListener perfListener, com.facebook.imagepipeline.core.ImagePipelineConfig imagePipelineConfig) {
    super(context, perfListener);
    Fresco.initialize(context, imagePipelineConfig);
  }

  @Override
  public com.facebook.samples.comparison.holders.FrescoHolder onCreateViewHolder(ViewGroup parent, int viewType) {
