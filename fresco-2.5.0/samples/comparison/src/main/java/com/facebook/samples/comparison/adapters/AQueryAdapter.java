...
public class AQueryAdapter extends ImageListAdapter {
  ...
  public AQueryAdapter(Context context, com.facebook.samples.comparison.instrumentation.PerfListener perfListener) {
    super(context, perfListener);
    mAQuery = new AQuery(context);
  }

  @Override
  public com.facebook.samples.comparison.holders.AQueryHolder onCreateViewHolder(ViewGroup parent, int viewType) {
