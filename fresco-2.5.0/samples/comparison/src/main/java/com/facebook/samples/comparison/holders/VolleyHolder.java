 ...
 */
public class VolleyHolder extends BaseViewHolder<> {
  private final ImageLoader mImageLoader;

  public VolleyHolder(Context context, ImageLoader imageLoader, View layoutView, com.facebook.samples.comparison.instrumentation.InstrumentedNetworkImageView view, com.facebook.samples.comparison.instrumentation.PerfListener perfListener) {
