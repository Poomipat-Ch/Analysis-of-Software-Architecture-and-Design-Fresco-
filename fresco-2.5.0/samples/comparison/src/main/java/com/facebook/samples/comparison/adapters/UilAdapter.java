...
public class UilAdapter extends ImageListAdapter {
  ...
  public UilAdapter(Context context, com.facebook.samples.comparison.instrumentation.PerfListener perfListener) {
    super(context, perfListener);
    mImageLoader = SampleUilFactory.getImageLoader(context);
  }

  @Override
  public com.facebook.samples.comparison.holders.UilHolder onCreateViewHolder(ViewGroup parent, int viewType) {
