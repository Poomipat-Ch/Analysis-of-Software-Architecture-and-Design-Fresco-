...
public class VolleyAdapter extends ImageListAdapter {
  ...
  public VolleyAdapter(Context context, com.facebook.samples.comparison.instrumentation.PerfListener perfListener) {
    super(context, perfListener);
    mImageLoader = SampleVolleyFactory.getImageLoader(context);
  }

  @Override
  public com.facebook.samples.comparison.holders.VolleyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
