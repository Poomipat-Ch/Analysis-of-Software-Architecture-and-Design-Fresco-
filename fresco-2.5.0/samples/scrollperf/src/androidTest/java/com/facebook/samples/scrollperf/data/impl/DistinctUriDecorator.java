 ...
 */
public enum DistinctUriDecorator implements com.facebook.samples.scrollperf.data.Decorator<> {
  SINGLETON,;
  @Override
  public Uri decorate(com.facebook.samples.scrollperf.data.SimpleAdapter<Uri> decoratee, int position) {
