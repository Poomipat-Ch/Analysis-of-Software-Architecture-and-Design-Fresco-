 ...
 */
public class InstrumentedDraweeView extends com.facebook.drawee.view.SimpleDraweeView implements Instrumented {
  private Instrumentation mInstrumentation;

  private com.facebook.samples.scrollperf.conf.Config mConfig;

  private com.facebook.drawee.controller.ControllerListener<Object> mListener;

  public InstrumentedDraweeView(Context context, com.facebook.drawee.generic.GenericDraweeHierarchy hierarchy, com.facebook.samples.scrollperf.conf.Config config) {
  ...
  public void setListener(com.facebook.drawee.controller.AbstractDraweeControllerBuilder controllerBuilder) {
    if (mConfig.instrumentationEnabled) {
      controllerBuilder.setControllerListener(mListener);
    }
  }

  public com.facebook.drawee.controller.ControllerListener<Object> getListener() {
    return mListener;
  }
