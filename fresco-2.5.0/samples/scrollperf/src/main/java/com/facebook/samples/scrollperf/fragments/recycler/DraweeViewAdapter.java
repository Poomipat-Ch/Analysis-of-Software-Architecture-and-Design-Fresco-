...
public class DraweeViewAdapter extends RecyclerView.Adapter<DraweeViewHolder> {
  ...
  public DraweeViewAdapter(Context context, com.facebook.samples.scrollperf.data.SimpleAdapter<Uri> simpleAdapter, com.facebook.samples.scrollperf.conf.Config config, com.facebook.samples.scrollperf.instrumentation.PerfListener perfListener) {
