...
public class Config {
  ...
  public static class Builder {
    ...
    public Config.Builder setDataSourceType(String dataSourceType) {
      this.mDataSourceType = dataSourceType;
      return this;
    }

    public Config.Builder setInfiniteDataSource(boolean infiniteDataSource) {
      this.mInfiniteDataSource = infiniteDataSource;
      return this;
    }

    public Config.Builder setDistinctUriDataSource(boolean distinctUriDataSource) {
      this.mDistinctUriDataSource = distinctUriDataSource;
      return this;
    }

    public Config.Builder setRecyclerLayoutType(String recyclerLayoutType) {
      this.mRecyclerLayoutType = recyclerLayoutType;
      return this;
    }

    public Config.Builder setGridSpanCount(int gridSpanCount) {
      this.mGridSpanCount = gridSpanCount;
      return this;
    }

    public Config.Builder setReuseOldController(boolean reuseOldController) {
      this.mReuseOldController = reuseOldController;
      return this;
    }

    public Config.Builder setUseRoundedCorners(boolean useRoundedCorners) {
      this.mUseRoundedCorners = useRoundedCorners;
      return this;
    }

    public Config.Builder setUseRoundedAsCircle(boolean useRoundedAsCircle) {
      this.mUseRoundedAsCircle = useRoundedAsCircle;
      return this;
    }

    public Config.Builder setUsePostprocessor(boolean usePostprocessor) {
      this.mUsePostprocessor = usePostprocessor;
      return this;
    }

    public Config.Builder setPostprocessorType(String postprocessorType) {
      this.mPostprocessorType = postprocessorType;
      return this;
    }

    public Config.Builder setScaleType(String scaleType) {
      this.mScaleType = scaleType;
      return this;
    }

    public Config.Builder setRotateUsingMetaData(boolean rotateUsingMetaData) {
      this.mRotateUsingMetaData = rotateUsingMetaData;
      return this;
    }

    public Config.Builder setForcedRotationAngle(int forcedRotationAngle) {
      this.mForcedRotationAngle = forcedRotationAngle;
      return this;
    }

    public Config.Builder setDecodingThreadCount(int decodingThreadCount) {
      this.mDecodingThreadCount = decodingThreadCount;
      return this;
    }

    public Config.Builder setDownsampling(boolean downsampling) {
      this.mDownsampling = downsampling;
      return this;
    }

    public Config.Builder setOverrideSize(boolean overrideSize) {
      this.mOverrideSize = overrideSize;
      return this;
    }

    public Config.Builder setOverridenWidth(int overridenWidth) {
      this.mOverridenWidth = overridenWidth;
      return this;
    }

    public Config.Builder setOverridenHeight(int overridenHeight) {
      this.mOverridenHeight = overridenHeight;
      return this;
    }

    public Config.Builder setFadeDurationMs(int fadeDurationMs) {
      this.mFadeDurationMs = fadeDurationMs;
      return this;
    }

    public Config.Builder setDecodeCancellation(boolean decodeCancellation) {
      this.mDecodeCancellation = decodeCancellation;
      return this;
    }

    public Config.Builder setWebpSupportEnabled(boolean webpSupportEnabled) {
      this.mWebpSupportEnabled = webpSupportEnabled;
      return this;
    }

    public Config.Builder setDrawBorder(boolean drawBorder) {
      this.mDrawBorder = drawBorder;
      return this;
    }

    public Config.Builder setBgColor(int bgColor) {
      this.mBgColor = bgColor;
      return this;
    }

    public Config.Builder setDraweeOverlayEnabled(boolean draweeOverlayEnabled) {
      this.mDraweeOverlayEnabled = draweeOverlayEnabled;
      return this;
    }

    public Config.Builder setInstrumentationEnabled(boolean instrumentationEnabled) {
