...
public class DraweeViewListAdapter extends BaseAdapter {
  private final com.facebook.samples.scrollperf.data.SimpleAdapter<Uri> mSimpleAdapter;
  ...
  public DraweeViewListAdapter(Context context, com.facebook.samples.scrollperf.data.SimpleAdapter<Uri> simpleAdapter, com.facebook.samples.scrollperf.conf.Config config, com.facebook.samples.scrollperf.instrumentation.PerfListener perfListener) {
