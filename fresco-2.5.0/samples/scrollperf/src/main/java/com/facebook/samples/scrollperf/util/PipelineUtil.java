...
public final class PipelineUtil {
   ...
   */
  public static void addOptionalFeatures(com.facebook.imagepipeline.request.ImageRequestBuilder imageRequestBuilder, com.facebook.samples.scrollperf.conf.Config config)
  {
