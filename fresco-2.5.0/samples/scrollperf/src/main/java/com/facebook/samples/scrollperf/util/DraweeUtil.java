...
public final class DraweeUtil {
   ...
   */
  public static com.facebook.drawee.generic.GenericDraweeHierarchy createDraweeHierarchy(final Context context, final com.facebook.samples.scrollperf.conf.Config config)
  {
  ...
  public static void applyScaleType(com.facebook.drawee.generic.GenericDraweeHierarchyBuilder builder, final com.facebook.samples.scrollperf.conf.Config config)
  {
   ...
   * @param config The Config object
   */
  public static void setBgColor(View view, final com.facebook.samples.scrollperf.conf.Config config)
  {
