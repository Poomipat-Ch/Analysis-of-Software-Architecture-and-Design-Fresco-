...
public class MainFragment extends Fragment {
  ...
  private com.facebook.samples.scrollperf.fragments.recycler.DraweeViewAdapter mDraweeViewAdapter;

  private ListAdapter mListAdapter;

  private com.facebook.samples.scrollperf.data.SimpleAdapter<Uri> mSimpleAdapter;

  private com.facebook.samples.scrollperf.conf.Config mConfig;

  boolean mDistinctUriCompatible =  true;

  private com.facebook.samples.scrollperf.instrumentation.PerfListener mPerfListener;
  ...
  private com.facebook.samples.scrollperf.data.SimpleAdapter<Uri> initializeSimpleAdapter(final com.facebook.samples.scrollperf.conf.Config config) {
  ...
  private com.facebook.samples.scrollperf.data.SimpleAdapter<Uri> getExternalPhotoSimpleAdapter() {
