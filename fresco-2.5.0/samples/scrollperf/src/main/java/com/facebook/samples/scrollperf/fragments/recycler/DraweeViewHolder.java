...
public class DraweeViewHolder extends RecyclerView.ViewHolder {
  ...
  private final com.facebook.samples.scrollperf.instrumentation.InstrumentedDraweeView mDraweeView;

  private final com.facebook.samples.scrollperf.conf.Config mConfig;

  private final com.facebook.samples.scrollperf.instrumentation.PerfListener mPerfListener;

  public DraweeViewHolder(View parentView, com.facebook.samples.scrollperf.instrumentation.InstrumentedDraweeView simpleDraweeView, com.facebook.samples.scrollperf.conf.Config config, com.facebook.samples.scrollperf.instrumentation.PerfListener perfListener) {
