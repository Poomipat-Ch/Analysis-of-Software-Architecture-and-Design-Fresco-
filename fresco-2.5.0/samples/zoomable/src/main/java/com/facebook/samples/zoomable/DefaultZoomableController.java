 ...
 */
public class DefaultZoomableController implements ZoomableController, com.facebook.samples.gestures.TransformGestureDetector.Listener {
  ...
  private com.facebook.samples.gestures.TransformGestureDetector mGestureDetector;

  @Nullable
  private DefaultZoomableController.ImageBoundsListener mImageBoundsListener;
  ...
  public DefaultZoomableController(com.facebook.samples.gestures.TransformGestureDetector gestureDetector) {
   ...
   */
  public void setImageBoundsListener(@Nullable DefaultZoomableController.ImageBoundsListener imageBoundsListener) {
   ...
   */
  @Nullable
  public DefaultZoomableController.ImageBoundsListener getImageBoundsListener() {
   ...
   */
  protected com.facebook.samples.gestures.TransformGestureDetector getDetector() {
   ...
   */
  @Override
  public void onGestureBegin(com.facebook.samples.gestures.TransformGestureDetector detector) {
  ...
  @Override
  public void onGestureUpdate(com.facebook.samples.gestures.TransformGestureDetector detector) {
  ...
  @Override
  public void onGestureEnd(com.facebook.samples.gestures.TransformGestureDetector detector) {
   ...
   */
  private boolean limitScale(Matrix transform, float pivotX, float pivotY, @LimitFlag int limitTypes) {
