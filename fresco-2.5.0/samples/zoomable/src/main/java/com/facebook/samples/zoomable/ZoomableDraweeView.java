 ...
 */
public class ZoomableDraweeView extends com.facebook.drawee.view.DraweeView<> {
  ...
  @Nullable
  private com.facebook.drawee.interfaces.DraweeController mHugeImageController;
  ...
  private final com.facebook.drawee.controller.ControllerListener mControllerListener = 
  ...
  public ZoomableDraweeView(Context context, com.facebook.drawee.generic.GenericDraweeHierarchy hierarchy) {
    super(context);
   ...
   */
  @Override
  public void setController(@Nullable com.facebook.drawee.interfaces.DraweeController controller) {
   ...
   */
  public void setControllers(@Nullable com.facebook.drawee.interfaces.DraweeController controller, @Nullable com.facebook.drawee.interfaces.DraweeController hugeImageController) {
    setControllersInternal(null, null);
    mZoomableController.setEnabled(false);
    setControllersInternal(controller, hugeImageController);
  }

  private void setControllersInternal(@Nullable com.facebook.drawee.interfaces.DraweeController controller, @Nullable com.facebook.drawee.interfaces.DraweeController hugeImageController) {
  ...
  private void removeControllerListener(com.facebook.drawee.interfaces.DraweeController controller) {
    if (controller instanceof AbstractDraweeController) {
      ((AbstractDraweeController) controller).removeControllerListener(mControllerListener);
    }
  }

  private void addControllerListener(com.facebook.drawee.interfaces.DraweeController controller) {
    if (controller instanceof AbstractDraweeController) {
