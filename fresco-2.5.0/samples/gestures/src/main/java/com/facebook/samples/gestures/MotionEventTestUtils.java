...
public class MotionEventTestUtils {
  ...
  public static MotionEvent obtainMotionEvent(long downTime, long eventTime, int action, int id1, float x1, float y1)
  {
    int[] ids = new int[] {id1};
  ...
  public static MotionEvent obtainMotionEvent(long downTime, long eventTime, int action, int id1, float x1, float y1, int id2, float x2, float y2)
  {
