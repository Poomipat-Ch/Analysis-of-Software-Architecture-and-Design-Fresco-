 ...
 */
public class ExampleColorBackend implements com.facebook.fresco.animation.backend.AnimationBackend {
  /**
   * Creates a simple animation backend that cycles through a list of colors.
   * 
   * @return the backend to use
   */
  public static com.facebook.fresco.animation.backend.AnimationBackend createSampleColorAnimationBackend(Resources resources)
  {
