 ...
 */
public class LocalDrawableAnimationBackend implements com.facebook.fresco.animation.backend.AnimationBackend {
  ...
  private LocalDrawableAnimationBackend(LocalDrawableAnimationBackend.Builder builder) {
  ...
  public static class Builder {
    ...
    public LocalDrawableAnimationBackend.Builder addDrawableFrame(int drawableResId) {
      mResourceIds.add(drawableResId);
      return this;
    }

    public LocalDrawableAnimationBackend.Builder loopCount(int loopCount) {
      mLoopCount = loopCount;
      return this;
    }

    public LocalDrawableAnimationBackend.Builder frameDurationMs(int frameDurationMs) {
