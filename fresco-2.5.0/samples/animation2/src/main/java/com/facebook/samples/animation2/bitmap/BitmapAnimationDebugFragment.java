...
public class BitmapAnimationDebugFragment extends Fragment {
  ...
  private final SparseArray<BitmapAnimationDebugFragment.FrameInformationHolder> mFrameInfoMap =  new SparseArray<>();

  private int mActiveFrameNumber =  -1;

  private com.facebook.fresco.animation.bitmap.BitmapAnimationBackend mBitmapAnimationBackend;

  private com.facebook.fresco.animation.drawable.AnimatedDrawable2 mAnimatedDrawable;

  private com.facebook.samples.animation2.utils.AnimationControlsManager mAnimationControlsManager;

  private final com.facebook.fresco.animation.bitmap.BitmapAnimationBackend.FrameListener mFrameListener = 
  ...
  private void setupFrameInformationContainer(com.facebook.fresco.animation.bitmap.BitmapAnimationBackend bitmapAnimationBackend) {
  ...
  private BitmapAnimationDebugFragment.FrameInformationHolder createFrameInformation(LayoutInflater inflater, int frameNumber) {
