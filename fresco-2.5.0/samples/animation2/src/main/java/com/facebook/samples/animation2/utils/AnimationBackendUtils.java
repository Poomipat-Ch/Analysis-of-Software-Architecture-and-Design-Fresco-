...
public final class AnimationBackendUtils {
   ...
   */
  public static com.facebook.fresco.animation.backend.AnimationBackend wrapAnimationBackendWithInactivityCheck(final Context context, final com.facebook.fresco.animation.backend.AnimationBackend animationBackend)
  {
