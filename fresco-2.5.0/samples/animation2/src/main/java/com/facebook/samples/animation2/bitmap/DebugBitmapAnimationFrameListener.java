 ...
 */
public class DebugBitmapAnimationFrameListener implements com.facebook.fresco.animation.bitmap.BitmapAnimationBackend.FrameListener {
  ...
  @Override
  public void onDrawFrameStart(com.facebook.fresco.animation.bitmap.BitmapAnimationBackend backend, int frameNumber) {
    mLastFrameStart = System.currentTimeMillis();
    FLog.d(TAG, "Frame: event=start, number=%d", frameNumber);
  }

  @Override
  public void onFrameDrawn(com.facebook.fresco.animation.bitmap.BitmapAnimationBackend backend, int frameNumber, @BitmapAnimationBackend.FrameType int frameType) {
  ...
  @Override
  public void onFrameDropped(com.facebook.fresco.animation.bitmap.BitmapAnimationBackend backend, int frameNumber) {
    mDroppedFrameCount++;
    FLog.d(
        TAG,
