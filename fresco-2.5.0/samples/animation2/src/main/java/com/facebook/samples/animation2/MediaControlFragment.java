 ...
 */
public class MediaControlFragment extends Fragment implements com.facebook.samples.animation2.utils.SampleAnimationBackendConfigurator.BackendChangedListener {
  ...
  @Override
  public void onBackendChanged(final com.facebook.fresco.animation.backend.AnimationBackend backend) {
