...
public class AnimationControlsManager {
  private final com.facebook.fresco.animation.drawable.AnimatedDrawable2 mAnimatedDrawable;
  ...
  private com.facebook.fresco.animation.drawable.AnimationListener mAnimationListener = 
  ...
  public AnimationControlsManager(com.facebook.fresco.animation.drawable.AnimatedDrawable2 animatedDrawable, @Nullable SeekBar seekBar, @Nullable ToggleButton playPauseToggleButton, @Nullable View resetButton) {
  ...
  public void updateBackendData(@Nullable com.facebook.fresco.animation.backend.AnimationBackend newBackend) {
    if (mSeekBar == null) {
      return;
    }
    if (newBackend != null) {
