...
public class ExampleBitmapAnimationFactory {
  ...
  public static com.facebook.fresco.animation.bitmap.BitmapAnimationBackend createColorBitmapAnimationBackend(final int[] colors, final int animationDurationMs, final com.facebook.fresco.animation.bitmap.BitmapFrameCache bitmapFrameCache)
  {
  ...
  public static class ColorListAnimationInformation implements com.facebook.fresco.animation.backend.AnimationInformation {
  ...
  public static class ColorAndFrameNumberRenderer implements com.facebook.fresco.animation.bitmap.BitmapFrameRenderer {
