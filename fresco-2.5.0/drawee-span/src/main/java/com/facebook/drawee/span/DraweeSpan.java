 ...
 * <p>{@see DraweeHolder}
 */
public class DraweeSpan extends com.facebook.widget.text.span.BetterImageSpan {
  private final com.facebook.drawee.view.DraweeHolder mDraweeHolder;

  public DraweeSpan(com.facebook.drawee.view.DraweeHolder draweeHolder, @BetterImageSpan.BetterImageSpanAlignment int verticalAlignment) {
   ...
   */
  public com.facebook.drawee.view.DraweeHolder getDraweeHolder() {
