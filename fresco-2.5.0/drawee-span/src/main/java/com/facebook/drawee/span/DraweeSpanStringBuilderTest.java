...
public class DraweeSpanStringBuilderTest {
  ...
  @Mock
  public com.facebook.drawee.view.DraweeHolder mDraweeHolder;
  ...
  private static void addDraweeSpan(DraweeSpanStringBuilder draweeSpanStringBuilder, com.facebook.drawee.view.DraweeHolder draweeHolder, int index, int spanLength)
  {
