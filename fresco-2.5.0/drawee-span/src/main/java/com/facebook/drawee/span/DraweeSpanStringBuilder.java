 ...
 * <p>{@see DraweeHolder}
 */
public class DraweeSpanStringBuilder extends SpannableStringBuilder implements com.facebook.common.lifecycle.AttachDetachListener {
  ...
  private class DrawableCallback extends Drawable.Callback {
    @Override
  ...
  private final DraweeSpanStringBuilder.DrawableCallback mDrawableCallback =  new DrawableCallback();
  ...
  @Nullable
  private DraweeSpanStringBuilder.DraweeSpanChangedListener mDraweeSpanChangedListener;
  ...
  public void setImageSpan(com.facebook.drawee.view.DraweeHolder draweeHolder, int index, final int drawableWidthPx, final int drawableHeightPx, boolean enableResizing, @BetterImageSpan.BetterImageSpanAlignment int verticalAlignment) {
    setImageSpan(
        draweeHolder,
        index,
        index,
  ...
  public void setImageSpan(com.facebook.drawee.view.DraweeHolder draweeHolder, int startIndex, int endIndex, final int drawableWidthPx, final int drawableHeightPx, boolean enableResizing, @BetterImageSpan.BetterImageSpanAlignment int verticalAlignment) {
    if (endIndex >= length()) {
  ...
  public void setImageSpan(Context context, com.facebook.drawee.interfaces.DraweeHierarchy draweeHierarchy, com.facebook.drawee.interfaces.DraweeController draweeController, int index, final int drawableWidthPx, final int drawableHeightPx, boolean enableResizing, @BetterImageSpan.BetterImageSpanAlignment int verticalAlignment) {
    setImageSpan(
        context,
        draweeHierarchy,
        draweeController,
  ...
  public void setImageSpan(Context context, com.facebook.drawee.interfaces.DraweeHierarchy draweeHierarchy, com.facebook.drawee.interfaces.DraweeController draweeController, int startIndex, int endIndex, final int drawableWidthPx, final int drawableHeightPx, boolean enableResizing, @BetterImageSpan.BetterImageSpanAlignment int verticalAlignment) {
  ...
  private class DrawableChangedListener extends com.facebook.drawee.controller.BaseControllerListener<> {
