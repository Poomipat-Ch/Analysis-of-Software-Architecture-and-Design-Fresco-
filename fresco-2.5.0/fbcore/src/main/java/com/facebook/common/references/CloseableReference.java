...
public abstract class CloseableReference<T> extends Cloneable {
  ...
  @CloseableRefType
  private static int sBitmapCloseableRefType =  REF_TYPE_DEFAULT;
  ...
  private static final CloseableReference.LeakHandler DEFAULT_LEAK_HANDLER = 
      new LeakHandler() {
        @Override
  ...
  protected CloseableReference(SharedReference<T> sharedReference, CloseableReference.LeakHandler leakHandler, @Nullable Throwable stacktrace) {
  ...
  protected CloseableReference(T t, ResourceReleaser<T> resourceReleaser, CloseableReference.LeakHandler leakHandler, @Nullable Throwable stacktrace) {
   ...
   * <p>Returns null if the parameter is null.
   */
  public static <T extends Closeable> CloseableReference<T> of(@PropagatesNullable T t, CloseableReference.LeakHandler leakHandler)
  {
    if (t == null) {
      return null;
    } else {
  ...
  public static <T> CloseableReference<T> of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser, CloseableReference.LeakHandler leakHandler)
  {
    if (t == null) {
      return null;
    } else {
   ...
   */
  public static <T> CloseableReference<T> of(@PropagatesNullable T t, ResourceReleaser<T> resourceReleaser, CloseableReference.LeakHandler leakHandler, @Nullable Throwable stacktrace)
  {
    if (t == null) {
      return null;
    } else {
