...
public class PooledByteArrayBufferedInputStream extends InputStream {
  ...
  public PooledByteArrayBufferedInputStream(InputStream inputStream, byte[] byteArray, com.facebook.common.references.ResourceReleaser<byte[]> resourceReleaser) {
