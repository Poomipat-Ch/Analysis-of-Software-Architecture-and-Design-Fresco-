...
public class PooledByteArrayBufferedInputStreamTest {
   ...
   * @param endOffset
   */
  private static void assertFilledWithZeros(final byte[] byteArray, final int startOffset, final int endOffset)
  {
   ...
   * @param firstByte
   */
  private static void assertFilledWithConsecutiveBytes(final byte[] byteArray, final int startOffset, final int endOffset, int firstByte)
  {
    for (int i = startOffset; i < endOffset; ++i) {
