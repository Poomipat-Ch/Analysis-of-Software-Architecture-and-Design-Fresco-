...
public class FileUtils {
   ...
   */
  public static void mkdirs(File directory) throws FileUtils.CreateDirectoryException
  {
    if (directory.exists()) {
      ...
      if (!directory.delete()) {
        throw new CreateDirectoryException(
            directory.getAbsolutePath(), new FileDeleteException(directory.getAbsolutePath()));
      }
    }
   ...
   * @throws IOException
   */
  public static void rename(File source, File target) throws FileUtils.RenameException
  {
