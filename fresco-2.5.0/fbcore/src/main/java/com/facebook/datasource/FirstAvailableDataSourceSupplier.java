 ...
 */
@ThreadSafe
public class FirstAvailableDataSourceSupplier<T> implements com.facebook.common.internal.Supplier<> {
  private final List<com.facebook.common.internal.Supplier<DataSource<T>>> mDataSourceSuppliers;
  ...
  private class FirstAvailableDataSource extends AbstractDataSource<> {
    ...
    @Nullable
    private synchronized com.facebook.common.internal.Supplier<DataSource<T>> getNextSupplier() {
