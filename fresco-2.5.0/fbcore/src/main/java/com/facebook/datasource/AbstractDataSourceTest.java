...
public class AbstractDataSourceTest {
  ...
  private static class FakeAbstractDataSource extends AbstractDataSource<> {
    @Override
    public boolean setResult(@Nullable AbstractDataSourceTest.Value value, boolean isLast) {
