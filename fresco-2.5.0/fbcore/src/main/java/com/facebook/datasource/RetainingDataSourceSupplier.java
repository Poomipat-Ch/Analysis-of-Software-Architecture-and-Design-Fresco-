...
@NotThreadSafe
public class RetainingDataSourceSupplier<T> implements com.facebook.common.internal.Supplier<> {
  private static class RetainingDataSource<T> extends AbstractDataSource<> {
    @GuardedBy("RetainingDataSource.this")
    @Nullable
    private DataSource<T> mDataSource =  null;

    public void setSupplier(@Nullable com.facebook.common.internal.Supplier<DataSource<T>> supplier) {
  ...
  private final Set<RetainingDataSourceSupplier.RetainingDataSource> mDataSources = 
      Collections.newSetFromMap(new WeakHashMap<RetainingDataSource, Boolean>());

  @Nullable
  private com.facebook.common.internal.Supplier<DataSource<T>> mCurrentDataSourceSupplier =  null;
  ...
  public void replaceSupplier(com.facebook.common.internal.Supplier<DataSource<T>> supplier) {
