...
public class DataSourceTestUtils {
  ...
  public static void setState(DataSource<Object> dataSource, boolean isClosed, boolean isFinished, boolean hasResult, Object value, boolean hasFailed, Throwable failureCause)
  {
  ...
  public static <T> void verifyState(DataSource<T> dataSource, boolean isClosed, boolean isFinished, boolean hasResult, T result, boolean hasFailed, Throwable failureCause)
  {
  ...
  public static class AbstractDataSourceSupplier {
    ...
    protected com.facebook.common.internal.Supplier<DataSource<Object>> mDataSourceSupplier1;

    protected com.facebook.common.internal.Supplier<DataSource<Object>> mDataSourceSupplier2;

    protected com.facebook.common.internal.Supplier<DataSource<Object>> mDataSourceSupplier3;
    ...
    protected List<com.facebook.common.internal.Supplier<DataSource<Object>>> mSuppliers;

    protected com.facebook.common.internal.Supplier<DataSource<Object>> mDataSourceSupplier;
     ...
     */
    protected DataSubscriber<Object> verifyGetAndSubscribe(com.facebook.common.internal.Supplier<DataSource<Object>> dataSourceSupplier, DataSource<Object> underlyingDataSource, boolean expectMoreInteractions) {
    ...
    protected DataSubscriber<Object> verifyGetAndSubscribe(com.facebook.common.internal.Supplier<DataSource<Object>> dataSourceSupplier, DataSource<Object> underlyingDataSource) {
      return verifyGetAndSubscribe(dataSourceSupplier, underlyingDataSource, false);
    }

    protected DataSubscriber<Object> verifyGetAndSubscribeM(com.facebook.common.internal.Supplier<DataSource<Object>> dataSourceSupplier, DataSource<Object> underlyingDataSource) {
