...
;
  ...
  @Nullable
  private static volatile AbstractDataSource.DataSourceInstrumenter sDataSourceInstrumenter;

  public static void provideInstrumenter(@Nullable AbstractDataSource.DataSourceInstrumenter dataSourceInstrumenter)
  {
