...
public class DropFramesFrameSchedulerTest {
  private static class DummyAnimationBackend implements com.facebook.fresco.animation.backend.AnimationBackend {
  ...
  private DropFramesFrameSchedulerTest.DummyAnimationBackend mDummyAnimationBackend;
