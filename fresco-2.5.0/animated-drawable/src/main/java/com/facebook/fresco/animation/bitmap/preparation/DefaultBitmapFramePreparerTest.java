...
public class DefaultBitmapFramePreparerTest {
  ...
  @Mock
  public com.facebook.fresco.animation.backend.AnimationBackend mAnimationBackend;

  @Mock
  public com.facebook.fresco.animation.bitmap.BitmapFrameCache mBitmapFrameCache;

  @Mock
  public com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory mPlatformBitmapFactory;

  @Mock
  public com.facebook.fresco.animation.bitmap.BitmapFrameRenderer mBitmapFrameRenderer;

  @Mock
  public com.facebook.common.references.CloseableReference<Bitmap> mBitmapReference;

  @Mock
  public Bitmap mBitmap;

  private com.facebook.imagepipeline.testing.FakeClock mFakeClock;

  private com.facebook.imagepipeline.testing.TestExecutorService mExecutorService;
