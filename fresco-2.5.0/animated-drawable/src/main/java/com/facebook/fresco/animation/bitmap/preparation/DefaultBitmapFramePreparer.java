...
public class DefaultBitmapFramePreparer implements BitmapFramePreparer {
  ...
  private final com.facebook.fresco.animation.bitmap.BitmapFrameRenderer mBitmapFrameRenderer;
  ...
  public DefaultBitmapFramePreparer(com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory platformBitmapFactory, com.facebook.fresco.animation.bitmap.BitmapFrameRenderer bitmapFrameRenderer, Bitmap.Config bitmapConfig, ExecutorService executorService) {
  ...
  @Override
  public boolean prepareFrame(com.facebook.fresco.animation.bitmap.BitmapFrameCache bitmapFrameCache, com.facebook.fresco.animation.backend.AnimationBackend animationBackend, int frameNumber) {
  ...
  private static int getUniqueId(com.facebook.fresco.animation.backend.AnimationBackend backend, int frameNumber)
  {
  ...
  private class FrameDecodeRunnable extends Runnable {
    private final com.facebook.fresco.animation.bitmap.BitmapFrameCache mBitmapFrameCache;

    private final com.facebook.fresco.animation.backend.AnimationBackend mAnimationBackend;

    private final int mFrameNumber;

    private final int mHashCode;

    public FrameDecodeRunnable(com.facebook.fresco.animation.backend.AnimationBackend animationBackend, com.facebook.fresco.animation.bitmap.BitmapFrameCache bitmapFrameCache, int frameNumber, int hashCode) {
    ...
    private boolean prepareFrameAndCache(int frameNumber, @BitmapAnimationBackend.FrameType int frameType) {
    ...
    private boolean renderFrameAndCache(int frameNumber, @Nullable com.facebook.common.references.CloseableReference<Bitmap> bitmapReference, @BitmapAnimationBackend.FrameType int frameType) {
