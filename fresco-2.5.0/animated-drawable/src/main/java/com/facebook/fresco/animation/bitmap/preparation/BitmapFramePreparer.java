...
public interface BitmapFramePreparer {
   ...
   * the frame is ready by calling {@link BitmapFrameCache#onFramePrepared(int, CloseableReference,
   * int)}
   * 
   ...
   * @return
   */
  boolean prepareFrame(com.facebook.fresco.animation.bitmap.BitmapFrameCache bitmapFrameCache, com.facebook.fresco.animation.backend.AnimationBackend animationBackend, int frameNumber) ;
