...
public interface BitmapFramePreparationStrategy {
   ...
   */
  void prepareFrames(BitmapFramePreparer bitmapFramePreparer, com.facebook.fresco.animation.bitmap.BitmapFrameCache bitmapFrameCache, com.facebook.fresco.animation.backend.AnimationBackend animationBackend, int lastDrawnFrameNumber) ;
