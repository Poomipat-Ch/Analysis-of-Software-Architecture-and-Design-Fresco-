...
public class AnimationBackendDelegateWithInactivityCheck<T extends AnimationBackend> extends AnimationBackendDelegate<> {
  ...
  public static <
            T extends
                AnimationBackend & AnimationBackendDelegateWithInactivityCheck.InactivityListener> AnimationBackendDelegate<T> createForBackend(T backend, com.facebook.common.time.MonotonicClock monotonicClock, ScheduledExecutorService scheduledExecutorServiceForUiThread)
  {
    return createForBackend(backend, backend, monotonicClock, scheduledExecutorServiceForUiThread);
  }

  public static <T extends AnimationBackend> AnimationBackendDelegate<T> createForBackend(T backend, AnimationBackendDelegateWithInactivityCheck.InactivityListener inactivityListener, com.facebook.common.time.MonotonicClock monotonicClock, ScheduledExecutorService scheduledExecutorServiceForUiThread)
  {
  ...
  private AnimationBackendDelegateWithInactivityCheck(@Nullable T animationBackend, @Nullable AnimationBackendDelegateWithInactivityCheck.InactivityListener inactivityListener, com.facebook.common.time.MonotonicClock monotonicClock, ScheduledExecutorService scheduledExecutorServiceForUiThread) {
  ...
  public void setInactivityListener(@Nullable AnimationBackendDelegateWithInactivityCheck.InactivityListener inactivityListener) {
    mInactivityListener = inactivityListener;
  }
