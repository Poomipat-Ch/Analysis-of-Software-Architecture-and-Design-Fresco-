...
@ThreadSafe
@DoNotStrip
public class WebPImage implements com.facebook.imagepipeline.animated.base.AnimatedImage, com.facebook.imagepipeline.animated.factory.AnimatedImageDecoder {
  /**
   ...
   */
  public static WebPImage createFromByteArray(byte[] source, @Nullable com.facebook.imagepipeline.common.ImageDecodeOptions options)
  {
    ensure();
   ...
   */
  public static WebPImage createFromByteBuffer(ByteBuffer byteBuffer, @Nullable com.facebook.imagepipeline.common.ImageDecodeOptions options)
  {
    ensure();
    byteBuffer.rewind();
  ...
  public static WebPImage createFromNativeMemory(long nativePtr, int sizeInBytes, @Nullable com.facebook.imagepipeline.common.ImageDecodeOptions options)
  {
    ensure();
