...
public class GifAnimationBackend implements com.facebook.fresco.animation.backend.AnimationBackend {
  private final com.facebook.animated.giflite.decoder.GifMetadataDecoder mGifDecoder;
  ...
  private GifAnimationBackend(com.facebook.animated.giflite.decoder.GifMetadataDecoder decoder, Movie movie) {
    mGifDecoder = decoder;
    mMovie = movie;
