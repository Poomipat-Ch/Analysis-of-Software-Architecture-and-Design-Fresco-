...
public class MovieAnimatedImage implements com.facebook.imagepipeline.animated.base.AnimatedImage {
  ...
  @Override
  public com.facebook.imagepipeline.animated.base.AnimatedImageFrame getFrame(int frameNumber) {
