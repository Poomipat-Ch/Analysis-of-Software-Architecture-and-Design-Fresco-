 ...
 */
public class GifDecoder implements com.facebook.imagepipeline.decoder.ImageDecoder {
  @Override
  public com.facebook.imagepipeline.image.CloseableImage decode(final com.facebook.imagepipeline.image.EncodedImage encodedImage, int length, com.facebook.imagepipeline.image.QualityInfo qualityInfo, com.facebook.imagepipeline.common.ImageDecodeOptions options) {
  ...
  private static com.facebook.imagepipeline.animated.base.AnimatedDrawableFrameInfo.DisposalMethod translateFrameDisposal(int raw)
  {
    switch (raw) {
