...
public class TestScheduledFuture<V> extends ScheduledFuture<V> {
  ...
  TestScheduledFuture(FakeClock fakeClock, ScheduledQueue scheduledQueue, long delay, final Runnable runnable) {
