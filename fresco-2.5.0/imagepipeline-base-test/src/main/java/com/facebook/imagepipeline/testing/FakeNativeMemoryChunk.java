 ...
 */
public class FakeNativeMemoryChunk extends com.facebook.imagepipeline.memory.NativeMemoryChunk {
  private byte[] mBuf;
  ...
  @Override
  public void copy(int offset, com.facebook.imagepipeline.memory.MemoryChunk other, int otherOffset, int count) {
