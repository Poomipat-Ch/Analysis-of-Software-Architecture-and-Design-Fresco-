 ...
 */
public class FakeBufferMemoryChunkPool extends com.facebook.imagepipeline.memory.BufferMemoryChunkPool {
  public FakeBufferMemoryChunkPool() {
    this(new PoolParams(128, getBucketSizes()));
  }

  public FakeBufferMemoryChunkPool(com.facebook.imagepipeline.memory.PoolParams poolParams) {
    super(
  ...
  @Override
  protected com.facebook.imagepipeline.memory.BufferMemoryChunk alloc(int bucketedSize) {
