...
public class FakeClock implements com.facebook.common.time.MonotonicClock {
  public interface OnTickListener {
    void onTick() ;

  }

  private final Map<FakeClock.OnTickListener, OnTickListener> otherClocks = 
      new ConcurrentHashMap<OnTickListener, OnTickListener>();

  private final Map<FakeClock.OnTickListener, OnTickListener> listeners = 
      new ConcurrentHashMap<OnTickListener, OnTickListener>();
   ...
   */
  public void addOtherClock(FakeClock.OnTickListener otherClock) {
    otherClocks.put(otherClock, otherClock);
  }

  public void addListener(FakeClock.OnTickListener listener) {
    listeners.put(listener, listener);
  }

  public void removeListener(FakeClock.OnTickListener listener) {
