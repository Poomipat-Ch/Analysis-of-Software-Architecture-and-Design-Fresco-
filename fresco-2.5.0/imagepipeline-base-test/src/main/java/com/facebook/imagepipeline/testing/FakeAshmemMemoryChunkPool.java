 ...
 */
public class FakeAshmemMemoryChunkPool extends com.facebook.imagepipeline.memory.AshmemMemoryChunkPool {
  public FakeAshmemMemoryChunkPool() {
    this(new PoolParams(128, getBucketSizes()));
  }

  public FakeAshmemMemoryChunkPool(com.facebook.imagepipeline.memory.PoolParams poolParams) {
    super(
  ...
  @Override
  public com.facebook.imagepipeline.memory.AshmemMemoryChunk alloc(int bucketedSize) {
