...
public class BitmapAnimationBackendTest {
  ...
  @Mock
  public com.facebook.fresco.animation.backend.AnimationInformation mAnimationInformation;
  ...
  @Mock
  public BitmapAnimationBackend.FrameListener mFrameListener;

  @Mock
  public com.facebook.fresco.animation.bitmap.preparation.BitmapFramePreparationStrategy mBitmapFramePreparationStrategy;

  @Mock
  public com.facebook.fresco.animation.bitmap.preparation.BitmapFramePreparer mBitmapFramePreparer;

  @Captor
  public ArgumentCaptor<com.facebook.common.references.CloseableReference<Bitmap>> mCapturedBitmapReference;

  private com.facebook.common.references.CloseableReference<Bitmap> mBitmapRefererence;
  ...
  private void verifyListenersAndCacheNotified(int frameNumber, @BitmapAnimationBackend.FrameType int frameType) {
  ...
  private void verifyListenersNotifiedWithoutCache(int frameNumber, @BitmapAnimationBackend.FrameType int frameType) {
    // Verify cache callback
  ...
  private void setupBoundsAndRendererDimensions(int boundsWidth, int boundsHeight, int backendIntrinsicWidth, int backendIntrinsicHeight) {
