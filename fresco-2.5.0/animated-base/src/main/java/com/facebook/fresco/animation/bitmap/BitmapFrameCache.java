...
public interface BitmapFrameCache {
   ...
   */
  @Nullable
  com.facebook.common.references.CloseableReference<Bitmap> getCachedFrame(int frameNumber) ;
   ...
   */
  @Nullable
  com.facebook.common.references.CloseableReference<Bitmap> getFallbackFrame(int frameNumber) ;
   ...
   */
  @Nullable
  com.facebook.common.references.CloseableReference<Bitmap> getBitmapToReuseForFrame(int frameNumber, int width, int height) ;
   ...
   */
  void onFrameRendered(int frameNumber, com.facebook.common.references.CloseableReference<Bitmap> bitmapReference, @BitmapAnimationBackend.FrameType int frameType) ;
   ...
   */
  void onFramePrepared(int frameNumber, com.facebook.common.references.CloseableReference<Bitmap> bitmapReference, @BitmapAnimationBackend.FrameType int frameType) ;
