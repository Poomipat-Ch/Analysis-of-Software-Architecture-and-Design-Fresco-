...
public class FrescoFrameCache implements com.facebook.fresco.animation.bitmap.BitmapFrameCache {
  private static final Class<?> TAG =  FrescoFrameCache.class;

  private final com.facebook.imagepipeline.animated.impl.AnimatedFrameCache mAnimatedFrameCache;

  private final boolean mEnableBitmapReusing;

  @GuardedBy("this")
  private final SparseArray<com.facebook.common.references.CloseableReference<CloseableImage>> mPreparedPendingFrames;

  @GuardedBy("this")
  @Nullable
  private com.facebook.common.references.CloseableReference<CloseableImage> mLastRenderedItem;

  public FrescoFrameCache(com.facebook.imagepipeline.animated.impl.AnimatedFrameCache animatedFrameCache, boolean enableBitmapReusing) {
  ...
  @Override
  public synchronized void onFramePrepared(int frameNumber, com.facebook.common.references.CloseableReference<Bitmap> bitmapReference, @BitmapAnimationBackend.FrameType int frameType) {
    Preconditions.checkNotNull(bitmapReference);
    CloseableReference<CloseableImage> closableReference = null;
    try {
      closableReference = createImageReference(bitmapReference);
  ...
  @VisibleForTesting
  @Nullable
  static com.facebook.common.references.CloseableReference<Bitmap> convertToBitmapReferenceAndClose(@Nullable final com.facebook.common.references.CloseableReference<CloseableImage> closeableImage)
  {
    try {
  ...
  private static int getBitmapSizeBytes(@Nullable com.facebook.common.references.CloseableReference<CloseableImage> imageReference)
  {
  ...
  private static int getBitmapSizeBytes(@Nullable com.facebook.imagepipeline.image.CloseableImage image)
  {
  ...
  @Nullable
  private static com.facebook.common.references.CloseableReference<CloseableImage> createImageReference(com.facebook.common.references.CloseableReference<Bitmap> bitmapReference)
  {
