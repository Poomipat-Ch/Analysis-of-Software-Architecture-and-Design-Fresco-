...
public class NoOpCache implements com.facebook.fresco.animation.bitmap.BitmapFrameCache {
  @Nullable
  @Override
  public com.facebook.common.references.CloseableReference<Bitmap> getCachedFrame(int frameNumber) {
    return null;
  }
  ...
  @Override
  public void onFrameRendered(int frameNumber, com.facebook.common.references.CloseableReference<Bitmap> bitmapReference, @BitmapAnimationBackend.FrameType int frameType) {
    // no-op
  }
