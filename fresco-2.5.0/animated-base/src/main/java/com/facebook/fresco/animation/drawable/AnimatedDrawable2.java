...
public class AnimatedDrawable2 extends Drawable implements com.facebook.drawable.base.DrawableWithCaches {
  public interface DrawListener {
    void onDraw(AnimatedDrawable2 animatedDrawable, com.facebook.fresco.animation.frame.FrameScheduler frameScheduler, int frameNumberToDraw, boolean frameDrawn, boolean isAnimationRunning, long animationStartTimeMs, long animationTimeMs, long lastFrameAnimationTimeMs, long actualRenderTimeStartMs, long actualRenderTimeEndMs, long startRenderTimeForNextFrameMs, long scheduledRenderTimeForNextFrameMs) ;
  ...
  @Nullable
  private com.facebook.fresco.animation.backend.AnimationBackend mAnimationBackend;

  @Nullable
  private com.facebook.fresco.animation.frame.FrameScheduler mFrameScheduler;
  ...
  @Nullable
  private volatile AnimatedDrawable2.DrawListener mDrawListener =  null;
   ...
   */
  @Nullable
  private com.facebook.drawee.drawable.DrawableProperties mDrawableProperties;
  ...
  public AnimatedDrawable2(@Nullable com.facebook.fresco.animation.backend.AnimationBackend animationBackend) {
   ...
   */
  public void setAnimationBackend(@Nullable com.facebook.fresco.animation.backend.AnimationBackend animationBackend) {
    mAnimationBackend = animationBackend;
    if (mAnimationBackend != null) {
   ...
   */
  public void setDrawListener(@Nullable AnimatedDrawable2.DrawListener drawListener) {
  ...
  @Nullable
  private static com.facebook.fresco.animation.frame.FrameScheduler createSchedulerForBackendAndDelayMethod(@Nullable com.facebook.fresco.animation.backend.AnimationBackend animationBackend)
  {
