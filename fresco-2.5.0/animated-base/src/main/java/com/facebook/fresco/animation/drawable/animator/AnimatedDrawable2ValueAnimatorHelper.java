...
public class AnimatedDrawable2ValueAnimatorHelper {
  @Nullable
  public static ValueAnimator createValueAnimator(com.facebook.fresco.animation.drawable.AnimatedDrawable2 animatedDrawable, int maxDurationMs)
  {
  ...
  public static ValueAnimator createValueAnimator(com.facebook.fresco.animation.drawable.AnimatedDrawable2 animatedDrawable)
  {
  ...
  public static ValueAnimator.AnimatorUpdateListener createAnimatorUpdateListener(final com.facebook.fresco.animation.drawable.AnimatedDrawable2 drawable)
  {
