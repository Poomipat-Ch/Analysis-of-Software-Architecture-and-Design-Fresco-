...
public class BitmapAnimationBackend implements com.facebook.fresco.animation.backend.AnimationBackend, com.facebook.fresco.animation.backend.AnimationBackendDelegateWithInactivityCheck.InactivityListener {
  ...
  private final com.facebook.fresco.animation.backend.AnimationInformation mAnimationInformation;

  private final BitmapFrameRenderer mBitmapFrameRenderer;

  @Nullable
  private final com.facebook.fresco.animation.bitmap.preparation.BitmapFramePreparationStrategy mBitmapFramePreparationStrategy;

  @Nullable
  private final com.facebook.fresco.animation.bitmap.preparation.BitmapFramePreparer mBitmapFramePreparer;
  ...
  @Nullable
  private BitmapAnimationBackend.FrameListener mFrameListener;

  public BitmapAnimationBackend(com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory platformBitmapFactory, BitmapFrameCache bitmapFrameCache, com.facebook.fresco.animation.backend.AnimationInformation animationInformation, BitmapFrameRenderer bitmapFrameRenderer, @Nullable com.facebook.fresco.animation.bitmap.preparation.BitmapFramePreparationStrategy bitmapFramePreparationStrategy, @Nullable com.facebook.fresco.animation.bitmap.preparation.BitmapFramePreparer bitmapFramePreparer) {
  ...
  public void setFrameListener(@Nullable BitmapAnimationBackend.FrameListener frameListener) {
   ...
   */
  private boolean renderFrameInBitmap(int frameNumber, @Nullable com.facebook.common.references.CloseableReference<Bitmap> targetBitmap) {
   ...
   */
  private boolean drawBitmapAndCache(int frameNumber, @Nullable com.facebook.common.references.CloseableReference<Bitmap> bitmapReference, Canvas canvas, @FrameType int frameType) {
