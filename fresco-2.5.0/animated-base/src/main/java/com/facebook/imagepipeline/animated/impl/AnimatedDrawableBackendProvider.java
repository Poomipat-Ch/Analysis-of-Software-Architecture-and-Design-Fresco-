...
public interface AnimatedDrawableBackendProvider {
   ...
   */
  com.facebook.imagepipeline.animated.base.AnimatedDrawableBackend get(com.facebook.imagepipeline.animated.base.AnimatedImageResult animatedImageResult, @Nullable Rect bounds) ;
