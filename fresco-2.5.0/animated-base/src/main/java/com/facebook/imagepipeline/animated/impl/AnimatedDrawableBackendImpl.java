...
public class AnimatedDrawableBackendImpl implements com.facebook.imagepipeline.animated.base.AnimatedDrawableBackend {
  private final com.facebook.imagepipeline.animated.util.AnimatedDrawableUtil mAnimatedDrawableUtil;

  private final com.facebook.imagepipeline.animated.base.AnimatedImageResult mAnimatedImageResult;

  private final com.facebook.imagepipeline.animated.base.AnimatedImage mAnimatedImage;
  ...
  private final com.facebook.imagepipeline.animated.base.AnimatedDrawableFrameInfo[] mFrameInfos;
  ...
  public AnimatedDrawableBackendImpl(com.facebook.imagepipeline.animated.util.AnimatedDrawableUtil animatedDrawableUtil, com.facebook.imagepipeline.animated.base.AnimatedImageResult animatedImageResult, @Nullable Rect bounds, boolean downscaleFrameToDrawableDimensions) {
  ...
  private static Rect getBoundsToUse(com.facebook.imagepipeline.animated.base.AnimatedImage image, @Nullable Rect targetBounds)
  {
  ...
  @Override
  public com.facebook.imagepipeline.animated.base.AnimatedDrawableBackend forNewBounds(@Nullable Rect bounds) {
  ...
  @Override
  @Nullable
  public com.facebook.common.references.CloseableReference<Bitmap> getPreDecodedFrame(int frameNumber) {
  ...
  private void renderImageSupportsScaling(Canvas canvas, com.facebook.imagepipeline.animated.base.AnimatedImageFrame frame) {
  ...
  private void renderImageDoesNotSupportScaling(Canvas canvas, com.facebook.imagepipeline.animated.base.AnimatedImageFrame frame) {
