...
public class AnimatedImageResult {
   ...
   */
  @Nullable
  public synchronized com.facebook.common.references.CloseableReference<Bitmap> getDecodedFrame(int index) {
   ...
   */
  @Nullable
  public synchronized com.facebook.common.references.CloseableReference<Bitmap> getPreviewBitmap() {
