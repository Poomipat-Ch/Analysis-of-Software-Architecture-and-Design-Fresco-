...
public class AnimatedFrameCache {
  @VisibleForTesting
  static class FrameKey implements com.facebook.cache.common.CacheKey {
    private final com.facebook.cache.common.CacheKey mImageCacheKey;

    private final int mFrameIndex;

    public FrameKey(com.facebook.cache.common.CacheKey imageCacheKey, int frameIndex) {
  ...
  private final com.facebook.imagepipeline.cache.CountingMemoryCache.EntryStateObserver<CacheKey> mEntryStateObserver;

  @GuardedBy("this")
  private final LinkedHashSet<com.facebook.cache.common.CacheKey> mFreeItemsPool;

  public AnimatedFrameCache(com.facebook.cache.common.CacheKey imageCacheKey, final com.facebook.imagepipeline.cache.CountingMemoryCache<CacheKey, CloseableImage> backingCache) {
    mImageCacheKey = imageCacheKey;
  ...
  public synchronized void onReusabilityChange(com.facebook.cache.common.CacheKey key, boolean isReusable) {
    if (isReusable) {
   ...
   */
  @Nullable
  public com.facebook.common.references.CloseableReference<CloseableImage> cache(int frameIndex, com.facebook.common.references.CloseableReference<CloseableImage> imageRef) {
   ...
   */
  @Nullable
  public com.facebook.common.references.CloseableReference<CloseableImage> get(int frameIndex) {
   ...
   */
  @Nullable
  public com.facebook.common.references.CloseableReference<CloseableImage> getForReuse() {
    while (true) {
