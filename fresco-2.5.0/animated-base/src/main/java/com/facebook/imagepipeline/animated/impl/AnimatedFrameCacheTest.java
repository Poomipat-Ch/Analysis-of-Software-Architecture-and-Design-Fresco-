...
public class AnimatedFrameCacheTest {
  ...
  @Mock
  public com.facebook.common.internal.Supplier<MemoryCacheParams> mMemoryCacheParamsSupplier;
  ...
  private com.facebook.common.references.CloseableReference<CloseableImage> mFrame1;

  private com.facebook.common.references.CloseableReference<CloseableImage> mFrame2;
