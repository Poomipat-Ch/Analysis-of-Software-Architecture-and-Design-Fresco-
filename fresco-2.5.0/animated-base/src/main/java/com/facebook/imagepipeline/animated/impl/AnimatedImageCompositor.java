...
public class AnimatedImageCompositor {
  public interface Callback {
     ...
     */
    @Nullable
    com.facebook.common.references.CloseableReference<Bitmap> getCachedBitmap(int frameNumber) ;
  ...
  public AnimatedImageCompositor(com.facebook.imagepipeline.animated.base.AnimatedDrawableBackend animatedDrawableBackend, AnimatedImageCompositor.Callback callback) {
...
;
  ...
  private void disposeToBackground(Canvas canvas, com.facebook.imagepipeline.animated.base.AnimatedDrawableFrameInfo frameInfo) {
    canvas.drawRect(
        frameInfo.xOffset,
        frameInfo.yOffset,
   ...
   */
  private AnimatedImageCompositor.FrameNeededResult isFrameNeededForRendering(int index) {
    AnimatedDrawableFrameInfo frameInfo = mAnimatedDrawableBackend.getFrameInfo(index);
    DisposalMethod disposalMethod = frameInfo.disposalMethod;
  ...
  private boolean isFullFrame(com.facebook.imagepipeline.animated.base.AnimatedDrawableFrameInfo frameInfo) {
