...
public class AnimatedImageResultBuilder {
  ...
  @Nullable
  private com.facebook.common.references.CloseableReference<Bitmap> mPreviewBitmap;

  @Nullable
  private List<com.facebook.common.references.CloseableReference<Bitmap>> mDecodedFrames;

  private int mFrameForPreview;

  @Nullable
  private com.facebook.imagepipeline.transformation.BitmapTransformation mBitmapTransformation;
   ...
   */
  @Nullable
  public com.facebook.common.references.CloseableReference<Bitmap> getPreviewBitmap() {
   ...
   * @return this builder
   */
  public AnimatedImageResultBuilder setPreviewBitmap(@Nullable com.facebook.common.references.CloseableReference<Bitmap> previewBitmap) {
   ...
   */
  @Nullable
  public List<com.facebook.common.references.CloseableReference<Bitmap>> getDecodedFrames() {
   ...
   */
  public AnimatedImageResultBuilder setBitmapTransformation(@Nullable com.facebook.imagepipeline.transformation.BitmapTransformation bitmapTransformation) {
