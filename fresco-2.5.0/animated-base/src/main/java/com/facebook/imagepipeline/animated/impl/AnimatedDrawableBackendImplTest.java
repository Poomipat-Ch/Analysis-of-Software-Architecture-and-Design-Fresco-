...
public class AnimatedDrawableBackendImplTest {
  ...
  @Mock
  public com.facebook.imagepipeline.animated.util.AnimatedDrawableUtil mAnimatedDrawableUtil;

  @Mock
  public com.facebook.imagepipeline.animated.base.AnimatedImageResult mAnimatedImageResult;

  @Mock
  public Canvas mCanvas;

  @Mock
  public com.facebook.imagepipeline.animated.base.AnimatedImage mImage;

  @Mock
  public com.facebook.imagepipeline.animated.base.AnimatedImageFrame mFrame;
  ...
  private void testBasic(int canvasWidth, int canvasHeight, int frameOriginalWidth, int frameOriginalHeight, int frameExpectedRenderedWidth, int frameExpectedRenderedHeight) {
