...
public class EncodedProbeProducer implements Producer<> {
  ...
  public EncodedProbeProducer(com.facebook.imagepipeline.cache.BufferedDiskCache defaultBufferedDiskCache, com.facebook.imagepipeline.cache.BufferedDiskCache smallImageBufferedDiskCache, com.facebook.imagepipeline.cache.CacheKeyFactory cacheKeyFactory, com.facebook.imagepipeline.cache.BoundedLinkedHashSet encodedMemoryCacheHistory, com.facebook.imagepipeline.cache.BoundedLinkedHashSet diskCacheHistory, Producer<EncodedImage> inputProducer) {
  ...
  private static class ProbeConsumer extends DelegatingConsumer<, > {
    ...
    public ProbeConsumer(Consumer<EncodedImage> consumer, ProducerContext producerContext, com.facebook.imagepipeline.cache.BufferedDiskCache defaultBufferedDiskCache, com.facebook.imagepipeline.cache.BufferedDiskCache smallImageBufferedDiskCache, com.facebook.imagepipeline.cache.CacheKeyFactory cacheKeyFactory, com.facebook.imagepipeline.cache.BoundedLinkedHashSet<CacheKey> encodedMemoryCacheHistory, com.facebook.imagepipeline.cache.BoundedLinkedHashSet<CacheKey> diskCacheHistory) {
      super(consumer);
