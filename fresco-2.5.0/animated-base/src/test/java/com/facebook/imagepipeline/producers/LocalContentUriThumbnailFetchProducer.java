...
public class LocalContentUriThumbnailFetchProducer extends LocalFetchProducer implements ThumbnailProducer<> {
  ...
  public LocalContentUriThumbnailFetchProducer(Executor executor, com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory, ContentResolver contentResolver) {
    super(executor, pooledByteBufferFactory);
    mContentResolver = contentResolver;
  }

  @Override
  public boolean canProvideImageForSize(@Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions) {
  ...
  @Override
  @Nullable
  protected com.facebook.imagepipeline.image.EncodedImage getEncodedImage(com.facebook.imagepipeline.request.ImageRequest imageRequest) throws IOException {
  ...
  @Nullable
  private com.facebook.imagepipeline.image.EncodedImage getCameraImage(Uri uri, @Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions) throws IOException {
   ...
   */
  @Nullable
  private com.facebook.imagepipeline.image.EncodedImage getThumbnail(com.facebook.imagepipeline.common.ResizeOptions resizeOptions, long imageId) throws IOException {
   ...
   */
  private static int getThumbnailKind(com.facebook.imagepipeline.common.ResizeOptions resizeOptions)
  {
