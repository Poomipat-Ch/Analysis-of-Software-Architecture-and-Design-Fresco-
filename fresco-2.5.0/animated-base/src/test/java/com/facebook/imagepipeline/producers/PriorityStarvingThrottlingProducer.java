...
public class PriorityStarvingThrottlingProducer<T> implements Producer<> {
  ...
  @GuardedBy("this")
  private final Queue<PriorityStarvingThrottlingProducer.Item<T>> mPendingRequests;
  ...
  private void produceResultsInternal(PriorityStarvingThrottlingProducer.Item<T> item) {
  ...
  static class PriorityComparator<T> extends Comparator<Item<T>> {
    @Override
    public int compare(PriorityStarvingThrottlingProducer.Item<T> o1, PriorityStarvingThrottlingProducer.Item<T> o2) {
