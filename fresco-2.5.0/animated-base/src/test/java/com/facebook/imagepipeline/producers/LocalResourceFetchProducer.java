...
public class LocalResourceFetchProducer extends LocalFetchProducer {
  ...
  public LocalResourceFetchProducer(Executor executor, com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory, Resources resources) {
  ...
  private static int getResourceId(com.facebook.imagepipeline.request.ImageRequest imageRequest)
  {
