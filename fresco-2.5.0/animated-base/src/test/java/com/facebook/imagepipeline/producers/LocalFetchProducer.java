...
public abstract class LocalFetchProducer implements Producer<> {
  ...
  protected LocalFetchProducer(Executor executor, com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory) {
    mExecutor = executor;
   ...
   */
  protected com.facebook.imagepipeline.image.EncodedImage getByteBufferBackedEncodedImage(InputStream inputStream, int length) throws IOException {
  ...
  @Nullable
  protected com.facebook.imagepipeline.image.EncodedImage getEncodedImage(InputStream inputStream, int length) throws IOException {
   ...
   */
  @Nullable
  protected abstract com.facebook.imagepipeline.image.EncodedImage getEncodedImage(com.facebook.imagepipeline.request.ImageRequest imageRequest) throws IOException ;
