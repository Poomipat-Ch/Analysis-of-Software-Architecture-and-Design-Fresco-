...
public class LocalVideoThumbnailProducer implements Producer<> {
  ...
  private static int calculateKind(com.facebook.imagepipeline.request.ImageRequest imageRequest)
  {
  ...
  @Nullable
  private String getLocalFilePath(com.facebook.imagepipeline.request.ImageRequest imageRequest) {
