...
public class NetworkFetchProducerTest {
  ...
  @Mock
  public com.facebook.common.memory.PooledByteBuffer mPooledByteBuffer;
  ...
  private static class TestNetworkFetchProducer extends NetworkFetchProducer {
    ...
    public TestNetworkFetchProducer(com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory, com.facebook.common.memory.ByteArrayPool byteArrayPool, NetworkFetcher networkFetcher) {
  ...
  private NetworkFetchProducerTest.TestNetworkFetchProducer mNetworkFetchProducer;
  ...
  private Future performResponse(final InputStream inputStream, final int length, final NetworkFetcher.Callback callback) {
