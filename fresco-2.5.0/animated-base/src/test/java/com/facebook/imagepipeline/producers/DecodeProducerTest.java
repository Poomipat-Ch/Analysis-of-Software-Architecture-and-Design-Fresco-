...
public class DecodeProducerTest {
  private static final com.facebook.imagepipeline.common.ImageDecodeOptions IMAGE_DECODE_OPTIONS = 
  ...
  @Mock
  public com.facebook.common.memory.ByteArrayPool mByteArrayPool;
  ...
  private com.facebook.common.references.CloseableReference<PooledByteBuffer> mByteBufferRef;
  ...
  @Mock
  public com.facebook.imagepipeline.decoder.ProgressiveJpegParser mProgressiveJpegParser;
  ...
  @Mock
  public com.facebook.imagepipeline.core.ImagePipelineExperiments mPipelineExperiments;
  ...
  private static com.facebook.imagepipeline.image.EncodedImage mockEncodedJpeg(com.facebook.common.references.CloseableReference<PooledByteBuffer> ref)
  {
  ...
  private void setupImageRequest(String requestId, com.facebook.imagepipeline.request.ImageRequest imageRequest) {
  ...
  private void setupNetworkUri(@Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions) {
    setupImageRequest(
        "networkRequest1",
  ...
  private void setupLocalUri(@Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions) {
    setupImageRequest(
        "localRequest1",
  ...
  private static com.facebook.common.memory.PooledByteBuffer mockPooledByteBuffer(int size)
  {
