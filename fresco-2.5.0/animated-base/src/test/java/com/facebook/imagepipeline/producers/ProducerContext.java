...
public interface ProducerContext {
   ...
   */
  com.facebook.imagepipeline.request.ImageRequest getImageRequest() ;
   ...
   */
  com.facebook.imagepipeline.request.ImageRequest.RequestLevel getLowestPermittedRequestLevel() ;
   ...
   */
  com.facebook.imagepipeline.common.Priority getPriority() ;
  ...
  com.facebook.imagepipeline.core.ImagePipelineConfigInterface getImagePipelineConfig() ;

  com.facebook.imagepipeline.image.EncodedImageOrigin getEncodedImageOrigin() ;

  void setEncodedImageOrigin(com.facebook.imagepipeline.image.EncodedImageOrigin encodedImageOrigin) ;
