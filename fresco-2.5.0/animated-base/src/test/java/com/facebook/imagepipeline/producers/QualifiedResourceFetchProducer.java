...
public class QualifiedResourceFetchProducer extends LocalFetchProducer {
  ...
  public QualifiedResourceFetchProducer(Executor executor, com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory, ContentResolver contentResolver) {
  ...
  @Override
  @Nullable
  protected com.facebook.imagepipeline.image.EncodedImage getEncodedImage(final com.facebook.imagepipeline.request.ImageRequest imageRequest) throws IOException {
