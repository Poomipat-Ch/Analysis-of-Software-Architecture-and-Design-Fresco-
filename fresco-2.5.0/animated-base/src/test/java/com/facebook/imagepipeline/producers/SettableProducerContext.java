...
public class SettableProducerContext extends BaseProducerContext {
  ...
  public SettableProducerContext(com.facebook.imagepipeline.request.ImageRequest overrideRequest, ProducerContext context) {
    this(
        overrideRequest,
        context.getId(),
        context.getUiComponentId(),
  ...
  public SettableProducerContext(com.facebook.imagepipeline.request.ImageRequest imageRequest, String id, ProducerListener2 producerListener, Object callerContext, com.facebook.imagepipeline.request.ImageRequest.RequestLevel lowestPermittedRequestLevel, boolean isPrefetch, boolean isIntermediateResultExpected, com.facebook.imagepipeline.common.Priority priority, com.facebook.imagepipeline.core.ImagePipelineConfigInterface imagePipelineConfig) {
    super(
        imageRequest,
        id,
        producerListener,
  ...
  public SettableProducerContext(com.facebook.imagepipeline.request.ImageRequest imageRequest, String id, @Nullable String uiComponentId, ProducerListener2 producerListener, Object callerContext, com.facebook.imagepipeline.request.ImageRequest.RequestLevel lowestPermittedRequestLevel, boolean isPrefetch, boolean isIntermediateResultExpected, com.facebook.imagepipeline.common.Priority priority, com.facebook.imagepipeline.core.ImagePipelineConfigInterface imagePipelineConfig) {
    super(
        imageRequest,
        id,
        uiComponentId,
   ...
   * @param priority
   */
  public void setPriority(com.facebook.imagepipeline.common.Priority priority) {
