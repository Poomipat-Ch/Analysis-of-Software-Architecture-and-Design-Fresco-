...
public class BitmapMemoryCacheProducerTest {
  ...
  @Mock
  public com.facebook.imagepipeline.cache.MemoryCache<CacheKey, CloseableImage> mMemoryCache;
  ...
  private com.facebook.imagepipeline.cache.BitmapMemoryCacheKey mBitmapMemoryCacheKey;

  private com.facebook.imagepipeline.image.CloseableImage mCloseableImage1;

  private com.facebook.imagepipeline.image.CloseableImage mCloseableImage2;

  private com.facebook.common.references.CloseableReference<CloseableImage> mFinalImageReference;

  private com.facebook.common.references.CloseableReference<CloseableImage> mIntermediateImageReference;

  private com.facebook.common.references.CloseableReference<CloseableImage> mFinalImageReferenceClone;

  private com.facebook.common.references.CloseableReference<CloseableImage> mIntermediateImageReferenceClone;
  ...
  private void setupBitmapMemoryCacheGetSuccessOnSecondRead(com.facebook.common.references.CloseableReference<CloseableImage> closeableImageRef) {
  ...
  private void setupInputProducerStreamingSuccessWithStatusFlags(@Consumer.Status final int statusFlags) {
    doAnswer(
  ...
  private static class ProduceResultsNewResultAnswer extends Answer<Void> {
    ...
    private final List<com.facebook.common.references.CloseableReference<CloseableImage>> mResults;

    private ProduceResultsNewResultAnswer(@Consumer.Status final int statusFlags, List<CloseableReference<CloseableImage>> results) {
