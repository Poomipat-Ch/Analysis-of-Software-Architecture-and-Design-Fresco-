...
public class BitmapMemoryCacheGetProducerTest {
  ...
  @Mock
  public com.facebook.imagepipeline.cache.BitmapMemoryCacheKey mCacheKey;
  ...
  private static class ProduceResultsNewResultAnswer extends Answer<Void> {
    private final com.facebook.common.references.CloseableReference<CloseableImage> mResult;

    private ProduceResultsNewResultAnswer(com.facebook.common.references.CloseableReference<CloseableImage> result) {
      mResult = result;
    }
