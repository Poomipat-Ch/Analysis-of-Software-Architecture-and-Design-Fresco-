...
public class LocalExifThumbnailProducer implements ThumbnailProducer<> {
  ...
  public LocalExifThumbnailProducer(Executor executor, com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory, ContentResolver contentResolver) {
    mExecutor = executor;
  ...
  private com.facebook.imagepipeline.image.EncodedImage buildEncodedImage(com.facebook.common.memory.PooledByteBuffer imageBytes, ExifInterface exifInterface) {
