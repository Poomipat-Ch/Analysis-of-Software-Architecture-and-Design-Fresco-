...
public final class ThumbnailSizeChecker {
   ...
   */
  public static boolean isImageBigEnough(int width, int height, @Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions)
  {
  ...
  public static boolean isImageBigEnough(@Nullable com.facebook.imagepipeline.image.EncodedImage encodedImage, @Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions)
  {
