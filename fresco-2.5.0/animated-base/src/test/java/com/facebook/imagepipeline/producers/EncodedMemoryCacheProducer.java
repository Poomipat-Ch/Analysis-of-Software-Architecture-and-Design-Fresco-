...
public class EncodedMemoryCacheProducer implements Producer<> {
  ...
  private final com.facebook.imagepipeline.cache.MemoryCache<CacheKey, PooledByteBuffer> mMemoryCache;

  private final com.facebook.imagepipeline.cache.CacheKeyFactory mCacheKeyFactory;

  private final Producer<EncodedImage> mInputProducer;

  public EncodedMemoryCacheProducer(com.facebook.imagepipeline.cache.MemoryCache<CacheKey, PooledByteBuffer> memoryCache, com.facebook.imagepipeline.cache.CacheKeyFactory cacheKeyFactory, Producer<EncodedImage> inputProducer) {
  ...
  private static class EncodedMemoryCacheConsumer extends DelegatingConsumer<, > {
    ...
    private final com.facebook.cache.common.CacheKey mRequestedCacheKey;

    private final boolean mIsMemoryCacheEnabled;

    private final boolean mEncodedCacheEnabled;

    public EncodedMemoryCacheConsumer(Consumer<EncodedImage> consumer, com.facebook.imagepipeline.cache.MemoryCache<CacheKey, PooledByteBuffer> memoryCache, com.facebook.cache.common.CacheKey requestedCacheKey, boolean isMemoryCacheEnabled, boolean encodedCacheEnabled) {
      super(consumer);
      mMemoryCache = memoryCache;
