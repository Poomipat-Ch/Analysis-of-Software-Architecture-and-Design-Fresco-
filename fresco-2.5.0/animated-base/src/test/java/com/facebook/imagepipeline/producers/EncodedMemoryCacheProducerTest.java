...
public class EncodedMemoryCacheProducerTest {
  ...
  @Mock
  public com.facebook.imagepipeline.cache.MemoryCache<CacheKey, PooledByteBuffer> mMemoryCache;
  ...
  private com.facebook.cache.common.MultiCacheKey mCacheKey;

  private com.facebook.common.memory.PooledByteBuffer mPooledByteBuffer1;

  private com.facebook.common.memory.PooledByteBuffer mPooledByteBuffer2;

  private com.facebook.common.references.CloseableReference<PooledByteBuffer> mFinalImageReference;

  private com.facebook.common.references.CloseableReference<PooledByteBuffer> mIntermediateImageReference;

  private com.facebook.common.references.CloseableReference<PooledByteBuffer> mFinalImageReferenceClone;

  private com.facebook.imagepipeline.image.EncodedImage mFinalEncodedImage;

  private com.facebook.imagepipeline.image.EncodedImage mFinalEncodedImageFormatUnknown;

  private com.facebook.imagepipeline.image.EncodedImage mIntermediateEncodedImage;

  private com.facebook.imagepipeline.image.EncodedImage mFinalEncodedImageClone;

  private EncodedMemoryCacheProducer mEncodedMemoryCacheProducer;

  private com.facebook.imagepipeline.core.ImagePipelineConfig mImagePipelineConfig;

  private com.facebook.imagepipeline.core.ImagePipelineExperiments mImagePipelineExperiments;
  ...
  private void testInputProducerSuccessButResultNotCacheableDueToStatusFlags(@Consumer.Status final int statusFlags) {
  ...
  private void setupInputProducerStreamingSuccessWithStatusFlags(@Consumer.Status int statusFlags, com.facebook.imagepipeline.image.EncodedImage finalEncodedImage) {
    doAnswer(
  ...
  private static class ProduceResultsNewResultAnswer extends Answer<Void> {
    private final List<com.facebook.imagepipeline.image.EncodedImage> mResults;
  ...
  private class ProduceResultsFailureAnswer extends Answer<Void> {
    @Override
    public Void answer(InvocationOnMock invocation) throws Throwable {
      Consumer consumer = (Consumer) invocation.getArguments()[0];
