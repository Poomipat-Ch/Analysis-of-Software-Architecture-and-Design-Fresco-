...
public class NetworkFetchProducer implements Producer<> {
  ...
  public NetworkFetchProducer(com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory, com.facebook.common.memory.ByteArrayPool byteArrayPool, NetworkFetcher networkFetcher) {
  ...
  protected void maybeHandleIntermediateResult(com.facebook.common.memory.PooledByteBufferOutputStream pooledOutputStream, FetchState fetchState) {
  ...
  protected void handleFinalResult(com.facebook.common.memory.PooledByteBufferOutputStream pooledOutputStream, FetchState fetchState) {
  ...
  protected static void notifyConsumer(com.facebook.common.memory.PooledByteBufferOutputStream pooledOutputStream, @Consumer.Status int status, @Nullable com.facebook.imagepipeline.common.BytesRange responseBytesRange, Consumer<EncodedImage> consumer, ProducerContext context)
  {
