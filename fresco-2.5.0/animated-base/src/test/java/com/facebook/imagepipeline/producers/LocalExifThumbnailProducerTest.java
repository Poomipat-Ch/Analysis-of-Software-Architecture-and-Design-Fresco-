...
public class LocalExifThumbnailProducerTest {
  ...
  @Mock
  public com.facebook.common.memory.PooledByteBuffer mThumbnailByteBuffer;
  ...
  private class TestLocalExifThumbnailProducer extends LocalExifThumbnailProducer {
    private TestLocalExifThumbnailProducer(Executor executor, com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory, ContentResolver contentResolver) {
  ...
  private com.facebook.imagepipeline.image.EncodedImage mCapturedEncodedImage;
