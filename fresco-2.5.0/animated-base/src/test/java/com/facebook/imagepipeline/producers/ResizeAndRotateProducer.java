...
public class ResizeAndRotateProducer implements Producer<> {
  ...
  public ResizeAndRotateProducer(final Executor executor, final com.facebook.common.memory.PooledByteBufferFactory pooledByteBufferFactory, final Producer<EncodedImage> inputProducer, final boolean isResizingEnabled, final com.facebook.imagepipeline.transcoder.ImageTranscoderFactory imageTranscoderFactory) {
  ...
  private class TransformingConsumer extends DelegatingConsumer<, > {
    ...
    TransformingConsumer(final Consumer<EncodedImage> consumer, final ProducerContext producerContext, final boolean isResizingEnabled, final com.facebook.imagepipeline.transcoder.ImageTranscoderFactory imageTranscoderFactory) {
      super(consumer);
      mIsCancelled = false;
    ...
    private void forwardNewResult(com.facebook.imagepipeline.image.EncodedImage newResult, @Status int status, com.facebook.imageformat.ImageFormat imageFormat) {
    ...
    @Nullable
    private com.facebook.imagepipeline.image.EncodedImage getNewResultForImagesWithoutExifData(com.facebook.imagepipeline.image.EncodedImage encodedImage) {
    ...
    @Nullable
    private com.facebook.imagepipeline.image.EncodedImage getNewResultsForJpegOrHeif(com.facebook.imagepipeline.image.EncodedImage encodedImage) {
    ...
    @Nullable
    private com.facebook.imagepipeline.image.EncodedImage getCloneWithRotationApplied(com.facebook.imagepipeline.image.EncodedImage encodedImage, int angle) {
    ...
    private void doTransform(com.facebook.imagepipeline.image.EncodedImage encodedImage, @Status int status, com.facebook.imagepipeline.transcoder.ImageTranscoder imageTranscoder) {
    ...
    @Nullable
    private Map<String, String> getExtraMap(com.facebook.imagepipeline.image.EncodedImage encodedImage, @Nullable com.facebook.imagepipeline.common.ResizeOptions resizeOptions, @Nullable com.facebook.imagepipeline.transcoder.ImageTranscodeResult transcodeResult, @Nullable String transcoderId) {
      if (!mProducerContext
          .getProducerListener()
  ...
  private static com.facebook.common.util.TriState shouldTransform(com.facebook.imagepipeline.request.ImageRequest request, com.facebook.imagepipeline.image.EncodedImage encodedImage, com.facebook.imagepipeline.transcoder.ImageTranscoder imageTranscoder)
  {
  ...
  private static boolean shouldRotate(com.facebook.imagepipeline.common.RotationOptions rotationOptions, com.facebook.imagepipeline.image.EncodedImage encodedImage)
  {
  ...
  private static boolean shouldRotateUsingExifOrientation(com.facebook.imagepipeline.common.RotationOptions rotationOptions, com.facebook.imagepipeline.image.EncodedImage encodedImage)
  {
