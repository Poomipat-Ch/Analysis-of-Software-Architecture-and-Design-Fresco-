...
public class HttpUrlConnectionNetworkFetcher extends BaseNetworkFetcher<> {
  ...
  @VisibleForTesting
  HttpUrlConnectionNetworkFetcher(@Nullable String userAgent, @Nullable Map<String, String> requestHeaders, com.facebook.common.time.MonotonicClock monotonicClock) {
  ...
  @Override
  public void fetch(final HttpUrlConnectionNetworkFetcher.HttpUrlConnectionNetworkFetchState fetchState, final NetworkFetcher.Callback callback) {
  ...
  @VisibleForTesting
  void fetchSync(HttpUrlConnectionNetworkFetcher.HttpUrlConnectionNetworkFetchState fetchState, NetworkFetcher.Callback callback) {
