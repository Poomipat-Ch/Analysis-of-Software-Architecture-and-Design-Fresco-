...
public class BitmapProbeProducer implements Producer<> {
  ...
  private final com.facebook.imagepipeline.cache.BoundedLinkedHashSet<CacheKey> mEncodedMemoryCacheHistory;

  private final com.facebook.imagepipeline.cache.BoundedLinkedHashSet<CacheKey> mDiskCacheHistory;

  public BitmapProbeProducer(com.facebook.imagepipeline.cache.MemoryCache<CacheKey, PooledByteBuffer> encodedMemoryCache, com.facebook.imagepipeline.cache.BufferedDiskCache defaultBufferedDiskCache, com.facebook.imagepipeline.cache.BufferedDiskCache smallImageBufferedDiskCache, com.facebook.imagepipeline.cache.CacheKeyFactory cacheKeyFactory, com.facebook.imagepipeline.cache.BoundedLinkedHashSet<CacheKey> encodedMemoryCacheHistory, com.facebook.imagepipeline.cache.BoundedLinkedHashSet<CacheKey> diskCacheHistory, Producer<CloseableReference<CloseableImage>> inputProducer) {
  ...
  private static class ProbeConsumer extends DelegatingConsumer<, > {
    ...
    public ProbeConsumer(Consumer<CloseableReference<CloseableImage>> consumer, ProducerContext producerContext, com.facebook.imagepipeline.cache.MemoryCache<CacheKey, PooledByteBuffer> encodedMemoryCache, com.facebook.imagepipeline.cache.BufferedDiskCache defaultBufferedDiskCache, com.facebook.imagepipeline.cache.BufferedDiskCache smallImageBufferedDiskCache, com.facebook.imagepipeline.cache.CacheKeyFactory cacheKeyFactory, com.facebook.imagepipeline.cache.BoundedLinkedHashSet<CacheKey> encodedMemoryCacheHistory, com.facebook.imagepipeline.cache.BoundedLinkedHashSet<CacheKey> diskCacheHistory) {
      super(consumer);
    ...
    @Override
    public void onNewResultImpl(@Nullable com.facebook.common.references.CloseableReference<CloseableImage> newResult, @Status int status) {
      try {
        if (FrescoSystrace.isTracing()) {
