...
public class BaseProducerContext implements ProducerContext {
  ...
  @GuardedBy("this")
  private com.facebook.imagepipeline.common.Priority mPriority;
  ...
  private final com.facebook.imagepipeline.core.ImagePipelineConfigInterface mImagePipelineConfig;

  private com.facebook.imagepipeline.image.EncodedImageOrigin mEncodedImageOrigin =  EncodedImageOrigin.NOT_SET;

  public BaseProducerContext(com.facebook.imagepipeline.request.ImageRequest imageRequest, String id, ProducerListener2 producerListener, Object callerContext, com.facebook.imagepipeline.request.ImageRequest.RequestLevel lowestPermittedRequestLevel, boolean isPrefetch, boolean isIntermediateResultExpected, com.facebook.imagepipeline.common.Priority priority, com.facebook.imagepipeline.core.ImagePipelineConfigInterface imagePipelineConfig) {
    this(
        imageRequest,
        id,
        null,
  ...
  public BaseProducerContext(com.facebook.imagepipeline.request.ImageRequest imageRequest, String id, @Nullable String uiComponentId, ProducerListener2 producerListener, Object callerContext, com.facebook.imagepipeline.request.ImageRequest.RequestLevel lowestPermittedRequestLevel, boolean isPrefetch, boolean isIntermediateResultExpected, com.facebook.imagepipeline.common.Priority priority, com.facebook.imagepipeline.core.ImagePipelineConfigInterface imagePipelineConfig) {
  ...
  @Override
  public synchronized com.facebook.imagepipeline.common.Priority getPriority() {
    return mPriority;
  }
  ...
  @Override
  public com.facebook.imagepipeline.core.ImagePipelineConfigInterface getImagePipelineConfig() {
  ...
  public void setEncodedImageOrigin(com.facebook.imagepipeline.image.EncodedImageOrigin encodedImageOrigin) {
   ...
   */
  @Nullable
  public synchronized List<ProducerContextCallbacks> setPriorityNoCallbacks(com.facebook.imagepipeline.common.Priority priority) {
