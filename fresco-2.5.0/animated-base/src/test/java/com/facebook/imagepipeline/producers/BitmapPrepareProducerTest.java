...
public class BitmapPrepareProducerTest {
  ...
  private com.facebook.common.references.CloseableReference<CloseableImage> mImageReference;

  @Mock
  private com.facebook.imagepipeline.image.CloseableStaticBitmap mCloseableStaticBitmap;
