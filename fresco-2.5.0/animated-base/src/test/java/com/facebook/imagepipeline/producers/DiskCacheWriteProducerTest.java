...
public class DiskCacheWriteProducerTest {
  ...
  private void setupInputProducerSuccessWithStatusFlags(@Consumer.Status final int statusFlags, final com.facebook.imagepipeline.image.EncodedImage finalEncodedImage) {
    doAnswer(
            new Answer<Object>() {
              @Override
