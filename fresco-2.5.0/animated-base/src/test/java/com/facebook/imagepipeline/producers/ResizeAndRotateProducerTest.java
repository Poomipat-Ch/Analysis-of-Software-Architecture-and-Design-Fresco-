...
public class ResizeAndRotateProducerTest {
  ...
  @Mock
  public com.facebook.imagepipeline.request.ImageRequest mImageRequest;

  @Mock
  public ProducerListener2 mProducerListener;
  ...
  @Mock
  public com.facebook.common.memory.PooledByteBufferFactory mPooledByteBufferFactory;

  @Mock
  public com.facebook.common.memory.PooledByteBufferOutputStream mPooledByteBufferOutputStream;
  ...
  private com.facebook.imagepipeline.testing.TestExecutorService mTestExecutorService;

  private ResizeAndRotateProducer mResizeAndRotateProducer;

  private Consumer<EncodedImage> mResizeAndRotateProducerConsumer;

  private com.facebook.common.references.CloseableReference<PooledByteBuffer> mIntermediateResult;

  private com.facebook.common.references.CloseableReference<PooledByteBuffer> mFinalResult;

  private com.facebook.common.memory.PooledByteBuffer mPooledByteBuffer;

  private com.facebook.imagepipeline.testing.FakeClock mFakeClockForWorker;

  private com.facebook.imagepipeline.testing.FakeClock mFakeClockForScheduled;

  private com.facebook.imagepipeline.testing.TestScheduledExecutorService mTestScheduledExecutorService;

  private com.facebook.common.executors.UiThreadImmediateExecutorService mUiThreadImmediateExecutorService;

  private com.facebook.imagepipeline.image.EncodedImage mIntermediateEncodedImage;

  private com.facebook.imagepipeline.image.EncodedImage mFinalEncodedImage;
  ...
  private void testNewResultContainsRotationAngleForImageFormat(com.facebook.imageformat.ImageFormat imageFormat) {
    int rotationAngle = 90;
    whenRequestSpecificRotation(rotationAngle);
  ...
  private void testDoesComputeRightNumerator(int rotationAngle, int exifOrientation, int numerator) {
    whenResizingEnabled();
  ...
  private void testDoesComputeRightNumeratorInvertedOrientation(int exifOrientation, int numerator) {
    whenResizingEnabled();
    whenRequestWidthAndHeight(50, 100);
    whenRequestsRotationFromMetadataWithoutDeferring();
  ...
  private static void verifyJpegTranscoderExifOrientationInteractions(int numerator, int exifOrientation)
  {
    PowerMockito.verifyStatic(NativeJpegTranscoder.class);
    try {
  ...
  private void provideIntermediateResult(com.facebook.imageformat.ImageFormat imageFormat) {
    provideIntermediateResult(imageFormat, 800, 800, 0, ExifInterface.ORIENTATION_UNDEFINED);
  }

  private void provideIntermediateResult(com.facebook.imageformat.ImageFormat imageFormat, int width, int height, int rotationAngle, int exifOrientation) {
  ...
  private void provideFinalResult(com.facebook.imageformat.ImageFormat imageFormat) {
    provideFinalResult(imageFormat, 800, 800, 0, ExifInterface.ORIENTATION_UNDEFINED);
  }

  private void provideFinalResult(com.facebook.imageformat.ImageFormat imageFormat, int width, int height, int rotationAngle, int exifOrientation) {
    mFinalEncodedImage =
  ...
  private static com.facebook.imagepipeline.image.EncodedImage buildEncodedImage(com.facebook.common.references.CloseableReference<PooledByteBuffer> pooledByteBufferRef, com.facebook.imageformat.ImageFormat imageFormat, int width, int height, int rotationAngle, int exifOrientation)
  {
