...
public class DiskCacheReadProducer implements Producer<> {
  ...
  public DiskCacheReadProducer(com.facebook.imagepipeline.cache.BufferedDiskCache defaultBufferedDiskCache, com.facebook.imagepipeline.cache.BufferedDiskCache smallImageBufferedDiskCache, com.facebook.imagepipeline.cache.CacheKeyFactory cacheKeyFactory, Producer<EncodedImage> inputProducer) {
  ...
  private Continuation<com.facebook.imagepipeline.image.EncodedImage, Void> onFinishDiskReads(final Consumer<EncodedImage> consumer, final ProducerContext producerContext) {
