...
public class RepeatedPostprocessorProducerTest {
  ...
  @Mock
  public com.facebook.imagepipeline.request.RepeatedPostprocessor mPostprocessor;

  @Mock
  public com.facebook.common.references.ResourceReleaser<Bitmap> mBitmapResourceReleaser;

  @Mock
  public com.facebook.imagepipeline.request.ImageRequest mImageRequest;

  @Mock
  public com.facebook.imagepipeline.core.ImagePipelineConfig mConfig;
  ...
  private com.facebook.imagepipeline.image.CloseableStaticBitmap mSourceCloseableStaticBitmap;

  private com.facebook.common.references.CloseableReference<CloseableImage> mSourceCloseableImageRef;

  private Bitmap mDestinationBitmap;

  private com.facebook.common.references.CloseableReference<Bitmap> mDestinationCloseableBitmapRef;
  ...
  private List<com.facebook.common.references.CloseableReference<CloseableImage>> mResults;
  ...
  private PostprocessorProducer.RepeatedPostprocessorConsumer produceResults() {
  ...
  private com.facebook.imagepipeline.request.RepeatedPostprocessorRunner getRunner() {
  ...
  private void performNewResult(PostprocessorProducer.RepeatedPostprocessorConsumer postprocessorConsumer, boolean run) {
    setupNewSourceImage();
  ...
  private void performUpdate(com.facebook.imagepipeline.request.RepeatedPostprocessorRunner repeatedPostprocessorRunner, boolean run) {
    setupNewDestinationImage();
  ...
  private void performUpdateDuringTheNextPostprocessing(final com.facebook.imagepipeline.request.RepeatedPostprocessorRunner repeatedPostprocessorRunner) {
    doAnswer(
  ...
  private void performFailure(com.facebook.imagepipeline.request.RepeatedPostprocessorRunner repeatedPostprocessorRunner) {
    setupNewDestinationImage();
