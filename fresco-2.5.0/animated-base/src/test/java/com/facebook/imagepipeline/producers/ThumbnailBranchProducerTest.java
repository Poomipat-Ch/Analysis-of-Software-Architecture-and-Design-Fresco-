...
public class ThumbnailBranchProducerTest {
  ...
  private static final com.facebook.imagepipeline.image.EncodedImage THROW_FAILURE =  mock(EncodedImage.class);
  ...
  private static com.facebook.imagepipeline.image.EncodedImage mockEncodedImage(int width, int height, int rotationAngle)
  {
  ...
  private static void mockProducerToSupportSize(ThumbnailProducer<EncodedImage> mockProducer, final int width, final int height)
  {
  ...
  private static void whenProduceResultsCalledTrigger(ThumbnailProducer<EncodedImage> mockProducer, final ThumbnailBranchProducerTest.ConsumerCallback callback)
  {
    doAnswer(
            new Answer<Void>() {
              @Override
