...
public class DiskCacheWriteProducer implements Producer<> {
  ...
  public DiskCacheWriteProducer(com.facebook.imagepipeline.cache.BufferedDiskCache defaultBufferedDiskCache, com.facebook.imagepipeline.cache.BufferedDiskCache smallImageBufferedDiskCache, com.facebook.imagepipeline.cache.CacheKeyFactory cacheKeyFactory, Producer<EncodedImage> inputProducer) {
  ...
  private static class DiskCacheWriteConsumer extends DelegatingConsumer<, > {
    ...
    private DiskCacheWriteConsumer(final Consumer<EncodedImage> consumer, final ProducerContext producerContext, final com.facebook.imagepipeline.cache.BufferedDiskCache defaultBufferedDiskCache, final com.facebook.imagepipeline.cache.BufferedDiskCache smallImageBufferedDiskCache, final com.facebook.imagepipeline.cache.CacheKeyFactory cacheKeyFactory) {
      super(consumer);
