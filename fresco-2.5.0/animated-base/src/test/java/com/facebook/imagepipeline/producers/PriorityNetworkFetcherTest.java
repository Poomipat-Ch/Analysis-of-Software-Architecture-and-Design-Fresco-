...
public class PriorityNetworkFetcherTest {
  ...
  private PriorityNetworkFetcher.PriorityFetchState<FetchState> fetch(PriorityNetworkFetcher<FetchState> fetcher, String uri, NetworkFetcher.Callback callback, boolean isHiPri) {
  ...
  private static class TestFetchState {
    private final PriorityNetworkFetcher.PriorityFetchState<FetchState> fetchState;

    public TestFetchState(PriorityNetworkFetcher.PriorityFetchState<FetchState> fetchState) {
  ...
  @SafeVarargs
  private static List<PriorityNetworkFetcherTest.TestFetchState> toTestEntry(PriorityFetchState<FetchState>... fetchStates)
  {
    return toTestEntry(Arrays.asList(fetchStates));
  }

  private static List<PriorityNetworkFetcherTest.TestFetchState> toTestEntry(List<PriorityFetchState<FetchState>> fetchStates)
  {
  ...
  private void cancel(PriorityNetworkFetcher.PriorityFetchState<FetchState> fetchState) {
    ((SettableProducerContext) fetchState.getContext()).cancel();
  }

  private static class RecordingNetworkFetcher implements NetworkFetcher<> {
