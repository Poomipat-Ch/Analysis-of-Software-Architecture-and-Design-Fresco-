...
public class BitmapMemoryCacheProducer implements Producer<> {
  ...
  public BitmapMemoryCacheProducer(com.facebook.imagepipeline.cache.MemoryCache<CacheKey, CloseableImage> memoryCache, com.facebook.imagepipeline.cache.CacheKeyFactory cacheKeyFactory, Producer<CloseableReference<CloseableImage>> inputProducer) {
  ...
  protected Consumer<CloseableReference<CloseableImage>> wrapConsumer(final Consumer<CloseableReference<CloseableImage>> consumer, final com.facebook.cache.common.CacheKey cacheKey, final boolean isMemoryCacheEnabled) {
  ...
  private static void maybeSetExtrasFromCloseableImage(com.facebook.imagepipeline.image.HasImageMetadata imageWithMeta, ProducerContext producerContext)
  {
