...
public class DecodeProducer implements Producer<> {
  ...
  private final com.facebook.common.internal.Supplier<Boolean> mRecoverFromDecoderOOM;

  public DecodeProducer(final com.facebook.common.memory.ByteArrayPool byteArrayPool, final Executor executor, final com.facebook.imagepipeline.decoder.ImageDecoder imageDecoder, final com.facebook.imagepipeline.decoder.ProgressiveJpegConfig progressiveJpegConfig, final boolean downsampleEnabled, final boolean downsampleEnabledForNetwork, final boolean decodeCancellationEnabled, final Producer<EncodedImage> inputProducer, final int maxBitmapSize, final com.facebook.imagepipeline.core.CloseableReferenceFactory closeableReferenceFactory, @Nullable final Runnable reclaimMemoryRunnable, com.facebook.common.internal.Supplier<Boolean> recoverFromDecoderOOM) {
  ...
  private abstract class ProgressiveDecoder extends DelegatingConsumer<, > {
    ...
    private void maybeIncreaseSampleSize(final com.facebook.imagepipeline.image.EncodedImage encodedImage) {
     ...
     */
    protected boolean updateDecodeJob(@Nullable com.facebook.imagepipeline.image.EncodedImage ref, @Status int status) {
     ...
     */
    private void doDecode(com.facebook.imagepipeline.image.EncodedImage encodedImage, @Status int status) {
     ...
     */
    private com.facebook.imagepipeline.image.CloseableImage internalDecode(com.facebook.imagepipeline.image.EncodedImage encodedImage, int length, com.facebook.imagepipeline.image.QualityInfo quality) {
    ...
    private void setImageExtras(com.facebook.imagepipeline.image.EncodedImage encodedImage, com.facebook.imagepipeline.image.CloseableImage image) {
    ...
    @Nullable
    private Map<String, String> getExtraMap(@Nullable com.facebook.imagepipeline.image.CloseableImage image, long queueTime, com.facebook.imagepipeline.image.QualityInfo quality, boolean isFinal, String imageFormatName, String encodedImageSize, String requestImageSize, String sampleSize) {
     ...
     */
    private void handleResult(final com.facebook.imagepipeline.image.CloseableImage decodedImage, @Status final int status) {
    ...
    protected abstract int getIntermediateImageEndOffset(com.facebook.imagepipeline.image.EncodedImage encodedImage) ;

    protected abstract com.facebook.imagepipeline.image.QualityInfo getQualityInfo() ;
  ...
  private class LocalImagesProgressiveDecoder extends DecodeProducer.ProgressiveDecoder {
    ...
    @Override
    protected synchronized boolean updateDecodeJob(@Nullable com.facebook.imagepipeline.image.EncodedImage encodedImage, @Status int status) {
      if (isNotLast(status)) {
        return false;
      }
    ...
    @Override
    protected int getIntermediateImageEndOffset(com.facebook.imagepipeline.image.EncodedImage encodedImage) {
      return encodedImage.getSize();
    }

    @Override
    protected com.facebook.imagepipeline.image.QualityInfo getQualityInfo() {
  ...
  private class NetworkImagesProgressiveDecoder extends DecodeProducer.ProgressiveDecoder {
    private final com.facebook.imagepipeline.decoder.ProgressiveJpegParser mProgressiveJpegParser;

    private final com.facebook.imagepipeline.decoder.ProgressiveJpegConfig mProgressiveJpegConfig;

    private int mLastScheduledScanNumber;

    public NetworkImagesProgressiveDecoder(final Consumer<CloseableReference<CloseableImage>> consumer, final ProducerContext producerContext, final com.facebook.imagepipeline.decoder.ProgressiveJpegParser progressiveJpegParser, final com.facebook.imagepipeline.decoder.ProgressiveJpegConfig progressiveJpegConfig, final boolean decodeCancellationEnabled, final int maxBitmapSize) {
      super(consumer, producerContext, decodeCancellationEnabled, maxBitmapSize);
