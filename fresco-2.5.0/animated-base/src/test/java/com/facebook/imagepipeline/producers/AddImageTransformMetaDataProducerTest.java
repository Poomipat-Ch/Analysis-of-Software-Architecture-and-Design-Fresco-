...
public class AddImageTransformMetaDataProducerTest {
  ...
  private com.facebook.common.references.CloseableReference<PooledByteBuffer> mIntermediateResultBufferRef;

  private com.facebook.common.references.CloseableReference<PooledByteBuffer> mFinalResultBufferRef;

  private com.facebook.imagepipeline.image.EncodedImage mIntermediateResult;

  private com.facebook.imagepipeline.image.EncodedImage mFinalResult;
