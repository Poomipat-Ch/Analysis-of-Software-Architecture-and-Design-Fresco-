...
@ThreadSafe
public class SharedByteArray implements com.facebook.common.memory.MemoryTrimmable {
  @VisibleForTesting
   ...
   */
  @VisibleForTesting
  final com.facebook.common.references.OOMSoftReference<byte[]> mByteArraySoftRef;
  ...
  public SharedByteArray(com.facebook.common.memory.MemoryTrimmableRegistry memoryTrimmableRegistry, PoolParams params) {
