...
public abstract class BaseBitmapReferenceDataSubscriber extends com.facebook.datasource.BaseDataSubscriber<> {
  @Override
  public void onNewResultImpl(@Nonnull com.facebook.datasource.DataSource<CloseableReference<CloseableImage>> dataSource) {
   ...
   */
  protected abstract void onNewResultImpl(@Nullable com.facebook.common.references.CloseableReference<Bitmap> bitmapReference) ;
