...
public class GingerbreadPurgeableDecoder extends com.facebook.imagepipeline.nativecode.DalvikPurgeableDecoder {
   ...
   */
  @Override
  protected Bitmap decodeByteArrayAsPurgeable(com.facebook.common.references.CloseableReference<PooledByteBuffer> bytesRef, BitmapFactory.Options options) {
   ...
   */
  @Override
  protected Bitmap decodeJPEGByteArrayAsPurgeable(com.facebook.common.references.CloseableReference<PooledByteBuffer> bytesRef, int length, BitmapFactory.Options options) {
    byte[] suffix = endsWithEOI(bytesRef, length) ? null : EOI;
    return decodeFileDescriptorAsPurgeable(bytesRef, length, suffix, options);
  }

  private static MemoryFile copyToMemoryFile(com.facebook.common.references.CloseableReference<PooledByteBuffer> bytesRef, int inputLength, @Nullable byte[] suffix) throws IOException
  {
  ...
  private Bitmap decodeFileDescriptorAsPurgeable(com.facebook.common.references.CloseableReference<PooledByteBuffer> bytesRef, int inputLength, @Nullable byte[] suffix, BitmapFactory.Options options) {
