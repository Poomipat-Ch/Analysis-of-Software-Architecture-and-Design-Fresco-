...
public interface Postprocessor {
   ...
   */
  com.facebook.common.references.CloseableReference<Bitmap> process(Bitmap sourceBitmap, com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory bitmapFactory) ;
   ...
   */
  @Nullable
  com.facebook.cache.common.CacheKey getPostprocessorCacheKey() ;
