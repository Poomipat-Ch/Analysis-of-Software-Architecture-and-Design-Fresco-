...
@ThreadSafe
public abstract class AbstractProducerToDataSourceAdapter<T> extends com.facebook.datasource.AbstractDataSource<> implements com.facebook.imagepipeline.request.HasImageRequest {
  private final com.facebook.imagepipeline.producers.SettableProducerContext mSettableProducerContext;

  private final com.facebook.imagepipeline.listener.RequestListener2 mRequestListener;

  protected AbstractProducerToDataSourceAdapter(com.facebook.imagepipeline.producers.Producer<T> producer, com.facebook.imagepipeline.producers.SettableProducerContext settableProducerContext, com.facebook.imagepipeline.listener.RequestListener2 requestListener) {
  ...
  private com.facebook.imagepipeline.producers.Consumer<T> createConsumer() {
  ...
  protected void onNewResultImpl(@Nullable T result, int status, com.facebook.imagepipeline.producers.ProducerContext producerContext) {
  ...
  protected Map<String, Object> getExtras(com.facebook.imagepipeline.producers.ProducerContext producerContext) {
