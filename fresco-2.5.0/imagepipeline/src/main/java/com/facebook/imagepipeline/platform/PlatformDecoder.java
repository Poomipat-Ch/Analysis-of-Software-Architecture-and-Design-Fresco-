...
public interface PlatformDecoder {
   ...
   */
  com.facebook.common.references.CloseableReference<Bitmap> decodeFromEncodedImage(final com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig, @Nullable Rect regionToDecode) ;
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  com.facebook.common.references.CloseableReference<Bitmap> decodeJPEGFromEncodedImage(com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig, @Nullable Rect regionToDecode, int length) ;
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  com.facebook.common.references.CloseableReference<Bitmap> decodeFromEncodedImageWithColorSpace(final com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig, @Nullable Rect regionToDecode, @Nullable final ColorSpace colorSpace) ;
   ...
   * @throws java.lang.OutOfMemoryError if the Bitmap cannot be allocated
   */
  com.facebook.common.references.CloseableReference<Bitmap> decodeJPEGFromEncodedImageWithColorSpace(com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig, @Nullable Rect regionToDecode, int length, @Nullable final ColorSpace colorSpace) ;
