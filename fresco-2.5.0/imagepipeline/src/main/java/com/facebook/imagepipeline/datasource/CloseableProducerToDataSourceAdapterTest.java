...
public class CloseableProducerToDataSourceAdapterTest {
  @Mock
  public com.facebook.imagepipeline.listener.RequestListener2 mRequestListener;
  ...
  private com.facebook.common.references.ResourceReleaser mResourceReleaser;

  private com.facebook.common.references.CloseableReference<Object> mResultRef1;

  private com.facebook.common.references.CloseableReference<Object> mResultRef2;

  private com.facebook.common.references.CloseableReference<Object> mResultRef3;

  private Exception mException;

  private com.facebook.datasource.DataSubscriber<CloseableReference<Object>> mDataSubscriber1;

  private com.facebook.datasource.DataSubscriber<CloseableReference<Object>> mDataSubscriber2;

  private com.facebook.imagepipeline.producers.SettableProducerContext mSettableProducerContext;

  private com.facebook.imagepipeline.producers.Producer<CloseableReference<Object>> mProducer;

  private com.facebook.imagepipeline.producers.Consumer<CloseableReference<Object>> mInternalConsumer;

  private com.facebook.datasource.DataSource<CloseableReference<Object>> mDataSource;
   ...
   */
  private static <T> void assertReferenceCount(int expectedCount, com.facebook.common.references.CloseableReference<T> ref)
  {
    assertEquals(expectedCount, ref.getUnderlyingReferenceTestOnly().getRefCountTestOnly());
  }

  private static <T> void assertReferencesSame(String errorMessage, com.facebook.common.references.CloseableReference<T> expectedRef, com.facebook.common.references.CloseableReference<T> actualRef)
  {
    if (expectedRef == null) {
   ...
   */
  private void verifyState(boolean isFinished, boolean hasResult, com.facebook.common.references.CloseableReference<Object> resultRef, boolean hasFailed, Throwable failureCause) {
  ...
  private void verifyReferenceCount(com.facebook.common.references.CloseableReference<Object> resultRef) {
  ...
  private void verifyWithResult(com.facebook.common.references.CloseableReference<Object> resultRef, boolean isLast) {
    verifyState(isLast, resultRef != null, resultRef, NOT_FAILED, null);
    verifyReferenceCount(resultRef);
    verifyNoMoreInteractionsAndReset();
  }

  private void verifyFailed(com.facebook.common.references.CloseableReference<Object> resultRef, Throwable throwable) {
  ...
  private void testNewResult(com.facebook.common.references.CloseableReference<Object> resultRef, boolean isLast, int numSubscribers) {
  ...
  private void testFailure(com.facebook.common.references.CloseableReference<Object> resultRef, int numSubscribers) {
