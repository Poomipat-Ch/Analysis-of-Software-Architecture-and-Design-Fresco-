...
public class KitKatPurgeableDecoderTest {
  ...
  protected com.facebook.imagepipeline.memory.FlexByteArrayPool mFlexByteArrayPool;
  ...
  protected com.facebook.common.references.CloseableReference<PooledByteBuffer> mByteBufferRef;

  protected com.facebook.imagepipeline.image.EncodedImage mEncodedImage;

  protected byte[] mInputBuf;

  protected byte[] mDecodeBuf;

  protected com.facebook.common.references.CloseableReference<byte[]> mDecodeBufRef;

  protected Bitmap mBitmap;

  protected com.facebook.imagepipeline.memory.BitmapCounter mBitmapCounter;
