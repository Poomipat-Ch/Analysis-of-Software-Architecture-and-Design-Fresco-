...
@ThreadSafe
public final class SettableDataSource<T> extends com.facebook.datasource.AbstractDataSource<> {
  /**
   ...
   */
  public boolean set(@Nullable com.facebook.common.references.CloseableReference<T> valueRef) {
  ...
  @Override
  protected void closeResult(@Nullable com.facebook.common.references.CloseableReference<T> result) {
