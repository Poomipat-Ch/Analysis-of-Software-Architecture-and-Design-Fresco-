...
public abstract class MemoryChunkPool extends BasePool<> {
   ...
   */
  MemoryChunkPool(com.facebook.common.memory.MemoryTrimmableRegistry memoryTrimmableRegistry, PoolParams poolParams, PoolStatsTracker memoryChunkPoolStatsTracker) {
