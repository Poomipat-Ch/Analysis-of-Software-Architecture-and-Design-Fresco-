...
public class ForwardingRequestListener2 implements RequestListener2 {
  ...
  @Override
  public void onRequestStart(com.facebook.imagepipeline.producers.ProducerContext producerContext) {
  ...
  @Override
  public void onProducerStart(com.facebook.imagepipeline.producers.ProducerContext producerContext, String producerName) {
    final int numberOfListeners = mRequestListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
      RequestListener2 listener = mRequestListeners.get(i);
      try {
  ...
  @Override
  public void onProducerFinishWithSuccess(com.facebook.imagepipeline.producers.ProducerContext producerContext, String producerName, @Nullable Map<String, String> extraMap) {
    final int numberOfListeners = mRequestListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
      RequestListener2 listener = mRequestListeners.get(i);
      try {
  ...
  @Override
  public void onProducerFinishWithFailure(com.facebook.imagepipeline.producers.ProducerContext producerContext, String producerName, Throwable t, @Nullable Map<String, String> extraMap) {
    final int numberOfListeners = mRequestListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
      RequestListener2 listener = mRequestListeners.get(i);
      try {
  ...
  @Override
  public void onProducerFinishWithCancellation(com.facebook.imagepipeline.producers.ProducerContext producerContext, String producerName, @Nullable Map<String, String> extraMap) {
    final int numberOfListeners = mRequestListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
      RequestListener2 listener = mRequestListeners.get(i);
      try {
  ...
  @Override
  public void onProducerEvent(com.facebook.imagepipeline.producers.ProducerContext producerContext, String producerName, String producerEventName) {
    final int numberOfListeners = mRequestListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
      RequestListener2 listener = mRequestListeners.get(i);
      try {
  ...
  @Override
  public void onUltimateProducerReached(com.facebook.imagepipeline.producers.ProducerContext producerContext, String producerName, boolean successful) {
    final int numberOfListeners = mRequestListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
      RequestListener2 listener = mRequestListeners.get(i);
      try {
  ...
  @Override
  public void onRequestSuccess(com.facebook.imagepipeline.producers.ProducerContext producerContext) {
    final int numberOfListeners = mRequestListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
      RequestListener2 listener = mRequestListeners.get(i);
      try {
  ...
  @Override
  public void onRequestFailure(com.facebook.imagepipeline.producers.ProducerContext producerContext, Throwable throwable) {
    final int numberOfListeners = mRequestListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
      RequestListener2 listener = mRequestListeners.get(i);
      try {
  ...
  @Override
  public void onRequestCancellation(com.facebook.imagepipeline.producers.ProducerContext producerContext) {
    final int numberOfListeners = mRequestListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
      RequestListener2 listener = mRequestListeners.get(i);
      try {
  ...
  @Override
  public boolean requiresExtraMap(com.facebook.imagepipeline.producers.ProducerContext producerContext, String producerName) {
    final int numberOfListeners = mRequestListeners.size();
    for (int i = 0; i < numberOfListeners; ++i) {
