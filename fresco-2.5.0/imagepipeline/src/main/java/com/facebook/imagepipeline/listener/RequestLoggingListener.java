...
public class RequestLoggingListener implements RequestListener {
  ...
  @Override
  public synchronized void onRequestStart(com.facebook.imagepipeline.request.ImageRequest request, Object callerContextObject, String requestId, boolean isPrefetch) {
  ...
  @Override
  public synchronized void onRequestSuccess(com.facebook.imagepipeline.request.ImageRequest request, String requestId, boolean isPrefetch) {
    if (FLog.isLoggable(FLog.VERBOSE)) {
  ...
  @Override
  public synchronized void onRequestFailure(com.facebook.imagepipeline.request.ImageRequest request, String requestId, Throwable throwable, boolean isPrefetch) {
    if (FLog.isLoggable(FLog.WARN)) {
      Long startTime = mRequestStartTimeMap.remove(requestId);
      long currentTime = getTime();
      FLog.w(
