...
public class LruBitmapPool implements BitmapPool {
  ...
  public LruBitmapPool(int maxPoolSize, int maxBitmapSize, PoolStatsTracker poolStatsTracker, @Nullable com.facebook.common.memory.MemoryTrimmableRegistry memoryTrimmableRegistry) {
