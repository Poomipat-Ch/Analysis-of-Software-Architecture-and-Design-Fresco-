...
public class MemoryPooledByteBufferTest {
  ...
  private static void testBasic(final MemoryPooledByteBuffer mPooledByteBuffer, final MemoryChunk mChunk)
  {
  ...
  private static void testReadFromStream(final MemoryPooledByteBuffer mPooledByteBuffer) throws Exception
  {
  ...
  private static void testClose(final MemoryPooledByteBuffer mPooledByteBuffer, final MemoryChunk mChunk, final MemoryChunkPool mPool)
  {
