...
public abstract class DefaultDecoder implements PlatformDecoder {
  ...
  public DefaultDecoder(com.facebook.imagepipeline.memory.BitmapPool bitmapPool, int maxNumThreads, SynchronizedPool decodeBuffers) {
   ...
   */
  @Override
  public com.facebook.common.references.CloseableReference<Bitmap> decodeFromEncodedImageWithColorSpace(com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig, @Nullable Rect regionToDecode, @Nullable final ColorSpace colorSpace) {
   ...
   */
  @Override
  public com.facebook.common.references.CloseableReference<Bitmap> decodeJPEGFromEncodedImageWithColorSpace(com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig, @Nullable Rect regionToDecode, int length, @Nullable final ColorSpace colorSpace) {
   ...
   * @return the bitmap
   */
  protected com.facebook.common.references.CloseableReference<Bitmap> decodeStaticImageFromStream(InputStream inputStream, BitmapFactory.Options options, @Nullable Rect regionToDecode) {
   ...
   * @return the bitmap
   */
  private com.facebook.common.references.CloseableReference<Bitmap> decodeFromStream(InputStream inputStream, BitmapFactory.Options options, @Nullable Rect regionToDecode, @Nullable final ColorSpace colorSpace) {
   ...
   */
  private static BitmapFactory.Options getDecodeOptionsForStream(com.facebook.imagepipeline.image.EncodedImage encodedImage, Bitmap.Config bitmapConfig)
  {
