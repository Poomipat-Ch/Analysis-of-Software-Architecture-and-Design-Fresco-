...
@ThreadSafe
public class MemoryPooledByteBufferFactory implements com.facebook.common.memory.PooledByteBufferFactory {
  ...
  public MemoryPooledByteBufferFactory(MemoryChunkPool pool, com.facebook.common.memory.PooledByteStreams pooledByteStreams) {
    mPool = pool;
