...
@ThreadSafe
public class GenericByteArrayPool extends BasePool<> implements com.facebook.common.memory.ByteArrayPool {
   ...
   */
  public GenericByteArrayPool(com.facebook.common.memory.MemoryTrimmableRegistry memoryTrimmableRegistry, PoolParams poolParams, PoolStatsTracker poolStatsTracker) {
