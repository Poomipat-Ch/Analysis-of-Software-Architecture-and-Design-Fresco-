 ...
 */
@ThreadSafe
public class MemoryPooledByteBuffer implements com.facebook.common.memory.PooledByteBuffer {
  private final int mSize;

  @GuardedBy("this")
  @VisibleForTesting
  com.facebook.common.references.CloseableReference<MemoryChunk> mBufRef;

  public MemoryPooledByteBuffer(com.facebook.common.references.CloseableReference<MemoryChunk> bufRef, int size) {
  ...
  @GuardedBy("this")
  @VisibleForTesting
  com.facebook.common.references.CloseableReference<MemoryChunk> getCloseableReference() {
    return mBufRef;
  }
