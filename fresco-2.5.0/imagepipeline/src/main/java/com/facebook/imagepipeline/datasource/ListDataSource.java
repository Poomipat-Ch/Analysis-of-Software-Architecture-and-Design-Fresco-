...
public class ListDataSource<T> extends com.facebook.datasource.AbstractDataSource<> {
  private final com.facebook.datasource.DataSource<CloseableReference<T>>[] mDataSources;

  @GuardedBy("this")
  private int mFinishedDataSources;

  protected ListDataSource(com.facebook.datasource.DataSource<CloseableReference<T>>[] dataSources) {
  ...
  @Override
  @Nullable
  public synchronized List<com.facebook.common.references.CloseableReference<T>> getResult() {
    if (!hasResult()) {
      return null;
    }
  ...
  private void onDataSourceFailed(com.facebook.datasource.DataSource<CloseableReference<T>> dataSource) {
  ...
  private class InternalDataSubscriber implements com.facebook.datasource.DataSubscriber<> {
    ...
    @Override
    public void onFailure(com.facebook.datasource.DataSource<CloseableReference<T>> dataSource) {
      ListDataSource.this.onDataSourceFailed(dataSource);
    }

    @Override
    public void onCancellation(com.facebook.datasource.DataSource<CloseableReference<T>> dataSource) {
      ListDataSource.this.onDataSourceCancelled();
    }

    @Override
    public void onNewResult(com.facebook.datasource.DataSource<CloseableReference<T>> dataSource) {
    ...
    @Override
    public void onProgressUpdate(com.facebook.datasource.DataSource<CloseableReference<T>> dataSource) {
