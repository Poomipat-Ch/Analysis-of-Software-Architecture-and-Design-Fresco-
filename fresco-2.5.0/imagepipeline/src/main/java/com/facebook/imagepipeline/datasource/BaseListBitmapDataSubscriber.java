...
public abstract class BaseListBitmapDataSubscriber extends com.facebook.datasource.BaseDataSubscriber<> {
  @Override
  public void onNewResultImpl(com.facebook.datasource.DataSource<List<CloseableReference<CloseableImage>>> dataSource) {
