...
public class AshmemMemoryChunkPoolTest {
  ...
  public void testGetBucketedSizeForValue() {
    ...
    Assert.assertEquals(64, mPool.getBucketedSizeForValue(new FakeAshmemMemoryChunk(64)));
    Assert.assertEquals(128, mPool.getBucketedSizeForValue(new FakeAshmemMemoryChunk(128)));

    // Non-bucket values
    Assert.assertEquals(1, mPool.getBucketedSizeForValue(new FakeAshmemMemoryChunk(1)));
    Assert.assertEquals(31, mPool.getBucketedSizeForValue(new FakeAshmemMemoryChunk(31)));
