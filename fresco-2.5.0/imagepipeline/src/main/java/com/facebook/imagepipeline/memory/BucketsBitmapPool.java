 ...
 * 
 * <p>The pool supports a get/release paradigm. get() allows for a bitmap in the pool to be reused
...
public class BucketsBitmapPool extends BasePool<> implements BitmapPool {
   ...
   */
  public BucketsBitmapPool(com.facebook.common.memory.MemoryTrimmableRegistry memoryTrimmableRegistry, PoolParams poolParams, PoolStatsTracker poolStatsTracker, boolean ignoreHardCap) {
  ...
  /**
   * Determine if this bitmap is reusable (i.e.) if subsequent {@link #get(int)} requests can use
