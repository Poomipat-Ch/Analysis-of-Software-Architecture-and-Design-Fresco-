...
public class FlexByteArrayPool {
  private final com.facebook.common.references.ResourceReleaser<byte[]> mResourceReleaser;

  @VisibleForTesting
  static class SoftRefByteArrayPool extends GenericByteArrayPool {
    public SoftRefByteArrayPool(com.facebook.common.memory.MemoryTrimmableRegistry memoryTrimmableRegistry, PoolParams poolParams, PoolStatsTracker poolStatsTracker) {
  ...
  public FlexByteArrayPool(com.facebook.common.memory.MemoryTrimmableRegistry memoryTrimmableRegistry, PoolParams params) {
  ...
  public com.facebook.common.references.CloseableReference<byte[]> get(int size) {
