...
public class ListDataSourceTest {
  ...
  private com.facebook.common.references.CloseableReference<Integer> mRef1;

  private com.facebook.common.references.CloseableReference<Integer> mRef2;

  private RuntimeException mRuntimeException;

  @Mock
  public com.facebook.common.references.ResourceReleaser<Integer> mResourceReleaser;

  @Mock
  public com.facebook.datasource.DataSubscriber<List<CloseableReference<Integer>>> mDataSubscriber;
