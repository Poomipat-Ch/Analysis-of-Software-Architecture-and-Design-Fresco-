 ...
 */
public interface RequestListener extends com.facebook.imagepipeline.producers.ProducerListener {
  /**
   ...
   */
  void onRequestStart(com.facebook.imagepipeline.request.ImageRequest request, Object callerContext, String requestId, boolean isPrefetch) ;
   ...
   * @param isPrefetch whether the request is a prefetch or not
   */
  void onRequestSuccess(com.facebook.imagepipeline.request.ImageRequest request, String requestId, boolean isPrefetch) ;
   ...
   * @param isPrefetch whether the request is a prefetch or not
   */
  void onRequestFailure(com.facebook.imagepipeline.request.ImageRequest request, String requestId, Throwable throwable, boolean isPrefetch) ;
