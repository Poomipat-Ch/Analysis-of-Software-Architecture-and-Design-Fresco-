...
public class MemoryPooledByteBufferOutputStream extends com.facebook.common.memory.PooledByteBufferOutputStream {
  /**
   ...
   */
  @Nullable
  private com.facebook.common.references.CloseableReference<MemoryChunk> mBufRef;
