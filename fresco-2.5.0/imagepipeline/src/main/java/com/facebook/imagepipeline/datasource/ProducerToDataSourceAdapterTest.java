...
public class ProducerToDataSourceAdapterTest {
  ...
  private com.facebook.datasource.DataSubscriber<Object> mDataSubscriber1;

  private com.facebook.datasource.DataSubscriber<Object> mDataSubscriber2;

  private com.facebook.imagepipeline.producers.SettableProducerContext mSettableProducerContext;

  private com.facebook.imagepipeline.producers.Producer<Object> mProducer;

  private com.facebook.imagepipeline.producers.Consumer<Object> mInternalConsumer;

  private com.facebook.datasource.DataSource<Object> mDataSource;
   ...
   */
  private void verifyState(boolean isFinished, boolean hasResult, Object result, boolean hasFailed, Throwable failureCause) {
