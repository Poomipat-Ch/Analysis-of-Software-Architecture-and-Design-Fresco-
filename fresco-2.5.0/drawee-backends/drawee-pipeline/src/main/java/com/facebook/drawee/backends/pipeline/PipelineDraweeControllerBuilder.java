 ...
 */
public class PipelineDraweeControllerBuilder extends com.facebook.drawee.controller.AbstractDraweeControllerBuilder<, , , > {
  ...
  public PipelineDraweeControllerBuilder(Context context, PipelineDraweeControllerFactory pipelineDraweeControllerFactory, com.facebook.imagepipeline.core.ImagePipeline imagePipeline, Set<ControllerListener> boundControllerListeners, Set<ControllerListener2> boundControllerListeners2) {
  ...
  public PipelineDraweeControllerBuilder setCustomDrawableFactories(@Nullable com.facebook.common.internal.ImmutableList<DrawableFactory> customDrawableFactories) {
  ...
  public PipelineDraweeControllerBuilder setCustomDrawableFactory(com.facebook.imagepipeline.drawable.DrawableFactory drawableFactory) {
    Preconditions.checkNotNull(drawableFactory);
    return setCustomDrawableFactories(ImmutableList.of(drawableFactory));
  }

  public PipelineDraweeControllerBuilder setImageOriginListener(@Nullable com.facebook.drawee.backends.pipeline.info.ImageOriginListener imageOriginListener) {
    mImageOriginListener = imageOriginListener;
    return getThis();
  }

  public PipelineDraweeControllerBuilder setPerfDataListener(@Nullable com.facebook.drawee.backends.pipeline.info.ImagePerfDataListener imagePerfDataListener) {
  ...
  @Nullable
  private com.facebook.cache.common.CacheKey getCacheKey() {
  ...
  @Override
  protected com.facebook.datasource.DataSource<CloseableReference<CloseableImage>> getDataSourceForRequest(com.facebook.drawee.interfaces.DraweeController controller, String controllerId, com.facebook.imagepipeline.request.ImageRequest imageRequest, Object callerContext, com.facebook.drawee.controller.AbstractDraweeControllerBuilder.CacheLevel cacheLevel) {
  ...
  @Nullable
  protected com.facebook.imagepipeline.listener.RequestListener getRequestListener(final com.facebook.drawee.interfaces.DraweeController controller) {
  ...
  public static com.facebook.imagepipeline.request.ImageRequest.RequestLevel convertCacheLevelToRequestLevel(com.facebook.drawee.controller.AbstractDraweeControllerBuilder.CacheLevel cacheLevel)
  {
    switch (cacheLevel) {
      case FULL_FETCH:
