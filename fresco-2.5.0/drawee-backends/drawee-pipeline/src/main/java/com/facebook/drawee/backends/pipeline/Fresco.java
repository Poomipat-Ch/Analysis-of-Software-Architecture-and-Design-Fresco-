...
public class Fresco {
   ...
   */
  public static void initialize(Context context, @Nullable com.facebook.imagepipeline.core.ImagePipelineConfig imagePipelineConfig)
  {
   ...
   */
  public static void initialize(Context context, @Nullable com.facebook.imagepipeline.core.ImagePipelineConfig imagePipelineConfig, @Nullable DraweeConfig draweeConfig)
  {
   ...
   */
  public static void initialize(Context context, @Nullable com.facebook.imagepipeline.core.ImagePipelineConfig imagePipelineConfig, @Nullable DraweeConfig draweeConfig, boolean useNativeCode)
  {
