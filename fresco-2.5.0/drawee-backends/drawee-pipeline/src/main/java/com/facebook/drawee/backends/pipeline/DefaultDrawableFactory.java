...
public class DefaultDrawableFactory implements com.facebook.imagepipeline.drawable.DrawableFactory {
  private final Resources mResources;

  @Nullable
  private final com.facebook.imagepipeline.drawable.DrawableFactory mAnimatedDrawableFactory;

  public DefaultDrawableFactory(Resources resources, @Nullable com.facebook.imagepipeline.drawable.DrawableFactory animatedDrawableFactory) {
  ...
  @Override
  @Nullable
  public Drawable createDrawable(com.facebook.imagepipeline.image.CloseableImage closeableImage) {
    try {
