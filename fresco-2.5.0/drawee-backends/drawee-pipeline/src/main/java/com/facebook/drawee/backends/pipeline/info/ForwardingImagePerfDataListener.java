...
public class ForwardingImagePerfDataListener implements ImagePerfDataListener {
  ...
  @Override
  public void onImageLoadStatusUpdated(ImagePerfData imagePerfData, @ImageLoadStatus int imageLoadStatus) {
  ...
  @Override
  public void onImageVisibilityUpdated(ImagePerfData imagePerfData, @VisibilityState int visibilityState) {
    for (ImagePerfDataListener listener : mListeners) {
