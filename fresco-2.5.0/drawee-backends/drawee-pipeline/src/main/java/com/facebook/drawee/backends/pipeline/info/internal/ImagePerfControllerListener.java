...
public class ImagePerfControllerListener extends com.facebook.drawee.controller.BaseControllerListener<> implements com.facebook.fresco.ui.common.OnDrawControllerListener<> {
  ...
  public ImagePerfControllerListener(com.facebook.common.time.MonotonicClock clock, com.facebook.drawee.backends.pipeline.info.ImagePerfState imagePerfState, com.facebook.drawee.backends.pipeline.info.ImagePerfMonitor imagePerfMonitor) {
    mClock = clock;
