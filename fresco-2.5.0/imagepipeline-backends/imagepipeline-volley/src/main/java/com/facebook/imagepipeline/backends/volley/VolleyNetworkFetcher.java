 ...
 */
public class VolleyNetworkFetcher extends com.facebook.imagepipeline.producers.BaseNetworkFetcher<> {
  public static class VolleyNetworkFetchState extends com.facebook.imagepipeline.producers.FetchState {
    long submitTime;
    ...
    public VolleyNetworkFetchState(com.facebook.imagepipeline.producers.Consumer<EncodedImage> consumer, com.facebook.imagepipeline.producers.ProducerContext producerContext) {
  ...
  @Override
  public VolleyNetworkFetcher.VolleyNetworkFetchState createFetchState(com.facebook.imagepipeline.producers.Consumer<EncodedImage> consumer, com.facebook.imagepipeline.producers.ProducerContext context) {
    return new VolleyNetworkFetchState(consumer, context);
  }

  @Override
  public void fetch(final VolleyNetworkFetcher.VolleyNetworkFetchState fetchState, final com.facebook.imagepipeline.producers.NetworkFetcher.Callback callback) {
